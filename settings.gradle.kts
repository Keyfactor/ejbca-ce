...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("cryptotokens-api", ":cryptotokens-api:3.10.1")
            library("cryptotokens-impl", ":cryptotokens-impl:3.10.1")
            library("cryptotokens-impl-ee", ":cryptotokens-impl-ee:3.10.1")
