...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("x509-common-util", ":x509-common-util:5.1.0")
            library("cryptotokens-api", ":cryptotokens-api:2.3.5")
            library("cryptotokens-impl", ":cryptotokens-impl:2.3.5")
            library("cryptotokens-impl-ee", ":cryptotokens-impl-ee:2.3.5")
