...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("java-ee-api", ":jakarta.jakartaee-api:10.0.0")
            ...
            library("cryptotokens-impl", ":cryptotokens-impl:1.1.0")
            library("cryptotokens-api", ":cryptotokens-api:1.1.0")
            ...
            library("swagger-annotations", ":swagger-annotations:2.2.20")
            library("swagger-core", ":swagger-core:2.2.20")
            library("swagger-jaxrs", ":swagger-jaxrs2-jakarta:2.2.20")
            library("swagger-models", ":swagger-models:2.2.20")
            ...
            library("hibernate-core", ":hibernate-core:5.6.15.Final")
            ...
            library("jaxb-api", ":jakarta.xml.bind-api:4.0.2")
