...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("cryptotokens-api", ":cryptotokens-api:3.8.5")
            library("cryptotokens-impl", ":cryptotokens-impl:3.8.5")
            library("cryptotokens-impl-ee", ":cryptotokens-impl-ee:3.8.5")
