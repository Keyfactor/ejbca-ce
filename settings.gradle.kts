...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("cryptotokens-api", ":cryptotokens-api:4.0.0")
            library("cryptotokens-impl", ":cryptotokens-impl:4.0.0")
            library("cryptotokens-impl-ee", ":cryptotokens-impl-ee:4.0.0")
