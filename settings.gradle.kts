...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("log4j-core", ":log4j-core:2.25.4")
            ...
            library("x509-common-util", ":x509-common-util:5.10.0")
            library("cryptotokens-api", ":cryptotokens-api:3.9.0")
            library("cryptotokens-impl", ":cryptotokens-impl:3.9.0")
            library("cryptotokens-impl-ee", ":cryptotokens-impl-ee:3.9.0")
            ...
            library("commons-codec", ":commons-codec:1.17.1")
            library("commons-io", ":commons-io:2.17.0")
            library("httpclient", ":httpclient:4.5.14")
            library("httpcore", ":httpcore:4.4.16")
            library("httpmime", ":httpmime:4.5.14")
            ...
            library("jackson-core", ":jackson-core:2.20.0")
            library("jackson-databind", ":jackson-databind:2.20.0")
            library("jackson-annotations", ":jackson-annotations:2.20")
            library("jackson-dataformat-xml", "com.fasterxml.jackson.dataformat:jackson-dataformat-xml:2.18.3")
            library("jackson-dataformat-yaml", ":jackson-dataformat-yaml:2.20.0")
            ...
            library("kerb4j-server-common", ":kerb4j-server-common:0.2.0")
            library("kerb-core", ":kerb-core:2.1.1")
            library("kerb-crypto", ":kerb-crypto:2.1.1")
            library("kerby-asn1", ":kerby-asn1:2.1.1")
            ...
            library("mockito", ":mockito-core:5.19.0")
            library("byte-buddy", ":byte-buddy:1.17.7")
            library("byte-buddy-agent", ":byte-buddy-agent:1.17.7")
            ...
            library("reactive-streams", ":reactive-streams:1.0.4")
            library("resteasy-client", ":resteasy-client:7.0.0.Final")
            library("resteasy-client-api", ":resteasy-client-api:7.0.0.Final")
            library("resteasy-core", ":resteasy-core:7.0.0.Final")
            library("resteasy-core-spi", ":resteasy-core-spi:7.0.0.Final")
            library("resteasy-undertow", ":resteasy-undertow:7.0.0.Final")
            library("resteasy-jaxb-provider", ":resteasy-jaxb-provider:7.0.0.Final")
            library("undertow-core", ":undertow-core:2.3.22.Final")
            library("undertow-servlet", ":undertow-servlet:2.3.22.Final")
            ...
            library("resteasy-multipart-provider", ":resteasy-multipart-provider:7.0.0.Final")
            library("json-patch", ":json-patch:1.13")
            library("jakarta.ws.rs-api", ":jakarta.ws.rs-api:4.0.0")
            library("jackson-jakarta-rs-base", ":jackson-jakarta-rs-base:2.20.0")
            library("jackson-jakarta-rs-json-provider", ":jackson-jakarta-rs-json-provider:2.20.0")
            library("jackson-module-jaxb-annotations", ":jackson-module-jaxb-annotations:2.20.0")
            library("jaxb-api", ":jaxb-api:2.2.12")
