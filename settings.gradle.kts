...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("x509-common-util", ":x509-common-util:5.2.1")
            library("cryptotokens-api", ":cryptotokens-api:2.4.1")
            library("cryptotokens-impl", ":cryptotokens-impl:2.4.1")
            library("cryptotokens-impl-ee", ":cryptotokens-impl-ee:2.4.1")
