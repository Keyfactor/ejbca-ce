...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            library("bcprov", ":bcprov:jdk18on-1.79-20241009.092052-3")
            library("bcpkix", ":bcpkix:jdk18on-1.79-20241009.092036-3")
            library("bctls", ":bctls:jdk18on-1.79-20241009.092109-3")
            library("bcutil", ":bcutil:jdk18on-1.79-20241009.092126-3")
            ...
            library("x509-common-util", ":x509-common-util:4.1.3")
            library("cryptotokens-api", ":cryptotokens-api:2.3.0")
            library("cryptotokens-impl", ":cryptotokens-impl:2.3.0")
            library("cryptotokens-impl-ee", ":cryptotokens-impl-ee:2.3.0")
