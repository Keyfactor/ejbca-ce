...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("jakarta.xml.soap-api-3.0.2", ":jakarta.xml.soap-api:3.0.2")
            ...
            library("swagger-annotations-jakarta", ":swagger-annotations-jakarta:2.2.22")
            library("swagger-core-jakarta", ":swagger-core-jakarta:2.2.22")
