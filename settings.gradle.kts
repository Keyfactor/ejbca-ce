...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("jackson-jakarta-rs-base", ":jackson-jakarta-rs-base:2.21.3")
            library("jackson-jakarta-rs-json-provider", ":jackson-jakarta-rs-json-provider:2.21.3")
            library("jackson-module-jaxb-annotations", ":jackson-module-jaxb-annotations:2.21.3")
