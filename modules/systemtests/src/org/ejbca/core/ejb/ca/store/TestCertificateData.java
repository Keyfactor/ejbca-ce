...
public class TestCertificateData extends TestCase {
    ...
    public void test01CreateNewCertRSASha1() throws Exception {
        ...
        try {
        	...
        	boolean ret = certificateStoreSession.storeCertificate(admin, cert, "foo", "1234", SecConst.CERT_INACTIVE, SecConst.CERTTYPE_ENDENTITY, SecConst.CERTPROFILE_FIXED_ENDUSER, "footag", new Date().getTime());
