...
/**
 * Try HTTP methods that should be disabled, like HTTP DELETE, for all public web modules.
 * 
 * @version $Id$
 */
public class HttpMethodsTest extends TestCase {
	...
	private final static String httpBaseUrl;
	private static String httpPort;

	static {
		try {
			httpPort = TestTools.getConfigurationSession().getProperty(WebConfiguration.CONFIG_HTTPSERVERPUBHTTP, "8080");
		} catch (Exception e) {
			httpPort = "8080";
