 ...
 */
public class UserPasswordExpireSystemTest extends CaTestCase {

    private static final Logger log = Logger.getLogger(UserPasswordExpireSystemTest.class);
    private static final AuthenticationToken admin = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal("UserPasswordExpireSystemTest"));
    private int caid = getTestCAId();

    private static final String USERNAME = "UserPasswordExpireSystemTestUser";
