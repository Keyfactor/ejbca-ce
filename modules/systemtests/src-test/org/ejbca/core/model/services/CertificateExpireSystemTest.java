 ...
 * @version $Id$
 */
public class CertificateExpireSystemTest extends CaTestCase {

    private static final Logger log = Logger.getLogger(CertificateExpireSystemTest.class);
    private static final AuthenticationToken admin = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal("CertificateExpireSystemTest"));
    private static final String USERNAME = "CertificateExpireSystemTest";
    ...
    public void testExpireCertificateUnusedCertificateProfile() throws Exception {
        final String usedCertificateprofilename = "testExpireCertificateUnusedCertificateProfile_foo";
        final String unusedCertificateProfileName = "testExpireCertificateUnusedCertificateProfile_bar";
