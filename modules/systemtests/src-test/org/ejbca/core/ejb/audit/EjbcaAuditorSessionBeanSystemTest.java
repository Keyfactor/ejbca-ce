 ...
 * @version $Id$
 */
public class EjbcaAuditorSessionBeanSystemTest extends RoleUsingTestCase {
    
    private static final Logger LOG = Logger.getLogger(EjbcaAuditorSessionBeanSystemTest.class);
