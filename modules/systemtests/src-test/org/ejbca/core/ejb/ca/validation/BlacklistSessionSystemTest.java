 ...
 * @version $Id$
 */
public class BlacklistSessionSystemTest extends RoleUsingTestCase {

    /** Class logger. */
    private static final Logger log = Logger.getLogger(BlacklistSessionSystemTest.class);

    /** Test user. */
    private static final AuthenticationToken internalAdmin = new TestAlwaysAllowLocalAuthenticationToken(
            new UsernamePrincipal("PublicKeyBlacklistSessionSystemTest-Admin"));
    ...
    public void setUp() throws Exception {
        ...
        super.setUpAuthTokenAndRole(null, "BlacklistSessionSystemTest", Arrays.asList(
