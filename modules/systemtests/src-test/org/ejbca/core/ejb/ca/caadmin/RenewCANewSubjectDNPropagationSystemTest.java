 ...
 */
public class RenewCANewSubjectDNPropagationSystemTest extends CaTestCase {

    private static final Logger log = Logger.getLogger(RenewCANewSubjectDNPropagationSystemTest.class);
    ...
    public static void afterClass() throws Exception {
        GlobalCaConfiguration globalConfiguration = (GlobalCaConfiguration) globalConfigSession.getCachedConfiguration(GlobalCaConfiguration.CA_CONFIGURATION_ID);
