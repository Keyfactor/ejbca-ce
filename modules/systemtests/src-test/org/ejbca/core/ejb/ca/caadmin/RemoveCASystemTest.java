...
public class RemoveCASystemTest extends CaTestCase {
    ...
    private static final AuthenticationToken alwaysAllowAuthenticationToken = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal(RemoveCASystemTest.class.getSimpleName()));
