...
public class SignSessionWithRsaSystemTest extends SignSessionCommon {

    private static final Logger log = Logger.getLogger(SignSessionWithRsaSystemTest.class);
   ...
   @Test
    ...
    public String getRoleName() {
        return SignSessionWithRsaSystemTest.class.getSimpleName();
    }
