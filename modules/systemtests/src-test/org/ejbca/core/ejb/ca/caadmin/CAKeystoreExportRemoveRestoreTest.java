...
public class CAKeystoreExportRemoveRestoreTest {
    ...
    private void subTestExportRemoveRestore(String cryptoTokenName, String signKeySpecification, final String encryptionKeySpec, String signatureAlgorithm, String encryptionAlgorithm) throws Exception {
        int cryptoTokenId = 0;
        try {
            cryptoTokenId = CryptoTokenTestUtils.createCryptoTokenForCA(internalAdmin, "foo123".toCharArray(), true, false, cryptoTokenName, signKeySpecification, encryptionKeySpec, false);
    ...
    public void test05RestoreWrong() throws Exception {
        ...
        try {
            ...
            cryptoTokenId1 = CryptoTokenTestUtils.createCryptoTokenForCA(internalAdmin, capassword.toCharArray(), true, false, CANAME1, "1024", "1024", false);
            ...
            cryptoTokenId2 = CryptoTokenTestUtils.createCryptoTokenForCA(internalAdmin, capassword.toCharArray(), true, false, CANAME2, "DSA1024", "1024", false);
            ...
            cryptoTokenId3 = CryptoTokenTestUtils.createCryptoTokenForCA(internalAdmin, capassword.toCharArray(), true, false, CANAME3, "1024", "1024", false);
