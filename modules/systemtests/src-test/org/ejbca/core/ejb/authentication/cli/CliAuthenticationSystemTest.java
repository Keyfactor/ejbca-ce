 ...
 */
public class CliAuthenticationSystemTest {

    private static final String CLI_TEST_ROLENAME = "CLI_TEST_ROLENAME";

    /** Internal localization of logs and errors */
    private static final InternalEjbcaResources intres = InternalEjbcaResources.getInstance();
    private static final Logger log = Logger.getLogger(CliAuthenticationSystemTest.class);
    ...
    private CliAuthenticationSystemTestHelperSessionRemote cliAuthenticationSystemTestHelperSession = EjbRemoteHelper.INSTANCE.getRemoteSession(CliAuthenticationSystemTestHelperSessionRemote.class, EjbRemoteHelper.MODULE_TEST);
    ...
    public void tearDown() throws Exception {
        try {
            endEntityManagementSession.deleteUser(internalToken, CliAuthenticationSystemTestHelperSessionRemote.USERNAME);
    ...
    public void testAuthenticationFailureDueToNonExistingUser() throws AuthorizationDeniedException {
        ...
        final String expectedMessage = intres.getLocalizedMessage("authentication.failed.cli.usernotfound", CliAuthenticationSystemTestHelperSessionRemote.USERNAME );
        Set<Principal> principals = new HashSet<Principal>();
        principals.add(new UsernamePrincipal(CliAuthenticationSystemTestHelperSessionRemote.USERNAME));
        AuthenticationSubject subject = new AuthenticationSubject(principals, null);
        CliAuthenticationToken authenticationToken = (CliAuthenticationToken) cliAuthenticationProvider.authenticate(subject);
