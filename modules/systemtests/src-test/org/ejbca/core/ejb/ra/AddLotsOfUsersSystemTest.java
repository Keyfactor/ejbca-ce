...
public class AddLotsOfUsersSystemTest extends CaTestCase {
	...
	private static final String USERNAME_PREFIX = "AddLotsOfUsersSystemTest";
	private static final int NUMBER_OF_THREADS = 10;
	private static final int USERS_PER_THREAD = 100;

    private static final AuthenticationToken alwaysAllowToken = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal("AddLotsOfUsersSystemTest"));
    ...
    public String getRoleName() {
        return "AddLotsOfUsersSystemTest";
    }
