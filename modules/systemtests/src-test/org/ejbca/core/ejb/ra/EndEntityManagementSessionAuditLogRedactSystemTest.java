...
public class EndEntityManagementSessionAuditLogRedactSystemTest extends CaTestCase {
    
    private static final Logger log = Logger.getLogger(EndEntityManagementSessionAuditLogRedactSystemTest.class);
    ...
    private static final String THROWAWAY_CERT_PROFILE = EndEntityManagementSessionSystemTest.class.getName()+"-ThrowAwayRevocationProfileRedactTest";
    private static final String THROWAWAY_PUBLISHER = EndEntityManagementSessionSystemTest.class.getName()+"-ThrowAwayRevocationPublisherRedactTest";
    
    private static final AuthenticationToken admin = new TestAlwaysAllowLocalAuthenticationToken("EndEntityManagementSessionAuditLogRedactSystemTest");
    ...
    public String getRoleName() {
        return "EndEntityManagementSessionAuditLogRedactSystemTest";
    }
