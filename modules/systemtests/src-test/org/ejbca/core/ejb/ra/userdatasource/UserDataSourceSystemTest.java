...
public class UserDataSourceSystemTest extends RoleUsingTestCase {

    private static final Logger log = Logger.getLogger(UserDataSourceSystemTest.class);
    private static final AuthenticationToken internalAdmin = new TestAlwaysAllowLocalAuthenticationToken("UserDataSourceSystemTest");
