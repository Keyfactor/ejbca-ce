 ...
 */
public class AdminPreferenceSystemTest extends CaTestCase {
    private static Logger log = Logger.getLogger(AdminPreferenceSystemTest.class);

    private static final AuthenticationToken internalToken = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal("AdminPreferenceSystemTest"));
    ...
    public String getRoleName() {
        return "AdminPreferenceSystemTest";
    }
