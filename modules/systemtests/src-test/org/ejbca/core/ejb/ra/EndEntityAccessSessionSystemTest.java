 ...
 *
 */
public class EndEntityAccessSessionSystemTest extends CaTestCase {
    
    private static final Logger log = Logger.getLogger(EndEntityAccessSessionSystemTest.class);
