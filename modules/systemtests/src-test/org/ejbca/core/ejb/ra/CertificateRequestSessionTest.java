...
public class CertificateRequestSessionTest extends CaTestCase {
    ...
    public void testSoftTokenRequestRollback() throws Exception {
        ...
        EndEntityInformation userdata = new EndEntityInformation(username, "CN=" + username, getTestCAId(), null, null, EndEntityConstants.USER_ENDUSER, SecConst.EMPTY_ENDENTITYPROFILE,
    ...
    public void testCertificateRequestRollback() throws Exception {
        ...
        EndEntityInformation userdata = new EndEntityInformation(username, "CN=" + username, getTestCAId(), null, null, EndEntityConstants.USER_ENDUSER,
    ...
    public void testEmptyFields() throws Exception {
        ...
        EndEntityInformation userdata = new EndEntityInformation(username, suppliedDn, getTestCAId(), null, null, EndEntityConstants.USER_ENDUSER, SecConst.EMPTY_ENDENTITYPROFILE,
