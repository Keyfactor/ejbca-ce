...
public class EndEntityManagementSessionSystemTest extends CaTestCase {

    private static final Logger log = Logger.getLogger(EndEntityManagementSessionSystemTest.class);
    
    private static final AuthenticationToken admin = new TestAlwaysAllowLocalAuthenticationToken("EndEntityManagementSessionSystemTest");
    private static final BigInteger THROWAWAY_CERT_SERIAL = new BigInteger("123456788A43197E", 16);
    private static final String THROWAWAY_CERT_PROFILE = EndEntityManagementSessionSystemTest.class.getName()+"-ThrowAwayRevocationProfile";
    private static final String THROWAWAY_PUBLISHER = EndEntityManagementSessionSystemTest.class.getName()+"-ThrowAwayRevocationPublisher";
...
//        assertTrue(("CA with id " + notExistingCa + " does not exist.").equals( exception.getMessage()));
        ...
        final AuthenticationToken adminNoAuthToAccessCa = new UsernameBasedAuthenticationToken(new UsernamePrincipal("EndEntityManagementSessionSystemTest-NoAuth"));
        try {
    ...
    public void test08Authorization() throws Exception {
        ...
        final String testRole = "EndEntityManagementSessionSystemTestAuthRole";
    ...
    public void testEndEntityIssuanceRevocationReason() throws Exception {
        ...
        try {            
            ...
            assertEquals(RevocationReasons.CERTIFICATEHOLD.getDatabaseValue(), data.getExtendedInformation().getIssuanceRevocationReason());
            
            data.setDN("CN=XX" + thisusername);
