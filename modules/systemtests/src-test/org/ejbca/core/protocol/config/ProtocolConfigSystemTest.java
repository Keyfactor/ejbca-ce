 ...
 *
 */
public class ProtocolConfigSystemTest {

    private static final Logger log = Logger.getLogger(ProtocolConfigSystemTest.class);
    ...
    private final AuthenticationToken admin = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal("ProtocolConfigSystemTest"));
    ...
    public void testWs() throws Exception {
        ...
        EjbcaWSSystemTest wsTest = new EjbcaWSSystemTest();
        ...
        try {
            EjbcaWSSystemTest.beforeClass();
            wsTest.setUpAdmin();
            // Call some random WS method
            wsTest.test01EditUser();
            EjbcaWSSystemTest.afterClass();
