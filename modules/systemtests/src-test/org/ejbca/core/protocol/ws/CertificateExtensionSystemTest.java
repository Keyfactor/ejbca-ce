 ...
 * @version $Id$
 */
public class CertificateExtensionSystemTest extends CommonEjbcaWs {

    private static final Logger log = Logger.getLogger(CertificateExtensionSystemTest.class);
    private static final String WS_ADMIN_ROLENAME = "CertificateExtensionSystemTest";
