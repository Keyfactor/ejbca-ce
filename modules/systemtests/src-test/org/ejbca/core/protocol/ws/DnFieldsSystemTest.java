 ...
 *
 */
public class DnFieldsSystemTest extends CommonEjbcaWs {

    private static final Logger log = Logger.getLogger(DnFieldsSystemTest.class);
    
    private static final String PROFILE_NAME = "TW";
    private static final String TEST_USERNAME = "tester";
    private static final String TEST_SUBJECTDN = "E=test@example.com,CN=DnFieldsSystemTest,C=SE";
    ...
    private AuthenticationToken internalAdmin = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal("DnFieldsSystemTest"));
    ...
    public String getRoleName() {
        return DnFieldsSystemTest.class.getSimpleName();
    }
