...
public class CrmfRARequestSystemTest extends CmpTestCase {
    ...
    private final static Logger log = Logger.getLogger(CrmfRARequestSystemTest.class);
    ...
    public void test01CrmfHttpOkUser() throws Exception {
        ...
        final X500Name userDN1 = new X500Name("C=SE,O=PrimeKey,CN=" + userName1+",SN="+serial1+",SURNAME="+surName1+",VID=FFF1,uniqueIdentifier=N62892");
