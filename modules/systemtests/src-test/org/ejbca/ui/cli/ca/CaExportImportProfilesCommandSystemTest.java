 ...
 * @version $Id$
 */
public class CaExportImportProfilesCommandSystemTest {
    ...
    private AuthenticationToken admin = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal("CaExportImportProfilesCommandSystemTest"));
    ...
    public void testExportImportProfiles() throws Exception {        
        ...
        try {
            ...
            profile.setValue(EndEntityProfile.AVAILCAS, 0, Integer.toString(CAConstants.ALLCAS)+';'+Integer.toString(caid));
            ...
            assertTrue("EE profile ANYCA should exist", availcas.contains(CAConstants.ALLCAS));
