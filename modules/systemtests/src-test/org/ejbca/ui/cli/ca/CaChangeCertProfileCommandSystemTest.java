 ...
 *
 */
public class CaChangeCertProfileCommandSystemTest {

    private static final String CA_NAME = "CaChangeCertProfileCommandSystemTest";
    private static final String CA_DN = "CN=" + CA_NAME;
    private static final String CERTIFICATE_PROFILE = "CaChangeCertProfileCommandSystemTest";
