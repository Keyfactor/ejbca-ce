 ...
 *
 */
public class CaImportCaCertCommandSystemTest {

    private static final String CA_NAME = "CaImportCaCertCommandSystemTest";
    ...
    private AuthenticationToken admin = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal("CaImportCaCertCommandSystemTest"));
