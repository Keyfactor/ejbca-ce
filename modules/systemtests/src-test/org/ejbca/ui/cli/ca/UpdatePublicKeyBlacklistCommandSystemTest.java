 ...
 * 
 * <pre>ant test:runone -Dtest.runone=UpdatePublicKeyBlacklistCommandSystemTest</pre>.
 * 
 * @version $Id$
 */
public class UpdatePublicKeyBlacklistCommandSystemTest {
    ...
    private static final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(
            UpdatePublicKeyBlacklistCommandSystemTest.class.getSimpleName());
