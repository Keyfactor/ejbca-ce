 ...
 * @version $Id$
 */
public class CaEditCaCommandSystemTest {

    private static final String CA_NAME = "CaEditCaCommandSystemTest";
    ...
    public void testRenameCa() throws AuthorizationDeniedException {
        final String newName = "CaEditCaCommandSystemTestNewName";
