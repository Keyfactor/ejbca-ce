 ...
 *
 */
public class CaGetFieldValueCommandSystemTest {

    private static final String CA_NAME = "CaGetFieldValueCommandSystemTest";

    private CaGetFieldValueCommand caGetFieldValueCommand;

    private AuthenticationToken admin = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal("CaGetFieldValueCommandSystemTest"));
