 ...
 * @version $Id$
 */
public class CaChangeCryptoTokenCommandSystemTest {
    private final static Logger log = Logger.getLogger(CaChangeCryptoTokenCommandSystemTest.class);
    ...
    private AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(
            new UsernamePrincipal("CaChangeCryptoTokenCommandSystemTest"));
