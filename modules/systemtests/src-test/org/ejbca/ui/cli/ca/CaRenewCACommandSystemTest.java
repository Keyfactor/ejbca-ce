 ...
 * @version $Id$
 */
public class CaRenewCACommandSystemTest extends CaTestCase {
    
	/** Logger for this class. */
	private static final Logger LOG = Logger.getLogger(CaRenewCACommandSystemTest.class);
	
	private static final AuthenticationToken internalAdmin = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal("CaRenewCACommandSystemTest"));
