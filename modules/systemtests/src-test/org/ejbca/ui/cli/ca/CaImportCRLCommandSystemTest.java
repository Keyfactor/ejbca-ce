 ...
 *
 */
public class CaImportCRLCommandSystemTest {
    ...
    private AuthenticationToken admin = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal("CaImportCRLCommandSystemTest"));
