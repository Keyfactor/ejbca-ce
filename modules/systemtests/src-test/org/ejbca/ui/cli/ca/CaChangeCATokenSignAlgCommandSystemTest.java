 ...
 *
 */
public class CaChangeCATokenSignAlgCommandSystemTest {

    private static final String CA_NAME = "CaChangeCATokenSignAlgCommandSystemTest";
    private static final String CA_DN = "CN=" + CA_NAME;
    
    private final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(CaActivateCACommandSystemTest.class.getSimpleName());
