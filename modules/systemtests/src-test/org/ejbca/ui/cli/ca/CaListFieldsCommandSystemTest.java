 ...
 *
 */
public class CaListFieldsCommandSystemTest {

    private static final String CA_NAME = "CaListFieldsCommandSystemTest";

    private CaListFieldsCommand caListFieldsCommand;

    private AuthenticationToken admin = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal("CaListFieldsCommandSystemTest"));
