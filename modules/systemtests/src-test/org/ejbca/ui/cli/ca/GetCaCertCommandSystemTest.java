 ...
 *
 */
public class GetCaCertCommandSystemTest {
    ...
    private static final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(GetCaCertCommandSystemTest.class.getSimpleName());
    ...
    public static void beforeClass() throws Exception {
        rootCa = CaTestUtils.createTestX509CA("CN=GetCaCertCommandSystemTestRoot", null, false);
        caSession.addCA(authenticationToken, rootCa);
        cainfo = X509CAInfo.getDefaultX509CAInfo("CN=GetCaCertCommandSystemTestSub", "GetCaCertCommandSystemTestSub", CAConstants.CA_ACTIVE,
