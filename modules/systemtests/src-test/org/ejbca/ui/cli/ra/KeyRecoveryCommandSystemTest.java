 ...
 *
 */
public class KeyRecoveryCommandSystemTest {

    private static final String TESTCLASS_NAME = KeyRecoveryCommandSystemTest.class.getSimpleName();
