 ...
 *
 */
public class DeleteEndEntityCommandSystemTest {

    private static final String TESTCLASS_NAME = DeleteEndEntityCommandSystemTest.class.getSimpleName();
    ...
    private static final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal(
            "DeleteEndEntityCommandSystemTest"));
    private final DeleteEndEntityCommand command = new DeleteEndEntityCommand();
