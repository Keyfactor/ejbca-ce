 ...
 *
 */
public class SetSubjDirAttrCommandSystemTest {

    private static final String TESTCLASS_NAME = KeyRecoveryNewestCommandSystemTest.class.getSimpleName();
    private static final String END_ENTITY_SUBJECT_DN = "C=SE, O=PrimeKey, CN=" + TESTCLASS_NAME;
    private static final String TEST_EEPROFILE = "SetSubjDirAttrCommandSystemTest_EEP";
    private static final String TEST_CERTPROFILE = "SetSubjDirAttrCommandSystemTest_CP";
