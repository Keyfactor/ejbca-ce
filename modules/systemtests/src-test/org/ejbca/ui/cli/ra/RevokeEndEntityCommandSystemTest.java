 ...
 */
public class RevokeEndEntityCommandSystemTest extends CaTestCase {

    private static final String USER_NAME = "RevokeEndEntityCommandSystemTest_user1";
    ...
    private AuthenticationToken admin = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal("RevokeEndEntityCommandSystemTest"));
