 ...
 *
 */
public class SetDefaultOcspResponderCommandSystemTest {
    
    private SetDefaultOcspResponderCommand command;
    
    private final GlobalConfigurationSessionRemote globalConfigurationSession = EjbRemoteHelper.INSTANCE.getRemoteSession(GlobalConfigurationSessionRemote.class);
    
    private final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken("SetDefaultOcspResponderCommandSystemTest");
    ...
    public void testSetDefaultResponder() throws AuthorizationDeniedException {
        ...
        final String newValue = "CN=SetDefaultOcspResponderCommandSystemTest";
        try {
