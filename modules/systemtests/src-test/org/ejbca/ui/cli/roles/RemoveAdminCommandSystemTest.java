...
public class RemoveAdminCommandSystemTest {
    ...
    private final String ROLENAME = "AdminsRemoveAdminCommandSystemTest";
    private final AuthenticationToken internalAdmin = new TestAlwaysAllowLocalAuthenticationToken("AdminsRemoveAdminCommandSystemTest");
