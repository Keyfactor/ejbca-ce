 ...
 *
 */
public class CryptoTokenGenerateCommandSystemTest {

    private static final String TOKEN_NAME = CryptoTokenGenerateCommandSystemTest.class.getSimpleName();
    private static final String KEYPAIR_ALIAS = CryptoTokenGenerateCommandSystemTest.class.getSimpleName();

    private final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(
            CryptoTokenGenerateCommandSystemTest.class.getSimpleName());
