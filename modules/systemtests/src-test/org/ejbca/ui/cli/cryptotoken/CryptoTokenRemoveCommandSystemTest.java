 ...
 *
 */
public class CryptoTokenRemoveCommandSystemTest {

    private static final String TOKEN_NAME = CryptoTokenRemoveCommandSystemTest.class.getSimpleName();
    private static final String KEYPAIR_ALIAS = CryptoTokenRemoveCommandSystemTest.class.getSimpleName();

    private final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(
            CryptoTokenRemoveCommandSystemTest.class.getSimpleName());
