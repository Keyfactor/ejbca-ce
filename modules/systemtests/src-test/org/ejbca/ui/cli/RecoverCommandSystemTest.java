 ...
 * <pre>
 *     ant test:runone -Dtest.runone=RecoverCommandSystemTest
 * </pre>.
 */
public class RecoverCommandSystemTest {
    private static final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(RecoverCommandSystemTest.class.getSimpleName());
    private X509CA ca;
