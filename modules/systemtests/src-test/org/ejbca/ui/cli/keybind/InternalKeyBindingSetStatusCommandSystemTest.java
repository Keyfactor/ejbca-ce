 ...
 *
 */
public class InternalKeyBindingSetStatusCommandSystemTest {

    private static final String TESTCLASS_NAME = InternalKeyBindingSetStatusCommandSystemTest.class.getSimpleName();

    private static final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(
            InternalKeyBindingSetStatusCommandSystemTest.class.getSimpleName());
