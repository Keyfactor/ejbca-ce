 ...
 *
 */
public class InternalKeyBindingUpdateCertificateCommandSystemTest {

    private static final String TESTCLASS_NAME = InternalKeyBindingUpdateCertificateCommandSystemTest.class.getSimpleName();

    private static final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(
            InternalKeyBindingUpdateCertificateCommandSystemTest.class.getSimpleName());
