 ...
 *
 */
public class InternalKeyBindingModifyCommandSystemTest {

    private static final String TESTCLASS_NAME = InternalKeyBindingModifyCommandSystemTest.class.getSimpleName();
    ...
    private static final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(
            InternalKeyBindingModifyCommandSystemTest.class.getSimpleName());
