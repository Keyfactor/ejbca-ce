 ...
 *
 */
public class InternalKeyBindingImportCertificateCommandSystemTest {

    private static final String TESTCLASS_NAME = InternalKeyBindingImportCertificateCommandSystemTest.class.getSimpleName();

    private static final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(
            InternalKeyBindingImportCertificateCommandSystemTest.class.getSimpleName());
