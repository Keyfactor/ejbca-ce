 ...
 *
 */
public class InternalKeyBindingDeleteCommandSystemTest {

    private static final String TESTCLASS_NAME = InternalKeyBindingDeleteCommandSystemTest.class.getSimpleName();

    private static final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(
            InternalKeyBindingDeleteCommandSystemTest.class.getSimpleName());
