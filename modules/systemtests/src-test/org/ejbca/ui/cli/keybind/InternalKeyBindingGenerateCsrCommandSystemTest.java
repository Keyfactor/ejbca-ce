 ...
 *
 */
public class InternalKeyBindingGenerateCsrCommandSystemTest {

    private static final Logger log = Logger.getLogger(InternalKeyBindingGenerateCsrCommandSystemTest.class);
    private static final String TESTCLASS_NAME = InternalKeyBindingGenerateCsrCommandSystemTest.class.getSimpleName();

    private static final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(
            InternalKeyBindingGenerateCsrCommandSystemTest.class.getSimpleName());
    ...
    public void testGenerateCsr() throws AuthorizationDeniedException, FileNotFoundException {
        ...
        try {
            ...
            assertEquals("Wrong DN in generated request", "CN=InternalKeyBindingGenerateCsrCommandSystemTest", msg.getRequestDN());
        } catch (Exception e) {
