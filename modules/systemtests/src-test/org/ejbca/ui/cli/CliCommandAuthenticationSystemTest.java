...
import org.ejbca.core.ejb.authentication.cli.CliAuthenticationSystemTestHelperSessionRemote;
 ...
 */
public class CliCommandAuthenticationSystemTest {

    private static final Logger log = Logger.getLogger(CliCommandAuthenticationSystemTest.class);
    ...
    private CliAuthenticationSystemTestHelperSessionRemote cliAuthenticationSystemTestHelperSession = EjbRemoteHelper.INSTANCE.getRemoteSession(
            CliAuthenticationSystemTestHelperSessionRemote.class, EjbRemoteHelper.MODULE_TEST);
    ...
    private final TestAlwaysAllowLocalAuthenticationToken internalAdmin = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal(
            "CliCommandAuthenticationSystemTest"));
    ...
    public void testWithKnownUser() throws Exception {
        cliAuthenticationSystemTestHelperSession.createUser(CliAuthenticationSystemTestHelperSessionRemote.USERNAME,
                CliAuthenticationSystemTestHelperSessionRemote.PASSWORD);
        try {
            mockCliCommand.execute(new String[] { "foo", "-u", CliAuthenticationSystemTestHelperSessionRemote.USERNAME,
                    "--clipassword=" + CliAuthenticationSystemTestHelperSessionRemote.PASSWORD });
        } catch (CliTestRuntimeException e) {
            fail("Exception was thrown when authenticating with a known user.");
        } finally {
            endEntityManagementSession.deleteUser(internalAdmin, CliAuthenticationSystemTestHelperSessionRemote.USERNAME);
        }
    }
    ...
    public void testWithKnownUserPasswordInFile() throws Exception {
        ...
        try {
            ...
            CommandResult result = mockCliCommand.execute(new String[] { "-u", CliAuthenticationSystemTestHelperSessionRemote.USERNAME,
            ...
            result = mockCliCommand.execute(new String[] { "-u", CliAuthenticationSystemTestHelperSessionRemote.USERNAME,
            ...
            fout.write(CliAuthenticationSystemTestHelperSessionRemote.PASSWORD);
            fout.close();
