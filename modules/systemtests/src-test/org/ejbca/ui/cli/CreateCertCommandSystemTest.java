 ...
 *
 */
public class CreateCertCommandSystemTest {

    private static final String CA_DN = "CN=Test";
    private static final String USERNAME = "CreateCertCommandSystemTest";
    ...
    private final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(CreateCertCommandSystemTest.class.getSimpleName());
