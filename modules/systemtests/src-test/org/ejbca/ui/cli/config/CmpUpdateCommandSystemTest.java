 ...
 */
public class CmpUpdateCommandSystemTest extends CmpTestCase{
    
    private static final Logger log = Logger.getLogger(CmpUpdateCommandSystemTest.class);
    private  CmpConfiguration cmpConfiguration;
    private final static String ALIAS = "DefaultProfileSystemTestConfAlias";
    ...
    public CmpUpdateCommandSystemTest() throws Exception {
