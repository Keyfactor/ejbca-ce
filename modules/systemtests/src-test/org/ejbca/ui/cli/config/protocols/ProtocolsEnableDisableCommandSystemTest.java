 ...
 * @version $Id$
 */
public class ProtocolsEnableDisableCommandSystemTest {

    private static final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(ProtocolsEnableDisableCommandSystemTest.class.getSimpleName());
