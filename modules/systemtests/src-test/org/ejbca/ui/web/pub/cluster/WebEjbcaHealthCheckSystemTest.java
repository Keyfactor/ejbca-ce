...
public class WebEjbcaHealthCheckSystemTest extends WebHealthTestAbstract {
    ...
    private static final Logger log = Logger.getLogger(WebEjbcaHealthCheckSystemTest.class);

    private static final String CA_DN = "CN=WebEjbcaHealthCheckSystemTestCA";
    private static final String SIGNER_DN = "CN=WebEjbcaHealthCheckSystemTestOcspSigner";
    ...
    private static final String TESTCLASSNAME = WebEjbcaHealthCheckSystemTest.class.getSimpleName();
    private static final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(
            WebEjbcaHealthCheckSystemTest.class.getSimpleName());
