 ...
 */
public class CertRevocationStatusCheckerSystemTest extends CaTestCase {

    @Override
    public String getRoleName() {
        return "CertRevocationStatusCheckerSystemTest";
    }
    ...
    private static final Logger log = Logger.getLogger(CertRevocationStatusCheckerSystemTest.class);
    ...
    public void setUp() throws Exception {
        ...
        certprofileName = "CertRevocationStatusCheckerSystemTestCertProfile";
        ...
        final String eepname = "CertRevocationStatusCheckerSystemTestEndEntityProfile";
    ...
    public void tearDown() throws Exception {
        try {
            ...
            endEntityProfileSession.removeEndEntityProfile(alwaysAllowToken, "CertRevocationStatusCheckerSystemTestEndEntityProfile");
        } finally {
