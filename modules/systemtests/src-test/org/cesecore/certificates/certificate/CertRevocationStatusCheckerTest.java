...
public class CertRevocationStatusCheckerTest extends CaTestCase {
    ...
    public void test04VerificationWithCRLFromCertExtension() throws Exception {
        ...
        try {
            ...
            // Generate CRL
            Collection<RevokedCertInfo> revcerts = certStoreSession.listRevokedCertInfo(CADN, CertificateConstants.NO_CRL_PARTITION, -1);
            ...
            revcerts = certStoreSession.listRevokedCertInfo(CADN, CertificateConstants.NO_CRL_PARTITION, -1);
    ...
    public void test07VerificationWithMultipleCRLs() throws Exception {
        ...
        try {
            ...
            revcerts = certStoreSession.listRevokedCertInfo(testca2SubjectDN, CertificateConstants.NO_CRL_PARTITION, -1);
