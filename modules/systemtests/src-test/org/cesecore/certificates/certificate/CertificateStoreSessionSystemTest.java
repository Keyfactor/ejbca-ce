 ...
 * @version $Id$
 */
public class CertificateStoreSessionSystemTest extends RoleUsingTestCase {

    private static final Logger log = Logger.getLogger(CertificateStoreSessionSystemTest.class);
    private static KeyPair keys;

    private static final String USERNAME = "CertificateStoreSessionSystemTest";
    private static final String SELFCERT_DN = "C=SE,O=PrimeKey,OU=TestCertificateData,CN=MyNameIsFoo";
    private static final String CROSS_CERT_CA_NAME = "CertificateStoreSessionSystemTest-CrossCertCa";
    ...
    private final AuthenticationToken alwaysAllowToken = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal("CertificateStoreSessionSystemTest"));

    @BeforeClass
    public static void setUpProvider() throws Exception {
        CryptoProviderTools.installBCProvider();
        keys = KeyTools.genKeys("512", AlgorithmConstants.KEYALGORITHM_RSA);
        EjbRemoteHelper.INSTANCE.getRemoteSession(InternalCertificateStoreSessionRemote.class, EjbRemoteHelper.MODULE_TEST).removeCertificatesBySubject(SELFCERT_DN);
    }
    ...
    @Test
    public void testFindUsernameByIssuerDnAndSerialNumber() throws IllegalStateException, OperatorCreationException, CertificateException,
    ...
    public void testLimitedCertificateDataFindByUsername() throws AuthorizationDeniedException {
        final String username = CertificateStoreSessionSystemTest.class.getName()+"_NonExistent";
    ...
    public void testGetCertificateDataByUsername() throws CertificateParsingException, OperatorCreationException, CertIOException, InvalidAlgorithmParameterException {
        ...
        final X509Certificate x509Certificate1 = SimpleCertGenerator.forTESTCaCert()
        ...
        final X509Certificate x509Certificate2 = SimpleCertGenerator.forTESTCaCert()
                .setSubjectDn("CN="+USERNAME)
                .setIssuerDn("CN="+USERNAME)
                .setFirstDate(date10sAgo)
        ...
        final X509Certificate x509Certificate3 = SimpleCertGenerator.forTESTCaCert()
                .setSubjectDn("CN="+USERNAME)
                .setIssuerDn("CN="+USERNAME)
                .setFirstDate(date10sAgo)
                .setLastDate(date1hFromNow)
        ...
        final X509Certificate x509Certificate4 = SimpleCertGenerator.forTESTCaCert()
                .setSubjectDn("CN="+USERNAME)
                .setIssuerDn("CN="+USERNAME)
                .setFirstDate(date10sAgo)
                .setLastDate(date1hFromNow)
...
//	}
    ...
    private X509Certificate generateCert(final AuthenticationToken admin, final int status) throws AuthorizationDeniedException, IllegalStateException,
        ...
        X509Certificate xcert = SimpleCertGenerator.forTESTLeafCert()
                .setSubjectDn(SELFCERT_DN)
                .setIssuerDn(SELFCERT_DN)
                .setValidityDays(24)
    ...
    public void testCrossCaCertChainSearch() throws Exception {
        ...
        X509Certificate rootCert1 = SimpleCertGenerator.forTESTCaCert()
                ...
                .setFirstDate(new Date(System.currentTimeMillis() - validity))
                .setLastDate(new Date(System.currentTimeMillis() + validity))
                .setSelfSignKeyPair(rootCaKeyPair1)
                .setSignatureAlgorithm(AlgorithmConstants.SIGALG_SHA256_WITH_RSA)
                .setLdapOrder(true)
                .generateCertificate();             
        ...
        X509Certificate intermediateCaCert = SimpleCertGenerator.forTESTCaCert()
                .setSubjectDn(intermediateDn)
                .setIssuerDn(rootCaDn)
                .setFirstDate(new Date(System.currentTimeMillis() - validity))
                .setLastDate(new Date(System.currentTimeMillis() + validity))
                .setIssuerPrivKey(rootCaKeyPair1.getPrivate())
                .setEntityPubKey(intermediateCaKeyPair.getPublic())
                .setSignatureAlgorithm(AlgorithmConstants.SIGALG_SHA256_WITH_RSA)
                .setLdapOrder(true)
                .generateCertificate();
        ...
        X509Certificate subCaCert = SimpleCertGenerator.forTESTCaCert()
                .setSubjectDn("CN="+CROSS_CERT_CA_NAME)
                .setIssuerDn(intermediateDn)
                .setFirstDate(new Date(System.currentTimeMillis() - validity))
                .setLastDate(new Date(System.currentTimeMillis() + validity))
                .setIssuerPrivKey(intermediateCaKeyPair.getPrivate())
        ...
        try {
            ...
            assertEquals("certificateChain length is wrong." , 4, certificateChain.size());
