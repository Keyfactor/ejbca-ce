 ...
 * @version $Id$
 */
public class OcspResponseCleanupSessionBeanSystemTest {
    private static final Logger log = Logger.getLogger(OcspResponseCleanupSessionBeanSystemTest.class);
    ...
    private static final AuthenticationToken alwaysAllowToken = new TestAlwaysAllowLocalAuthenticationToken(OcspResponseCleanupSessionBeanSystemTest.class.getName());
