 ...
 * @version $Id$
 */
public class CertificateProfileSessionSystemTest extends RoleUsingTestCase {
    private static final Logger log = Logger.getLogger(CertificateProfileSessionSystemTest.class);
