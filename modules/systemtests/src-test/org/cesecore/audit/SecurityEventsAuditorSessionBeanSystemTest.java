 ...
 * 
 */
public class SecurityEventsAuditorSessionBeanSystemTest extends SecurityEventsBase {
    ...
    public static void setUpCryptoProvider() throws Exception {
        ...
        final AuthenticationToken authenticationToken = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal(SecurityEventsAuditorSessionBeanSystemTest.class.getSimpleName()));
