...
public class InternalKeyBindingMgmtSystemTest {
    ...
    private static final Logger log = Logger.getLogger(InternalKeyBindingMgmtSystemTest.class);
    private static final AuthenticationToken alwaysAllowToken = new TestAlwaysAllowLocalAuthenticationToken(new UsernamePrincipal(InternalKeyBindingMgmtSystemTest.class.getSimpleName()));
    ...
    public InternalKeyBindingMgmtSystemTest(CryptoTokenRunner cryptoTokenRunner) throws Exception {
