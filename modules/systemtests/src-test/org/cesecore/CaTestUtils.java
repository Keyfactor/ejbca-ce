...
public abstract class CaTestUtils {
    ...
    public static ECA createTestECAOptionalGenKeys(AuthenticationToken admin, String cadn, char[] tokenpin, boolean pkcs11, final String keyspec) throws Exception {
        ...
        CitsCaInfo ecaInfo = CitsCaInfo.getDefaultCitsCaInfo(cadn, "Test ECA", "5y", "ECA-TEST-1", 2079976939, 2079976939, catoken);
        ItsGeographicRegion region = ItsGeographicRegion.fromString("rectangle:12,23,34,56;78,90,76,65");
        ecaInfo.setRegion(region);
