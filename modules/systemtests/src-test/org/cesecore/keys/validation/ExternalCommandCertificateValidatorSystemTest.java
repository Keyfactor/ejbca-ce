 ...
 * @version $Id$
 */
public class ExternalCommandCertificateValidatorSystemTest {

    /** Class logger. */
    private static final Logger log = Logger.getLogger(ExternalCommandCertificateValidatorSystemTest.class);
