...
public class P11Slot {
    ...
    /**
     * As {@link #getInstance(String, String, boolean, String, com.keyfactor.util.keys.token.pkcs11.P11Slot.P11SlotUser)} but is using config file instead of parameters. 
