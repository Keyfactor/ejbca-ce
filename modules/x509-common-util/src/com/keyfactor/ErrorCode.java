...
public class ErrorCode implements Serializable {
    ...
    private static final String _CA_MS_COMPATIBILITY_IRREVERSIBLE = "CA_MS_COMPATIBILITY_IRREVERSIBLE"; // CA MS compatibility irreversible.
    ...
    private static final String _INTERNAL_KEY_BINDING_NONCE_CONFLICT = "INTERNAL_KEY_BINDING_NONCE_CONFLICT"; // The internal key binding nonce setting conflicts with the CA's pre-produce OCSP Responses setting
    ...
    /** CA MS compatibility irreversible. */
    public static final ErrorCode CA_MS_COMPATIBILITY_IRREVERSIBLE = new ErrorCode(_CA_MS_COMPATIBILITY_IRREVERSIBLE);
    ...
    public static final ErrorCode CERTIFICATE_FOR_THIS_KEY_ALREADY_EXISTS_FOR_ANOTHER_USER = new ErrorCode(_CERTIFICATE_FOR_THIS_KEY_ALREADY_EXISTS_FOR_ANOTHER_USER);
    public static final ErrorCode CERTIFICATE_FOR_THIS_KEY_ALREADY_EXISTS = new ErrorCode(_CERTIFICATE_FOR_THIS_KEY_ALREADY_EXISTS);
    ...
    public static final ErrorCode INTERNAL_KEY_BINDING_NONCE_CONFLICT = new ErrorCode(_INTERNAL_KEY_BINDING_NONCE_CONFLICT);
