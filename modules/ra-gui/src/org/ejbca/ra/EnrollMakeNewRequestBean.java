...
public class EnrollMakeNewRequestBean implements Serializable {
    ...
    private void initAvailableCertificateProfiles(){
        ...
        availableCertificateProfiles = raMasterApiProxyBean.getAvailableCertificateProfiles(availableCertificateProfileIds);
    ...
    private void initAvailableCertificateAuthorities(){
        ...
        String[] availableCertificateAuthorities = endEntityProfile.getValue(EndEntityProfile.AVAILCAS, 0).split(EndEntityProfile.SPLITCHAR);
    }
