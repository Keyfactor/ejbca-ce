...
public class ObjectFactory {
    ...
    private final static QName _ImportCaCertArg1_QNAME = new QName("", "arg1");
    ...
    public JAXBElement<byte[]> createGetLatestCRLResponseReturn(byte[] value) {
        return new JAXBElement<byte[]>(_CaRenewCertRequestResponseReturn_QNAME, byte[].class, GetLatestCRLResponse.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createImportCaCertArg1(byte[] value) {
        return new JAXBElement<byte[]>(_ImportCaCertArg1_QNAME, byte[].class, ImportCaCert.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createGetProfileResponseReturn(byte[] value) {
        return new JAXBElement<byte[]>(_CaRenewCertRequestResponseReturn_QNAME, byte[].class, GetProfileResponse.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createUpdateCaCertArg1(byte[] value) {
        return new JAXBElement<byte[]>(_ImportCaCertArg1_QNAME, byte[].class, UpdateCaCert.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createCaCertResponseForRolloverArg1(byte[] value) {
        return new JAXBElement<byte[]>(_ImportCaCertArg1_QNAME, byte[].class, CaCertResponseForRollover.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createCaCertResponseArg1(byte[] value) {
        return new JAXBElement<byte[]>(_ImportCaCertArg1_QNAME, byte[].class, CaCertResponse.class, ((byte[]) value));
    }
