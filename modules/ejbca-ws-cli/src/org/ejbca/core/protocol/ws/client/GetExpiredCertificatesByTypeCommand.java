 ...
 */
public class GetExpiredCertificatesByTypeCommand extends EJBCAWSRABaseCommand implements IAdminCommand{
    ...
    public GetExpiredCertificatesByTypeCommand(String[] args) {
        super(args);
    }
    ...
    public void execute() throws IllegalAdminCommandException, ErrorAdminCommandException {
        ...
        try {   
            ...
            int certType = Integer.parseInt(args[ARG_TYPE]);
            ...
            try{
                List<Certificate> result = getEjbcaRAWS().getCertificatesByExpirationTimeAndType(days, certType, maxNumberOfResults);
                
                if(result==null || result.size() == 0){
                    getPrintStream().println("No certificate will expire within " + days + " days and are of type " + certType);
                }else{
