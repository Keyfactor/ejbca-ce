...
public class CvcRequestCommand extends EJBCAWSRABaseCommand implements IAdminCommand{
	...
	protected void usage() {
		...
		getPrintStream().println("If genreq is true (just enter true, not 'genreq=true') a new request is generated and the generated request is written to <basefilename>.cvreq, and the private key to <basefilename>.pkcs8.");
