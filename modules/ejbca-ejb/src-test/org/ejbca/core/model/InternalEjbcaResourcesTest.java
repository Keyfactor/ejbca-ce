...
public class InternalEjbcaResourcesTest {
    ...
    public void testGetLocalizedMessageStringObject() {
        InternalEjbcaResources intres = new InternalEjbcaResources(TEST_RESOURCE_PATH);
        String res = intres.getLocalizedMessage("test.testparams", new Long(1), new Integer(3), "hi", Boolean.valueOf(true), "bye");
        assertEquals("Test 1 3 hi true bye message 1", res);
        assertEquals("Test 1 3 hi true bye message 1", intres.getLocalizedMessageCs("test.testparams", Long.valueOf(1), Integer.valueOf(3), "hi", Boolean.valueOf(true), "bye").toString());
    }

	@Test
    public void testGetLocalizedMessageStringObjectWithNull() {
        InternalEjbcaResources intres = new InternalEjbcaResources(TEST_RESOURCE_PATH);
        String res = intres.getLocalizedMessage("test.testparams", null, Integer.valueOf(3), null, Boolean.valueOf(true), "bye");
        assertEquals("Test  3  true bye message ", res);
        assertEquals("Test  3  true bye message ", intres.getLocalizedMessageCs("test.testparams", null, Integer.valueOf(3), null, Boolean.valueOf(true), "bye").toString());
    ...
    public void testCeSecoreMessage() {
        ...
        assertEquals("Test 1 3 hi true bye message 1", res);    	
        assertEquals("Test 1 3 hi true bye message 1", intres.getLocalizedMessageCs("raadmin.testparams", Long.valueOf(1), Integer.valueOf(3), "hi", Boolean.valueOf(true), "bye").toString());
    }
