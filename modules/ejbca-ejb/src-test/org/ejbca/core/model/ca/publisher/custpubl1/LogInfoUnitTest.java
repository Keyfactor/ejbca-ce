...
public class LogInfoUnitTest {
    ...
    public void testConstructAndEncode() throws Exception {
        ...
        assertEquals("get encoded 1", " time:19700101000004.711Z sqn: stage: level:info msgid: msg:Some message msgext:", instance.getEncoded());
        ...
        instance = new CustomerLdapPublisher1.LogInfo(expectedDate, expectedSqn, expectedStage, expectedLevel, expectedMsgid, expectedMessage, expectedMsgext);
        assertEquals("get date", expectedDate, instance.getTime());
        ...
        assertEquals("get encoded 2", " time:19700101000004.711Z sqn:13 stage:Download level:info msgid:023 msg:Some message msgext:uploadtype=DSC lastTryTime=20121030121233Z lastTryTime=20121030121233.12Z", instance.getEncoded());
        
        // Test erroneus msgid
        try {
            String erronousMsgid = "1234";
            CustomerLdapPublisher1.LogInfo logInfo = new CustomerLdapPublisher1.LogInfo(expectedDate, expectedSqn, expectedStage, expectedLevel, erronousMsgid, expectedMessage, expectedMsgext);
