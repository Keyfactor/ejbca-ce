...
public class NoCacheFilter implements Filter {
     ...
     * @return true for the request URIs that should be cached, false otherwise.
     */
    private boolean cacheURI(HttpServletRequest request) {
        String requestUri = request.getRequestURI();
        return requestUri.startsWith(request.getContextPath() + "/styles") || 
               requestUri.startsWith(request.getContextPath() + "/scripts") ||
