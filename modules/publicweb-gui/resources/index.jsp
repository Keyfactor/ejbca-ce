<%@ include file="header.jsp" %>
  ...
  <ul>
	  ...
	  <li>Request Browser Certificate Renewal - Authenticate using a browser certificate and request it to be renewed. Requires client certificate authentication.</li>
  </ul>
  <h2>Retrieve</h2>
  <ul>
