...
public interface CaSessionLocal extends CaSession {
    ...
    /** Changes a CA in the database. Can change mostly everything except caid, caname. When editing a CA the CA token will usually be taken off line.
     * So you need to activate the CA token after editing, if auto-activation of the CA token is not enabled. 
     * 
     * @param admin AuthenticationToken of admin
     * @param ca the CA to edit
     ...
     * @throws AuthorizationDeniedException
     */
    void editCAWithNewSubjectDn(final AuthenticationToken admin, final CA ca, boolean auditlog) throws CADoesntExistsException, AuthorizationDeniedException;
