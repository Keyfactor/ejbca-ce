 ...
 * @version $Id$
 */
final class CertificateSerializableWrapper implements CertificateWrapper, Comparable<CertificateSerializableWrapper>, Serializable {
    ...
    @Override
    public int compareTo(final CertificateSerializableWrapper other) {
