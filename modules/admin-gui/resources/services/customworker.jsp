...
%>
	...
	<h:panelGroup rendered="#{editService.customWorkerType.customUiRenderingSupported}">
		<h:dataTable style="margin-top: 0px; width: 100%;" styleClass="edit-ctnd" value="#{editService.customWorkerType.customUiPropertyList}" var="customUiProperty"
			...
			<h:column>
				<h:inputText rendered="#{customUiProperty.typeText}" value="#{customUiProperty.value}" style="min-width: 240px;"/>
				<h:selectBooleanCheckbox rendered="#{customUiProperty.typeBoolean}" value="#{customUiProperty.booleanValue}"/>
				<h:selectOneMenu rendered="#{customUiProperty.typeSelectOne}" value="#{customUiProperty.value}" style="min-width: 240px;">
					<f:selectItems value="#{editService.customWorkerType.customUiPropertySelectItems}"/>
				</h:selectOneMenu>
				<h:selectManyListbox rendered="#{customUiProperty.typeSelectMany}" value="#{customUiProperty.multiValue}" style="min-width: 240px;">
					<f:selectItems value="#{editService.customWorkerType.customUiPropertySelectItems}"/>
				</h:selectManyListbox>
			</h:column>
		</h:dataTable>
