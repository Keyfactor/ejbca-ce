...
<body id="header">
	<div id="banner">
		<a href="<%= ejbcawebbean.getAdminWebBaseUrl() %>" target="_top"><img src="<%= ejbcawebbean.getAdminWebBaseUrl() + ejbcawebbean.getImagefileInfix("banner_"+org.ejbca.config.InternalConfiguration.getAppNameLower()+"-admin-test.png") %>" alt="<c:out value="<%= org.ejbca.config.InternalConfiguration.getAppNameCapital() %>" />" /></a>
	</div>
</body>
</html>
