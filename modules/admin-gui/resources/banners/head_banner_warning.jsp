...
<html>
<jsp:useBean id="ejbcawebbean" scope="session" class="org.ejbca.ui.web.admin.configuration.EjbcaWebBeanImpl" />
...
<body id="header">
	<div id="banner">
		<a href="<%= ejbcawebbean.getAdminWebBaseUrl() %>" target="_top"><img src="<%= ejbcawebbean.getAdminWebBaseUrl() + ejbcawebbean.getImagePath(ejbcawebbean.getEditionFolder() + "/keyfactor-"+ org.ejbca.config.InternalConfiguration.getAppNameLower() +"-logo-warning.png") %>" alt="<c:out value="<%= org.ejbca.config.InternalConfiguration.getAppNameCapital() %>" />" /></a>
	</div>
</body>
</html>
