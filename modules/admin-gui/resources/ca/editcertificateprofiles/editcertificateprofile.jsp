...
<div align="center">
  <h2><h:outputText value="#{web.text.EDITCERTIFICATEPROFILE}" rendered="#{certProfilesBean.authorizedToEdit}"/><h:outputText value="#{web.text.VIEWCERTIFICATEPROFILE}" rendered="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}" /></h2>
...
<h:form id="cpf">
	...
	<h:panelGrid columns="2" styleClass="edit-top" cellspacing="3" cellpadding="3" border="0" width="100%" rowClasses="Row0,Row1" columnClasses="editColumn1,editColumn2">
		...
		<h:panelGroup id="selecttype">
			<h:commandButton rendered="#{certProfileBean.typeEndEntityAvailable}" disabled="#{certProfileBean.typeEndEntity or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"
				action="#{certProfileBean.setTypeEndEntity}" value="#{certProfileBean.typeEndEntity?'✓':' '}#{web.text.ENDENTITY}"/>
			<h:commandButton rendered="#{certProfileBean.typeSubCaAvailable or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}" disabled="#{certProfileBean.typeSubCa or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"
				action="#{certProfileBean.setTypeSubCa}" value="#{certProfileBean.typeSubCa?'✓':' '}#{web.text.SUBCA}"/>
			<h:commandButton rendered="#{certProfileBean.typeRootCaAvailable or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}" disabled="#{certProfileBean.typeRootCa or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"
				action="#{certProfileBean.setTypeRootCa}" value="#{certProfileBean.typeRootCa?'✓':' '}#{web.text.ROOTCA}"/>
			<h:commandButton rendered="#{certProfileBean.typeHardTokenAvailable or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}" disabled="#{certProfileBean.typeHardToken or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"
		...
		<h:selectManyListbox id="selectavailablebitlengths" value="#{certProfileBean.certificateProfile.availableBitLengths}" size="5" styleClass="number" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}">
		...
		<h:selectOneMenu id="selectsignaturealgorithm" value="#{certProfileBean.signatureAlgorithm}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}">
		...
		<h:panelGroup>
			<h:inputText id="textfieldvalidity" value="#{certProfileBean.validity}" title="#{web.text.FORMAT_TIME_YMD} #{web.text.OR} #{web.text.FORMAT_ISO8601}" size="25" maxlength="255"
				disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
			<br/>
	...
	<h:panelGrid columns="2" styleClass="edit-top" cellspacing="3" cellpadding="3" border="0" width="100%" rowClasses="Row0,Row1" columnClasses="editColumn1,editColumn2">
		...
		<h:panelGroup id="checkallowvalidityoverridegroup">
			<h:selectBooleanCheckbox id="checkallowvalidityoverride" value="#{certProfileBean.certificateProfile.allowValidityOverride}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="checkallowextensionoverridegroup">
			<h:selectBooleanCheckbox id="checkallowextensionoverride" value="#{certProfileBean.certificateProfile.allowExtensionOverride}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="allowcertserialnumberoverridegroup">
			...
			<h:selectBooleanCheckbox rendered="#{certProfileBean.uniqueCertificateSerialNumberIndex}" id="allowcertserialnumberoverride"
				value="#{certProfileBean.certificateProfile.allowCertSerialNumberOverride}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="checkallowdnoverridegroup">
			<h:selectBooleanCheckbox id="checkallowdnoverride" value="#{certProfileBean.certificateProfile.allowDNOverride}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="checkallowdnoverrideeeigroup">
			<h:selectBooleanCheckbox id="checkallowdnoverrideeei" value="#{certProfileBean.certificateProfile.allowDNOverrideByEndEntityInformation}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="checkallowkeyusageoverridegroup">
			<h:selectBooleanCheckbox id="checkallowkeyusageoverride" value="#{certProfileBean.certificateProfile.allowKeyUsageOverride}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="checkallowbackdatedrevokationgroup">
			<h:selectBooleanCheckbox id="checkallowbackdatedrevokation" value="#{certProfileBean.certificateProfile.allowBackdatedRevocation}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="checkUseCertificateStorageGroup" rendered="#{!certProfileBean.typeCA}">
			<h:selectBooleanCheckbox id="checkUseCertificateStorage" value="#{certProfileBean.certificateProfile.useCertificateStorage}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="checkStoreCertificateDataGroup" rendered="#{!certProfileBean.typeCA}">
			<h:selectBooleanCheckbox id="checkStoreCertificateData" value="#{certProfileBean.certificateProfile.storeCertificateData}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
	...
	<h:panelGrid columns="2" styleClass="edit-top" cellspacing="3" cellpadding="3" border="0" width="100%" rowClasses="Row0,Row1" columnClasses="editColumn1,editColumn2">
		...
		<h:panelGroup id="cbbasicconstraintsgroup">
			...
			<h:commandButton id="cbbasicconstraints" styleClass="checkBoxOverlay" action="#{certProfileBean.toggleUseBasicConstraints}"
				value="#{certProfileBean.certificateProfile.useBasicConstraints?web.text.BOOL_TRUE:web.text.BOOL_FALSE}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
			...
			<h:selectBooleanCheckbox id="cbbasicconstraintscritical" value="#{certProfileBean.certificateProfile.basicConstraintsCritical}"
				disabled="#{!certProfileBean.certificateProfile.useBasicConstraints or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="checkusepathlengthconstraintgroup" rendered="#{certProfileBean.typeCA}">
			...
			<h:inputText id="textfieldpathlengthconstraint" value="#{certProfileBean.certificateProfile.pathLengthConstraint}" size="2" maxlength="2"
				disabled="#{!certProfileBean.certificateProfile.usePathLengthConstraint || !certProfileBean.certificateProfile.useBasicConstraints || certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"
		...
		<h:panelGroup id="cbauthoritykeyidentifiergroup">
			<h:selectBooleanCheckbox id="cbauthoritykeyidentifier" value="#{certProfileBean.certificateProfile.useAuthorityKeyIdentifier}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="cbsubjectkeyidentifiergroup">
			<h:selectBooleanCheckbox id="cbsubjectkeyidentifier" value="#{certProfileBean.certificateProfile.useSubjectKeyIdentifier}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGrid columns="1">
			<h:panelGroup id="cbkeyusagegroup">
				...
				<h:commandButton id="cbkeyusage" styleClass="checkBoxOverlay" action="#{certProfileBean.toggleUseKeyUsage}"
					value="#{certProfileBean.certificateProfile.useKeyUsage?web.text.BOOL_TRUE:web.text.BOOL_FALSE}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				...
				<h:selectBooleanCheckbox id="cbkeyusagecritical" value="#{certProfileBean.certificateProfile.keyUsageCritical}"
					disabled="#{!certProfileBean.certificateProfile.useKeyUsage or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/> 
			...
			<h:panelGrid id="keyUsageSelection" columns="6" rendered="#{certProfileBean.certificateProfile.useKeyUsage}">
				<h:selectBooleanCheckbox id="keyUsageDigitalSignature" value="#{certProfileBean.keyUsageDigitalSignature}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				<h:outputLabel for="keyUsageDigitalSignature" value="#{web.text.KU_DIGITALSIGNATURE}"/>
				<h:selectBooleanCheckbox id="keyUsageDataEncipherment" value="#{certProfileBean.keyUsageDataEncipherment}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				<h:outputLabel for="keyUsageDataEncipherment" value="#{web.text.KU_DATAENCIPHERMENT}"/>
				<h:selectBooleanCheckbox id="keyUsageKeyCrlSign" value="#{certProfileBean.keyUsageKeyCrlSign}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				<h:outputLabel for="keyUsageKeyCrlSign" value="#{web.text.KU_CRLSIGN}"/>

				<h:selectBooleanCheckbox id="keyUsageNonRepudiation" value="#{certProfileBean.keyUsageNonRepudiation}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				<h:outputLabel for="keyUsageNonRepudiation" value="#{web.text.KU_NONREPUDIATION}"/>
				<h:selectBooleanCheckbox id="keyUsageKeyAgreement" value="#{certProfileBean.keyUsageKeyAgreement}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				<h:outputLabel for="keyUsageKeyAgreement" value="#{web.text.KU_KEYAGREEMENT}"/>
				<h:selectBooleanCheckbox id="keyUsageEncipherOnly" value="#{certProfileBean.keyUsageEncipherOnly}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				<h:outputLabel for="keyUsageEncipherOnly" value="#{web.text.KU_ENCIPHERONLY}"/>

				<h:selectBooleanCheckbox id="keyUsageKeyEncipherment" value="#{certProfileBean.keyUsageKeyEncipherment}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				<h:outputLabel for="keyUsageKeyEncipherment" value="#{web.text.KU_KEYENCIPHERMENT}"/>
				<h:selectBooleanCheckbox id="keyUsageKeyCertSign" value="#{certProfileBean.keyUsageKeyCertSign}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				<h:outputLabel for="keyUsageKeyCertSign" value="#{web.text.KU_KEYCERTSIGN}"/>
				<h:selectBooleanCheckbox id="keyUsageDecipherOnly" value="#{certProfileBean.keyUsageDecipherOnly}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGrid columns="1">
			<h:panelGroup id="checkuseextendedkeyusagegroup">
				...
				<h:commandButton id="checkuseextendedkeyusage" styleClass="checkBoxOverlay" action="#{certProfileBean.toggleUseExtendedKeyUsage}"
					value="#{certProfileBean.certificateProfile.useExtendedKeyUsage?web.text.BOOL_TRUE:web.text.BOOL_FALSE}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				...
				<h:selectBooleanCheckbox id="cbextendedkeyusagecritical" value="#{certProfileBean.certificateProfile.extendedKeyUsageCritical}"
					disabled="#{!certProfileBean.certificateProfile.useExtendedKeyUsage or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
			...
			<h:selectManyListbox id="selectextendedkeyusage" value="#{certProfileBean.certificateProfile.extendedKeyUsageOids}" size="10"
				rendered="#{certProfileBean.certificateProfile.useExtendedKeyUsage}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}">
		...
		<h:panelGrid id="certificatePolicies" columns="1">
			<h:panelGroup>
				...
				<h:commandButton id="checkusecertificatepolicies" styleClass="checkBoxOverlay" action="#{certProfileBean.toggleUseCertificatePolicies}"
					value="#{certProfileBean.certificateProfile.useCertificatePolicies?web.text.BOOL_TRUE:web.text.BOOL_FALSE}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				...
				<h:selectBooleanCheckbox id="checkcertificatepoliciescritical" value="#{certProfileBean.certificateProfile.certificatePoliciesCritical}"
					disabled="#{!certProfileBean.certificateProfile.useCertificatePolicies or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
			...
			<h:dataTable value="#{certProfileBean.certificatePolicies}" var="certificatePolicy" rendered="#{certProfileBean.certificateProfile.useCertificatePolicies}">
						...
						<h:panelGrid columns="1">
							...
							<h:panelGrid id="policyqualidinput" columns="3">
								<h:commandButton value="#{certProfileBean.newCertificatePolicyQualifierIdNone?'✓':' '}#{web.text.EXT_PKIX_CP_NOQUAL}"
									action="#{certProfileBean.actionNewCertificatePolicyQualifierIdNone}" disabled="#{certProfileBean.newCertificatePolicyQualifierIdNone or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"
								...
								<h:commandButton value="#{certProfileBean.newCertificatePolicyQualifierIdUserNotice?'✓':' '}#{web.text.EXT_PKIX_CP_USERNOTICE}"
									...
									disabled="#{certProfileBean.newCertificatePolicyQualifierIdUserNotice or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"
									title="#{web.text.EXT_PKIX_CP_POLICYQUALID}"/>
								<h:commandButton value="#{certProfileBean.newCertificatePolicyQualifierIdCpsUri?'✓':' '}#{web.text.EXT_PKIX_CP_CPSURI}"
									...
									disabled="#{certProfileBean.newCertificatePolicyQualifierIdCpsUri or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"
									title="#{web.text.EXT_PKIX_CP_POLICYQUALID}"/>
							</h:panelGrid>
				...
				<h:column>
					<h:commandButton id="buttondeletepolicy" value="#{web.text.DELETE}" action="#{certProfileBean.deleteCertificatePolicy}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
					<f:facet name="footer">
						<h:commandButton id="buttonaddpolicy" value="#{web.text.ADD}" action="#{certProfileBean.addCertificatePolicy}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
					</f:facet>
				</h:column>
			</h:dataTable>
		</h:panelGrid>
	...
	<h:panelGrid columns="2" styleClass="edit-top subsection" cellspacing="3" cellpadding="3" border="0" width="100%" rowClasses="Row0,Row1" columnClasses="editColumn1,editColumn2">
		...
		<h:panelGroup id="cbsubjectalternativenamegroup">
			...
			<h:selectBooleanCheckbox id="cbsubjectalternativenamecritical" value="#{certProfileBean.certificateProfile.subjectAlternativeNameCritical}"
				disabled="#{!certProfileBean.certificateProfile.useSubjectAlternativeName or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="cbissueralternativenamegroup">
			...
			<h:selectBooleanCheckbox id="cbissueralternativenamecritical" value="#{certProfileBean.certificateProfile.issuerAlternativeNameCritical}"
				disabled="#{!certProfileBean.certificateProfile.useIssuerAlternativeName or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/> 
		...
		<h:panelGroup id="checknameconstraintsgroup">
			...
			<h:selectBooleanCheckbox id="checknameconstraintscritical" value="#{certProfileBean.certificateProfile.nameConstraintsCritical}"
				disabled="#{!certProfileBean.certificateProfile.useNameConstraints or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
	...
	<h:panelGrid columns="2" styleClass="edit-top subsection" cellspacing="3" cellpadding="3" border="0" width="100%" rowClasses="Row0,Row1" columnClasses="editColumn1,editColumn2">
		...
		<h:panelGroup id="cbcrldistributionpointgroup">
			...
			<h:selectBooleanCheckbox id="cbcrldistributionpointcritical" value="#{certProfileBean.certificateProfile.CRLDistributionPointCritical}"
				disabled="#{!certProfileBean.certificateProfile.useCRLDistributionPoint or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:inputText id="textfieldcrldisturi" value="#{certProfileBean.certificateProfile.CRLDistributionPointURI}" size="45" maxlength="4096"
			...
			disabled="#{certProfileBean.certificateProfile.useDefaultCRLDistributionPoint or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}" title="#{web.text.FORMAT_URI}"/>
		...
		<h:inputText id="textfieldcrlissuer" value="#{certProfileBean.certificateProfile.CRLIssuer}" size="45" maxlength="255" rendered="#{certProfileBean.certificateProfile.useCRLDistributionPoint}"
			disabled="#{certProfileBean.certificateProfile.useDefaultCRLDistributionPoint or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}" title="#{web.text.FORMAT_DN}"/>
		...
		<h:inputText id="textfieldfreshestcrluri" value="#{certProfileBean.certificateProfile.freshestCRLURI}" size="45" maxlength="255" rendered="#{certProfileBean.certificateProfile.useFreshestCRL}"
			disabled="#{certProfileBean.certificateProfile.useCADefinedFreshestCRL or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}" title="#{web.text.FORMAT_URI}"/>
		...
		<h:inputText id="textfieldocspservicelocatoruri" value="#{certProfileBean.certificateProfile.OCSPServiceLocatorURI}" size="45" maxlength="255" title="#{web.text.FORMAT_URI}"
			 ...
			 disabled="#{certProfileBean.certificateProfile.useDefaultOCSPServiceLocator or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGrid columns="3" id="privateKeyUsagePeriodGroup">
			...
			<h:inputText id="textfieldprivkeyusageperiodstartoffset" value="#{certProfileBean.privateKeyUsagePeriodStartOffset}" size="20" maxlength="255"
				disabled="#{!certProfileBean.certificateProfile.usePrivateKeyUsagePeriodNotBefore or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
			...
			<h:panelGroup>
				<h:selectBooleanCheckbox styleClass="checkBoxOverlay" value="#{certProfileBean.certificateProfile.usePrivateKeyUsagePeriodNotAfter}" 
					rendered="#{!web.legacyInternetExplorer}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
			...
			<h:inputText id="textfieldprivkeyusageperiodlength" value="#{certProfileBean.privateKeyUsagePeriodLength}" size="20" maxlength="255"
				disabled="#{!certProfileBean.certificateProfile.usePrivateKeyUsagePeriodNotAfter or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
			<h:outputText styleClass="help" value="#{web.text.FORMAT_TIME_YMD}"/>
		</h:panelGrid>
	...
	<h:panelGrid columns="2" styleClass="edit-top" cellspacing="3" cellpadding="3" border="0" width="100%" rowClasses="Row0,Row1" columnClasses="editColumn1,editColumn2">
		...
		<h:panelGroup id="checkuseqcstatementgroup">
			...
			<h:selectBooleanCheckbox id="checkqcstatementcritical" value="#{certProfileBean.certificateProfile.QCStatementCritical}" 
				disabled="#{!certProfileBean.certificateProfile.useQCStatement or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="checkpkixqcsyntaxv2group" rendered="#{certProfileBean.certificateProfile.useQCStatement}">
			<h:selectBooleanCheckbox id="checkpkixqcsyntaxv2" value="#{certProfileBean.certificateProfile.usePkixQCSyntaxV2}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:inputText id="textfieldqcsemanticsid" value="#{certProfileBean.certificateProfile.QCSemanticsId}" size="20" maxlength="255" title="#{web.text.FORMAT_OID}"
			 rendered="#{certProfileBean.certificateProfile.useQCStatement}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="checkqcetsiqcompliancegroup" rendered="#{certProfileBean.certificateProfile.useQCStatement}">
			<h:selectBooleanCheckbox id="checkqcetsiqcompliance" value="#{certProfileBean.certificateProfile.useQCEtsiQCCompliance}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="checkqcetsisignaturedevicegroup" rendered="#{certProfileBean.certificateProfile.useQCStatement}">
			<h:selectBooleanCheckbox id="checkqcetsisignaturedevice" value="#{certProfileBean.certificateProfile.useQCEtsiSignatureDevice}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="qcetsivaluelimitgroup" rendered="#{certProfileBean.certificateProfile.useQCStatement}">
			...
			<h:commandButton id="checkqcetsivaluelimit" styleClass="checkBoxOverlay" action="#{certProfileBean.toggleUseQCEtsiValueLimit}"
				value="#{certProfileBean.certificateProfile.useQCEtsiValueLimit?web.text.BOOL_TRUE:web.text.BOOL_FALSE}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
			...
			<h:inputText id="textfieldqcetsivaluelimitcur" value="#{certProfileBean.certificateProfile.QCEtsiValueLimitCurrency}" size="3" maxlength="3" title="#{web.text.FORMAT_ISO4217}"
				disabled="#{!certProfileBean.certificateProfile.useQCEtsiValueLimit or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}" style="text-align: center;"/>
			...
			<h:inputText id="textfieldqcetsivaluelimit" value="#{certProfileBean.certificateProfile.QCEtsiValueLimit}" size="3" maxlength="6" title="#{web.text.FORMAT_INTEGER}"
				disabled="#{!certProfileBean.certificateProfile.useQCEtsiValueLimit or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}" converterMessage="#{web.text.ONLYDECINETSIVALUELIMIT}" validatorMessage="#{web.text.ONLYDECINETSIVALUELIMIT}">
		...
		<h:panelGroup id="qcetsiretentionperiodgroup" rendered="#{certProfileBean.certificateProfile.useQCStatement}">
			...
			<h:commandButton id="checkqcetsiretentionperiod" styleClass="checkBoxOverlay" action="#{certProfileBean.toggleUseQCEtsiRetentionPeriod}"
				value="#{certProfileBean.certificateProfile.useQCEtsiRetentionPeriod?web.text.BOOL_TRUE:web.text.BOOL_FALSE}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
			...
			<h:inputText id="textfieldqcetsiretentionperiod" value="#{certProfileBean.certificateProfile.QCEtsiRetentionPeriod}" size="2" maxlength="3" title="#{web.text.FORMAT_INTEGER}"
				disabled="#{!certProfileBean.certificateProfile.useQCEtsiRetentionPeriod or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}">
		...
		<h:panelGroup id="checkqccustomstringgroup" rendered="#{certProfileBean.certificateProfile.useQCStatement}">
			...
			<h:commandButton id="checkqccustomstring" styleClass="checkBoxOverlay" action="#{certProfileBean.toggleUseQCCustomString}"
				value="#{certProfileBean.certificateProfile.useQCCustomString?web.text.BOOL_TRUE:web.text.BOOL_FALSE}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
			...
			<h:inputText id="textfieldqccustomstringoid" value="#{certProfileBean.certificateProfile.QCCustomStringOid}" size="20" maxlength="255" title="#{web.text.FORMAT_OID}"
				disabled="#{!certProfileBean.certificateProfile.useQCCustomString or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		</h:panelGroup>
	...
	<h:panelGrid columns="2" styleClass="edit-top" cellspacing="3" cellpadding="3" border="0" width="100%" rowClasses="Row0,Row1" columnClasses="editColumn1,editColumn2"
		...
		<h:selectManyListbox rendered="#{certProfileBean.ctEnabled}" id="selectctlogs" value="#{certProfileBean.enabledCTLogs}"
			size="#{certProfileBean.enabledCTLogsAvailableSize}" style="min-width: 280px;" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}">
		...
		<h:panelGroup rendered="#{certProfileBean.ctInCertsOrOCSPEnabled}">
    		<h:inputText id="textfieldctminscts" value="#{certProfileBean.certificateProfile.CTMinSCTs}" size="2" maxlength="255" title="#{web.text.FORMAT_INTEGER}"
    			disabled="#{!certProfileBean.certificateProfile.useCertificateTransparencyInCerts or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
			...
			<h:inputText  id="textfieldctminsctsocsp" value="#{certProfileBean.certificateProfile.CTMinSCTsOCSP}" size="2" maxlength="255" title="#{web.text.FORMAT_INTEGER}"
                disabled="#{!certProfileBean.certificateProfile.useCertificateTransparencyInOCSP or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
        ...
        <h:panelGroup id="checkctsubmitexistinggroup" rendered="#{certProfileBean.ctInOCSPOrPublishersEnabled}">
            <h:selectBooleanCheckbox id="checkctsubmitexisting" value="#{certProfileBean.certificateProfile.useCTSubmitExisting}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:inputText rendered="#{certProfileBean.ctInCertsOrOCSPEnabled}" id="textfieldctmaxretries" value="#{certProfileBean.certificateProfile.CTMaxRetries}" size="3" maxlength="255" title="#{web.text.FORMAT_INTEGER}"
			disabled="#{(!certProfileBean.certificateProfile.useCertificateTransparencyInCerts && !certProfileBean.certificateProfile.useCertificateTransparencyInOCSP) || certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
	...
	<h:panelGrid columns="2" styleClass="edit-top" cellspacing="3" cellpadding="3" border="0" width="100%" rowClasses="Row0,Row1" columnClasses="editColumn1,editColumn2">
		...
		<h:panelGroup id="checkuseocspnocheckgroup">
			<h:selectBooleanCheckbox id="checkuseocspnocheck" value="#{certProfileBean.certificateProfile.useOcspNoCheck}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="checkusemstemplategroup">
			...
			<h:selectOneMenu id="selectmstemplate" value="#{certProfileBean.certificateProfile.microsoftTemplate}" 
				disabled="#{!certProfileBean.certificateProfile.useMicrosoftTemplate or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}">
		...
		<h:panelGroup id="checkusecardnumbergroup" rendered="#{!certProfileBean.typeCA}">
			<h:selectBooleanCheckbox id="checkusecardnumber" value="#{certProfileBean.certificateProfile.useCardNumber}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:selectManyListbox rendered="#{!empty certProfileBean.availableCertificateExtensionsAvailable}" id="selectusedcertificateextensions" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"
	...
	<h:panelGrid columns="2" styleClass="edit-top" cellspacing="3" cellpadding="3" border="0" width="100%" rowClasses="Row0,Row1" columnClasses="editColumn1,editColumn2">
		...
		<h:panelGrid columns="1">
			<h:panelGroup id="cbdocumenttypegroup">
				...
				<h:commandButton id="cbusedocumenttype" styleClass="checkBoxOverlay" action="#{certProfileBean.toggleUseDocumentTypeList}"
					value="#{certProfileBean.certificateProfile.useDocumentTypeList?web.text.BOOL_TRUE:web.text.BOOL_FALSE}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				...
				<h:selectBooleanCheckbox id="cbdocumenttypecritical" value="#{certProfileBean.certificateProfile.documentTypeListCritical}" 
					disabled="#{!certProfileBean.certificateProfile.useDocumentTypeList or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
			...
			<h:dataTable id="textfielddocumenttype" value="#{certProfileBean.documentTypeList}" var="current" rendered="#{certProfileBean.certificateProfile.useDocumentTypeList}">
				<h:column>
					...
					<f:facet name="footer">
						<h:inputText value="#{certProfileBean.documentTypeListNew}" size="20" maxlength="4096" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
					</f:facet>
				</h:column>
				<h:column>
					<h:commandButton value="#{web.text.REMOVE}" action="#{certProfileBean.documentTypeListRemove}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
					<f:facet name="footer">
						<h:commandButton value="#{web.text.ADD}" action="#{certProfileBean.documentTypeListAdd}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
					</f:facet>
				</h:column>
			</h:dataTable>
		</h:panelGrid>
		...
		<h:panelGroup id="selectcvctermtype" rendered="#{certProfileBean.cvcAvailable}">
			<h:commandButton value="#{certProfileBean.cvcTerminalTypeIs?'✓':' '}#{web.text.CVCINSPECTIONSYSTEM}" 
					disabled="#{certProfileBean.cvcTerminalTypeIs or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}" action="#{certProfileBean.setCvcTerminalTypeIs}"/>
			<h:commandButton value="#{certProfileBean.cvcTerminalTypeAt?'✓':' '}#{web.text.CVCAUTHENTICATIONTERMINAL}" 
				disabled="#{certProfileBean.cvcTerminalTypeAt or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}" action="#{certProfileBean.setCvcTerminalTypeAt}"/>
			<h:commandButton value="#{certProfileBean.cvcTerminalTypeSt?'✓':' '}#{web.text.CVCSIGNATURETERMINAL}" 
				disabled="#{certProfileBean.cvcTerminalTypeSt or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}" action="#{certProfileBean.setCvcTerminalTypeSt}"/>
		</h:panelGroup>
		...
		<h:panelGroup id="selectcvcaccessrights" rendered="#{certProfileBean.cvcAvailable}">
			<h:panelGrid columns="4" rendered="#{certProfileBean.cvcTerminalTypeIs}">
				<h:selectBooleanCheckbox id="cvcAccessRightDg3" value="#{certProfileBean.cvcAccessRightDg3}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				<h:outputLabel for="cvcAccessRightDg3" value="#{web.text.CVCACCESSDG3}"/>
				<h:selectBooleanCheckbox id="cvcAccessRightDg4" value="#{certProfileBean.cvcAccessRightDg4}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
			...
			<h:selectManyListbox id="selectcvcaccessrights_at" rendered="#{certProfileBean.cvcTerminalTypeAt}" enabledClass="cvcoption_at"
				 value="#{certProfileBean.cvcLongAccessRights}" size="8" converter="javax.faces.Integer" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}">
			...
			<h:panelGrid  id="selectcvcaccessrights_st" columns="4" rendered="#{certProfileBean.cvcTerminalTypeSt}">
				<h:selectBooleanCheckbox id="cvcAccessRightSign" value="#{certProfileBean.cvcAccessRightSign}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				<h:outputLabel for="cvcAccessRightSign" value="#{web.text.CVCACCESSSIGN}"/>
				<h:selectBooleanCheckbox id="cvcAccessRightQualSign" value="#{certProfileBean.cvcAccessRightQualSign}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
	...
	<h:panelGrid columns="2" styleClass="edit" cellspacing="3" cellpadding="3" border="0" width="100%" rowClasses="Row0,Row1" columnClasses="editColumn1,editColumn2">
		...
		<h:panelGroup id="checkuseldapdnordergroup">
			<h:selectBooleanCheckbox id="checkuseldapdnorder" value="#{certProfileBean.certificateProfile.useLdapDnOrder}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGroup id="cnpostfixgroup">
			...
			<h:commandButton id="checkusecnpostfix" styleClass="checkBoxOverlay" action="#{certProfileBean.toggleUseCNPostfix}"
				value="#{certProfileBean.certificateProfile.useCNPostfix?web.text.BOOL_TRUE:web.text.BOOL_FALSE}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
			...
			<h:inputText id="textfieldcnpostfix" size="20" maxlength="255" title="#{web.text.FORMAT_STRING}" value="#{certProfileBean.certificateProfile.CNPostfix}"
				disabled="#{!certProfileBean.certificateProfile.useCNPostfix or certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
		...
		<h:panelGrid columns="1">
			<h:panelGroup id="checkusesubjectdnsubsetgroup">
				...
				<h:commandButton id="checkusesubjectdnsubset" styleClass="checkBoxOverlay" action="#{certProfileBean.toggleUseSubjectDNSubSet}"
					value="#{certProfileBean.certificateProfile.useSubjectDNSubSet?web.text.BOOL_TRUE:web.text.BOOL_FALSE}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"/>
				<h:outputLabel for="checkusesubjectdnsubset" value="#{web.text.RESTRICT}…" styleClass="checkBoxOverlay"/>
			</h:panelGroup>
			<h:selectManyListbox rendered="#{certProfileBean.certificateProfile.useSubjectDNSubSet}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"
		...
		<h:panelGrid columns="1">
			...
			<h:selectManyListbox rendered="#{certProfileBean.certificateProfile.useSubjectAltNameSubSet}" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}"
		...
		<h:selectManyListbox id="selectavailablecas" value="#{certProfileBean.certificateProfile.availableCAs}" size="#{certProfileBean.availableCAsAvailableSize}"
			converter="javax.faces.Integer" style="min-width: 280px;" disabled="#{certProfilesBean.authorizedToOnlyView or certProfilesBean.viewOnly}">
