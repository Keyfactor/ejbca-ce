...
public class CAInfoView implements java.io.Serializable, Cloneable {
    ...
    * CANAME, CERT_SUBJECTDN, SUBJECTALTNAME, CATYPE, EXPIRES, STATUS, CATOKENSTATUS, DESCRIPTION, CRLPERIOD, CRLISSUEINTERVAL, CRLOVERLAPTIME, DELTACRLPERIOD
    * It must also have "" in pos nr 4 (CASPACER) 
    * It must also have "" in pos nr 9 (CRLSPACER) 
    */
   public static String[] X509CA_CAINFODATATEXTS = {"CANAME","CERT_SUBJECTDN","SUBJECTALTNAME","CATYPE","",
