    ...
    public String parseRequest(HttpServletRequest request) throws AuthorizationDeniedException {
        ...
        if (action != null) {
            ...
            if (action.equals(ACTION_EDIT_HARDTOKENPROFILE)) {
                ...
                if (profile != null) {
                    if (!profile.trim().equals("")) {
                        if (request.getParameter(BUTTON_SAVE) != null || request.getParameter(BUTTON_UPLOADENVELOPETEMP) != null
                                || request.getParameter(BUTTON_UPLOADVISUALTEMP) != null || request.getParameter(BUTTON_UPLOADRECEIPTTEMP) != null
