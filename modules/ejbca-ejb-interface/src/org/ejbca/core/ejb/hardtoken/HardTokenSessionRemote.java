 ...
 */
@Remote
public interface HardTokenSessionRemote {
    /**
    ...
    public void changeHardTokenProfile(org.ejbca.core.model.log.Admin admin, java.lang.String name,
            org.ejbca.core.model.hardtoken.profiles.HardTokenProfile profile) throws java.rmi.RemoteException;
    ...
    public void cloneHardTokenProfile(org.ejbca.core.model.log.Admin admin, java.lang.String oldname, java.lang.String newname)
            throws org.ejbca.core.model.hardtoken.HardTokenProfileExistsException, java.rmi.RemoteException;
     ...
     *             if a communication or other error occurs.
     */
    public void removeHardTokenProfile(org.ejbca.core.model.log.Admin admin, java.lang.String name) throws java.rmi.RemoteException;
     ...
     */
    public java.util.Collection getAuthorizedHardTokenProfileIds(org.ejbca.core.model.log.Admin admin) throws java.rmi.RemoteException;

    /**
     * Method creating a hashmap mapping profile id (Integer) to profile name
     * (String).
     */
    public java.util.HashMap getHardTokenProfileIdToNameMap(org.ejbca.core.model.log.Admin admin) throws java.rmi.RemoteException;
     ...
     */
    public int getHardTokenProfileUpdateCount(org.ejbca.core.model.log.Admin admin, int hardtokenprofileid) throws java.rmi.RemoteException;
     ...
     */
    public int getHardTokenProfileId(org.ejbca.core.model.log.Admin admin, java.lang.String name) throws java.rmi.RemoteException;
     ...
     *             if a communication or other error occurs.
     */
    public java.lang.String getHardTokenProfileName(org.ejbca.core.model.log.Admin admin, int id) throws java.rmi.RemoteException;
    ...
    public boolean addHardTokenIssuer(org.ejbca.core.model.log.Admin admin, java.lang.String alias, int admingroupid,
            org.ejbca.core.model.hardtoken.HardTokenIssuer issuerdata) throws java.rmi.RemoteException;
     ...
     *             if a communication or other error occurs.
     */
    public void removeHardTokenIssuer(org.ejbca.core.model.log.Admin admin, java.lang.String alias) throws java.rmi.RemoteException;
     ...
     *         alias.
     */
    public boolean getAuthorizedToHardTokenIssuer(org.ejbca.core.model.log.Admin admin, java.lang.String alias) throws java.rmi.RemoteException;
     ...
     *             if a communication or other error occurs.
     */
    public java.util.Collection getHardTokenIssuerDatas(org.ejbca.core.model.log.Admin admin) throws java.rmi.RemoteException;
     ...
     *             if a communication or other error occurs.
     */
    public java.util.Collection getHardTokenIssuerAliases(org.ejbca.core.model.log.Admin admin) throws java.rmi.RemoteException;
     ...
     *             if a communication or other error occurs.
     */
    public java.util.TreeMap getHardTokenIssuers(org.ejbca.core.model.log.Admin admin) throws java.rmi.RemoteException;
     ...
     *             if a communication or other error occurs.
     */
    public int getNumberOfHardTokenIssuers(org.ejbca.core.model.log.Admin admin) throws java.rmi.RemoteException;
     ...
     *             if a communication or other error occurs.
     */
    public int getHardTokenIssuerId(org.ejbca.core.model.log.Admin admin, java.lang.String alias) throws java.rmi.RemoteException;
     ...
     *             if a communication or other error occurs.
     */
    public java.lang.String getHardTokenIssuerAlias(org.ejbca.core.model.log.Admin admin, int id) throws java.rmi.RemoteException;
    ...
    public void addHardToken(org.ejbca.core.model.log.Admin admin, java.lang.String tokensn, java.lang.String username, java.lang.String significantissuerdn,
            ...
            throws org.ejbca.core.model.hardtoken.HardTokenExistsException, java.rmi.RemoteException;
    ...
    public void removeHardToken(org.ejbca.core.model.log.Admin admin, java.lang.String tokensn)
            throws org.ejbca.core.model.hardtoken.HardTokenDoesntExistsException, java.rmi.RemoteException;
     ...
     *             if a communication or other error occurs.
     */
    public boolean existsHardToken(org.ejbca.core.model.log.Admin admin, java.lang.String tokensn) throws java.rmi.RemoteException;
     ...
     *             if a communication or other error occurs.
     */
    public java.util.Collection findCertificatesInHardToken(org.ejbca.core.model.log.Admin admin, java.lang.String tokensn) throws java.rmi.RemoteException;
    ...
    public void errorWhenGeneratingToken(org.ejbca.core.model.log.Admin admin, java.lang.String tokensn, java.lang.String username,
            java.lang.String significantissuerdn) throws java.rmi.RemoteException;
     ...
     *         profiles.
     */
    public boolean existsCertificateProfileInHardTokenProfiles(org.ejbca.core.model.log.Admin admin, int id) throws java.rmi.RemoteException;
     ...
     *         issuers.
     */
    public boolean existsHardTokenProfileInHardTokenIssuer(org.ejbca.core.model.log.Admin admin, int id) throws java.rmi.RemoteException;
}
