 ...
 */
@Local
public interface KeyRecoverySessionLocal {
    /**
     ...
     *             if a communication or other error occurs.
     */
    public void removeKeyRecoveryData(org.ejbca.core.model.log.Admin admin, java.security.cert.Certificate certificate);
     ...
     *             if a communication or other error occurs.
     */
    public void removeAllKeyRecoveryData(org.ejbca.core.model.log.Admin admin, java.lang.String username);
    ...
    public boolean markAsRecoverable(org.ejbca.core.model.log.Admin admin, java.security.cert.Certificate certificate, int endEntityProfileId,
            org.ejbca.core.model.ra.raadmin.GlobalConfiguration gc) throws org.ejbca.core.model.authorization.AuthorizationDeniedException,
            org.ejbca.core.model.approval.WaitingForApprovalException, org.ejbca.core.model.approval.ApprovalException;
     ...
     *             if a communication or other error occurs.
     */
    public void unmarkUser(org.ejbca.core.model.log.Admin admin, java.lang.String username);
     ...
     *             if a communication or other error occurs.
     */
    public boolean isUserMarked(org.ejbca.core.model.log.Admin admin, java.lang.String username);
     ...
     *             if a communication or other error occurs.
     */
    public boolean existsKeys(org.ejbca.core.model.log.Admin admin, java.security.cert.Certificate certificate);
}
