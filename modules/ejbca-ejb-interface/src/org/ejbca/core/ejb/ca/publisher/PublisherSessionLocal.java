 ...
 */
@Local
public interface PublisherSessionLocal {
    /**
    ...
    public boolean storeCertificate(org.ejbca.core.model.log.Admin admin, java.util.Collection publisherids, java.security.cert.Certificate incert,
            ...
            org.ejbca.core.model.ra.ExtendedInformation extendedinformation);
     ...
     *             if a communication or other error occurs.
     */
    public java.lang.String getPublisherName(org.ejbca.core.model.log.Admin admin, int id);
