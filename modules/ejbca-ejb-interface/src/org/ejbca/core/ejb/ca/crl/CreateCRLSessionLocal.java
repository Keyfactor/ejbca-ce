 ...
 */
@Local
public interface CreateCRLSessionLocal {
    /**
     ...
     */
    public void publishCRL(org.ejbca.core.model.log.Admin admin, java.security.cert.Certificate caCert, java.util.Collection usedpublishers,
