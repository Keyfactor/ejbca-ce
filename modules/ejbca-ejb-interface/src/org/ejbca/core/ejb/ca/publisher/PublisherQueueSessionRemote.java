...
/**
 * Remote interface for PublisherQueueSession.
 */
@Remote
public interface PublisherQueueSessionRemote {
    /**
     ...
     */
    public void removeQueueData(java.lang.String pk) throws java.rmi.RemoteException;
     ...
     */
    public java.util.Collection getPendingEntriesForPublisher(int publisherId) throws java.rmi.RemoteException;
     ...
     */
    public int getPendingEntriesCountForPublisher(int publisherId) throws java.rmi.RemoteException;
     ...
     */
    public int[] getPendingEntriesCountForPublisherInIntervals(int publisherId, int[] lowerBounds, int[] upperBounds) throws java.rmi.RemoteException;
     ...
     * @return Collection of PublisherQueueData, never null
     */
    public java.util.Collection getEntriesByFingerprint(java.lang.String fingerprint) throws java.rmi.RemoteException;
     ...
     */
    public void updateData(java.lang.String pk, int status, int tryCounter) throws java.rmi.RemoteException;
