...
@Local
public interface CAAdminSessionLocal {
     ...
     * @see org.ejbca.core.model.ca.caadmin.X509CAInfo
     */
    public void editCA(Admin admin, org.ejbca.core.model.ca.caadmin.CAInfo cainfo) throws AuthorizationDeniedException;
     ...
     *             if no CA was found
     */
    public org.ejbca.core.model.ca.caadmin.CA getCA(Admin admin, int caid) throws org.ejbca.core.model.ca.caadmin.CADoesntExistsException;
     ...
     */
    public void verifyExistenceOfCA(int caid) throws org.ejbca.core.model.ca.caadmin.CADoesntExistsException;
    ...
    public byte[] makeRequest(Admin admin, int caid, Collection cachain, boolean regenerateKeys, boolean usenextkey, boolean activatekey, String keystorepass)
            throws org.ejbca.core.model.ca.caadmin.CADoesntExistsException, AuthorizationDeniedException, java.security.cert.CertPathValidatorException,
            org.ejbca.core.model.ca.catoken.CATokenOfflineException, org.ejbca.core.model.ca.catoken.CATokenAuthenticationFailedException;
    ...
    public byte[] signRequest(Admin admin, int caid, byte[] request, boolean usepreviouskey, boolean createlinkcert) throws AuthorizationDeniedException,
            org.ejbca.core.model.ca.caadmin.CADoesntExistsException, org.ejbca.core.model.ca.catoken.CATokenOfflineException;
     ...
     */
    public void receiveResponse(Admin admin, int caid, org.ejbca.core.protocol.IResponseMessage responsemessage, Collection cachain,
            String tokenAuthenticationCode) throws AuthorizationDeniedException, java.security.cert.CertPathValidatorException, EjbcaException;
     ...
     */
    public org.ejbca.core.protocol.IResponseMessage processRequest(Admin admin, org.ejbca.core.model.ca.caadmin.CAInfo cainfo,
            org.ejbca.core.protocol.IRequestMessage requestmessage) throws CAExistsException, org.ejbca.core.model.ca.caadmin.CADoesntExistsException,
            AuthorizationDeniedException, org.ejbca.core.model.ca.catoken.CATokenOfflineException;
     ...
     */
    public void initExternalCAService(Admin admin, int caid, org.ejbca.core.model.ca.caadmin.extendedcaservices.ExtendedCAServiceInfo info)
            throws org.ejbca.core.model.ca.catoken.CATokenOfflineException, AuthorizationDeniedException,
            org.ejbca.core.model.ca.caadmin.CADoesntExistsException, java.io.UnsupportedEncodingException,
            org.ejbca.core.model.ca.caadmin.IllegalKeyStoreException;
     ...
     */
    public void renewCA(Admin admin, int caid, String keystorepass, boolean regenerateKeys) throws org.ejbca.core.model.ca.caadmin.CADoesntExistsException,
            AuthorizationDeniedException, java.security.cert.CertPathValidatorException, org.ejbca.core.model.ca.catoken.CATokenOfflineException,
     ...
     */
    public void revokeCA(Admin admin, int caid, int reason) throws org.ejbca.core.model.ca.caadmin.CADoesntExistsException, AuthorizationDeniedException;
    ...
    public void importCAFromKeyStore(Admin admin, String caname, byte[] p12file, String keystorepass, String privkeypass, String privateSignatureKeyAlias,
            String privateEncryptionKeyAlias) throws java.lang.Exception;
    ...
    public void importCAFromKeys(Admin admin, String caname, String keystorepass, java.security.cert.Certificate[] signatureCertChain,
            ...
            java.security.PublicKey p12PublicEncryptionKey) throws java.lang.Exception, org.ejbca.core.model.ca.catoken.CATokenAuthenticationFailedException,
    ...
    public void importCAFromHSM(Admin admin, String caname, java.security.cert.Certificate[] signatureCertChain, String catokenpassword,
            String catokenclasspath, String catokenproperties) throws java.lang.Exception;
     ...
     *             approval queue.
     */
    public void activateCAToken(Admin admin, int caid, String authorizationcode, org.ejbca.core.model.ra.raadmin.GlobalConfiguration gc)
            throws AuthorizationDeniedException, org.ejbca.core.model.ca.catoken.CATokenAuthenticationFailedException,
            org.ejbca.core.model.ca.catoken.CATokenOfflineException, org.ejbca.core.model.approval.ApprovalException,
