 ...
 */
@Remote
public interface CreateCRLSessionRemote {

    /**
     * Same as generating a new CRL but this is in a new separate transaction.
     */
    public void runNewTransaction( org.ejbca.core.model.log.Admin admin,org.ejbca.core.model.ca.caadmin.CA ca )
       throws org.ejbca.core.model.ca.catoken.CATokenOfflineException, java.rmi.RemoteException;

    /**
     * Method that checks if the CRL is needed to be updated for the CA and creates the CRL, if neccessary. A CRL is created: 1. if the current CRL expires within the crloverlaptime (milliseconds) 2. if a CRL issue interval is defined (>0) a CRL is issued when this interval has passed, even if the current CRL is still valid
     * @param admin administrator performing the task
     * @param ca the CA this operation regards
     * @param addtocrloverlaptime given in milliseconds and added to the CRL overlap time, if set to how often this method is run (poll time), it can be used to issue a new CRL if the current one expires within the CRL overlap time (configured in CA) and the poll time. The used CRL overlap time will be (crloverlaptime + addtocrloverlaptime)
    ...
    /**
     * Generates a new CRL by looking in the database for revoked certificates and generating a CRL. This method also "archives" certificates when after they are no longer needed in the CRL.
     * @param admin administrator performing the task
     * @param ca the CA this operation regards
     ...
     */
    public java.lang.String run( org.ejbca.core.model.log.Admin admin,org.ejbca.core.model.ca.caadmin.CA ca )
       throws org.ejbca.core.model.ca.catoken.CATokenOfflineException, java.rmi.RemoteException;

    /**
     * This method sets the "archived" certificates status. Normally this is done by the CRL-creation process. This is also used from the createLotsOfCertsPerUser test.
     ...
     */
    public void setArchivedStatus( java.lang.String certificateFingerprint )
       throws javax.ejb.FinderException, java.rmi.RemoteException;

    /**
     * Generates a new Delta CRL by looking in the database for revoked certificates since the last complete CRL issued and generating a CRL with the difference. If either of baseCrlNumber or baseCrlCreateTime is -1 this method will try to query the database for the last complete CRL.
     * @param admin administrator performing the task
     * @param ca the CA this operation regards
     ...
     */
    public boolean storeCRL( org.ejbca.core.model.log.Admin admin,byte[] incrl,java.lang.String cafp,int number,java.lang.String issuerDN,java.util.Date thisUpdate,java.util.Date nextUpdate,int deltaCRLIndicator )
       throws java.rmi.RemoteException;
     ...
     */
    public void publishCRL( org.ejbca.core.model.log.Admin admin,java.security.cert.Certificate caCert,java.util.Collection usedpublishers,java.lang.String caDataDN,boolean doPublishDeltaCRL )
       throws java.rmi.RemoteException;
