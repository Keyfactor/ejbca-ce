 ...
 */
@Remote
public interface AuthorizationSessionRemote {
    /**
    ...
    public void initialize(org.ejbca.core.model.log.Admin admin, int caid, java.lang.String superAdminCN)
            throws org.ejbca.core.model.authorization.AdminGroupExistsException, java.rmi.RemoteException;
     ...
     */
    public boolean existsAdministratorInGroup(org.ejbca.core.model.log.Admin admin, int admingrouppk) throws java.rmi.RemoteException;
     ...
     */
    public void removeAdminGroup(org.ejbca.core.model.log.Admin admin, java.lang.String admingroupname) throws java.rmi.RemoteException;
    ...
    public java.util.Collection getAuthorizedAvailableAccessRules(org.ejbca.core.model.log.Admin admin, java.util.Collection availableCaIds,
            ...
            java.util.Collection authorizedUserDataSourceIds) throws java.rmi.RemoteException;
     ...
     */
    public java.util.Collection getAuthorizedCAIds(org.ejbca.core.model.log.Admin admin, java.util.Collection availableCaIds) throws java.rmi.RemoteException;
    ...
    public java.util.Collection getAuthorizedEndEntityProfileIds(org.ejbca.core.model.log.Admin admin, java.lang.String rapriviledge,
            java.util.Collection availableEndEntityProfileId) throws java.rmi.RemoteException;
     ...
     */
    public boolean existsEndEntityProfileInRules(org.ejbca.core.model.log.Admin admin, int profileid) throws java.rmi.RemoteException;
     ...
     */
    public boolean existsCAInRules(org.ejbca.core.model.log.Admin admin, int caid) throws java.rmi.RemoteException;

    /**
     * Method to force an update of the autorization rules without any wait.
     */
    public void forceRuleUpdate(org.ejbca.core.model.log.Admin admin) throws java.rmi.RemoteException;
