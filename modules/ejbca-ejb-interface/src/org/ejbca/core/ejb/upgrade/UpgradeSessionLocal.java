...
public interface UpgradeSessionLocal  extends UpgradeSession{
    ...
    /** For internal user from UpgradeSessionBean only */
    void migrateDatabase780() throws UpgradeFailedException;
    /** For internal user from UpgradeSessionBean only */
    void migrateDatabase781() throws UpgradeFailedException;
    /** For internal user from UpgradeSessionBean only */
    void migrateDatabase7100() throws UpgradeFailedException;
    /** For internal user from UpgradeSessionBean only */
    void migrateDatabase7110() throws UpgradeFailedException;
    /** For internal user from UpgradeSessionBean only */
    void migrateDatabase800() throws UpgradeFailedException;
    /** For internal user from UpgradeSessionBean only */
    ...
    /** For internal user from UpgradeSessionBean only */
    void migrateDatabase9_4_1()  throws UpgradeFailedException;
    /** For internal user from UpgradeSessionBean only */
