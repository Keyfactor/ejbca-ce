...
public class NoConflictCertificateData extends ProtectedData implements Serializable {
    ...
    public NoConflictCertificateData(Certificate certificate, PublicKey enrichedpubkey, 
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("Creating NoCertificateData, subjectDN=" + getSubjectDnNeverNull() + ", subjectAltName=" + getSubjectAltNameNeverNull() + ", issuer=" + getIssuerDN() + ", fingerprint=" + fp+", storeSubjectAltName="+storeSubjectAltName);
            }
    ...
    public static NoConflictCertificateData findByFingerprint(EntityManager entityManager, String fingerprint) {
        return entityManager.find(NoConflictCertificateData.class, fingerprint);
    }
    ...
    public static List<NoConflictCertificateData> findBySubjectDN(EntityManager entityManager, String subjectDN) {
        final TypedQuery<NoConflictCertificateData> query = entityManager.createQuery("SELECT a FROM CertificateData a WHERE a.subjectDN=:subjectDN", NoConflictCertificateData.class);
        query.setParameter("subjectDN", subjectDN);
    ...
    public static List<NoConflictCertificateData> findBySerialNumber(EntityManager entityManager, String serialNumber) {
        final TypedQuery<NoConflictCertificateData> query = entityManager.createQuery("SELECT a FROM CertificateData a WHERE a.serialNumber=:serialNumber", NoConflictCertificateData.class);
    ...
    public static List<NoConflictCertificateData> findByIssuerDNSerialNumber(EntityManager entityManager, String issuerDN, String serialNumber) {
        final TypedQuery<NoConflictCertificateData> query = entityManager.createQuery("SELECT a FROM CertificateData a WHERE a.issuerDN=:issuerDN AND a.serialNumber=:serialNumber", NoConflictCertificateData.class);
        query.setParameter("issuerDN", issuerDN);
        query.setParameter("serialNumber", serialNumber);
        return query.getResultList();
    }
    ...
    /** @return return the query results as a List. */
    @SuppressWarnings("unchecked")
    public static List<NoConflictCertificateData> findByUsernameOrdered(EntityManager entityManager, String username) {
        final Query query = entityManager
    ...
    /** @return return the query results as a List. */
    @SuppressWarnings("unchecked")
    public static List<NoConflictCertificateData> findByUsernameAndStatus(EntityManager entityManager, String username, int status) {
        final Query query = entityManager
    ...
    /** @return return the query results as a List. */
    @SuppressWarnings("unchecked")
    public static List<NoConflictCertificateData> findByUsernameAndStatusAfterExpireDate(EntityManager entityManager, String username, int status, long afterExpireDate) {
        final Query query = entityManager
     ...
     */
    @SuppressWarnings("unchecked")
    public static List<NoConflictCertificateData> getNextBatch(EntityManager entityManager, int certificateProfileId, String currentFingerprint, int batchSize) {
        final Query query = entityManager
     ...
     */
    @SuppressWarnings("unchecked")
    public static List<NoConflictCertificateData> getNextBatch(EntityManager entityManager, String currentFingerprint, int batchSize) {
        final Query query = entityManager
    ...
    /** @return return the query results as a List. */
    @SuppressWarnings("unchecked")
    public static List<NoConflictCertificateData> findByExpireDateWithLimit(EntityManager entityManager, long expireDate, int maxNumberOfResults) {
        final Query query = entityManager
    ...
    /** @return return the query results as a List. */
    @SuppressWarnings("unchecked")
    public static List<NoConflictCertificateData> findByExpireDateAndIssuerWithLimit(EntityManager entityManager, long expireDate, String issuerDN, int maxNumberOfResults) {
        final Query query = entityManager
    ...
    /** @return return the query results as a List. */
    @SuppressWarnings("unchecked")
    public static List<NoConflictCertificateData> findByExpireDateAndTypeWithLimit(EntityManager entityManager, long expireDate, int certificateType, int maxNumberOfResults) {
        final Query query = entityManager
    ...
    /**
     * Get a list of {@link Certificate} from a list of list of {@link NoConflictCertificateData}.
     * @param cdl
     * @param entityManager
     * @return The resulting list.
     */
    public static List<Certificate> getCertificateList(List<NoConflictCertificateData> cdl, EntityManager entityManager) {
        final List<Certificate> cl = new LinkedList<Certificate>();
        for ( NoConflictCertificateData cd : cdl) {
