...
@NamedQueries({ 
        ...
        @NamedQuery(name = "findOcspDataByCaIdSerialNumber", query = "SELECT a FROM OcspResponseData a WHERE a.caId = :caId AND a.serialNumber = :serialNumber AND a.nextUpdate>:currentTime ORDER BY a.producedAt DESC"),
