...
public class RoleDataTest {
    ...
    public void testHasAccessToRule() {
        ...
        accessRules.put(1, new AccessRuleData(roleName, "/foo", AccessRuleState.RULE_ACCEPT, false));
        ...
        accessRules.put(6, new AccessRuleData(roleName, "/non_recursive", AccessRuleState.RULE_ACCEPT, false));
