...
public class YamlWriterUnitTest {
    ...
    private static final byte[] CONTAINER_YAML_UNSIGNED = """
            certificate: |
              -----BEGIN CERTIFICATE-----
              MIICWzCCAcSgAwIBAgIIJND6Haa3NoAwDQYJKoZIhvcNAQEFBQAwLzEPMA0GA1UE
              AxMGVGVzdENBMQ8wDQYDVQQKEwZBbmFUb20xCzAJBgNVBAYTAlNFMB4XDTAyMDEw
    ...
    private static final byte[] CONTAINER_YAML_UNSIGNED_REDACTED = """
            certificate: null
    ...
    private static final byte[] CONTAINER_YAML_SIGNED_REDACTED = """
            data:
              certificate: null
              certificateProfile: 0
              certificateProfileName: null
    ...
    @Test
    public void shouldConvertScpPublisherNotSignedToYaml() throws Exception {
        ...
        final byte[] result = YamlWriter.exportToYamlBytes(containerWrapper);

        assertNotNull(result);
        assertEquals(new String(CONTAINER_YAML_UNSIGNED), new String(result));
    }
    
    @Test
    public void shouldConvertScpPublisherNotSignedToYamlRedacted() throws Exception {
        final ScpContainer scpContainer = new ScpContainer()
                .setCertificateStatus(2)
                .setIssuer("issuerDN")
                .setRevocationDate(1751883738893L)
        ...
        assertNotNull(result);
        assertEquals(new String(CONTAINER_YAML_UNSIGNED_REDACTED), new String(result));
    }
    ...
    @Test
    public void shouldConvertScpPublisherSignedToYamlWithRedaction() throws Exception {
        final ScpContainer scpContainer = new ScpContainer()
                .setCertificateStatus(2)
                .setIssuer("issuerDN")
                .setRevocationDate(1751883738893L)
        ...
        containerWrapper.getCertificateProfile();
        
        final byte[] result = YamlWriter.exportToYamlBytes(signedContainer);

        assertNotNull(result);
        assertEquals(new String(CONTAINER_YAML_SIGNED_REDACTED), new String(result));
    }
