...
public enum KeyValidationFailedActions {
    ...
    // formatter:on
    DO_NOTHING(0, "KEYVALIDATORFAILEDACTION_DO_NOTHING"), 
    LOG_INFO(1, "KEYVALIDATORFAILEDACTION_LOG_INFO"), 
    LOG_WARN(2, "KEYVALIDATORFAILEDACTION_LOG_WARN"), 
    LOG_ERROR(3, "KEYVALIDATORFAILEDACTION_LOG_ERROR"), 
    ABORT_CERTIFICATE_ISSUANCE(4, "KEYVALIDATORFAILEDACTION_ABORT_CERTIFICATE_ISSUANCE");
    // formatter:off
