...
public enum KeyValidatorSettingsTemplate {
    ...
    // @formatter:off
    USE_CERTIFICATE_PROFILE_SETTINGS(0, "KEYVALIDATORSETTINGSTEMPLATE_USE_CP_SETTINGS"), 
    USE_CAB_FORUM_SETTINGS(1, "KEYVALIDATORSETTINGSTEMPLATE_USE_CAB_FORUM_SETTINGS"), 
    USE_CUSTOM_SETTINGS(2, "KEYVALIDATORSETTINGSTEMPLATE_USE_CUSTOM_SETTINGS");
    // @formatter:on
