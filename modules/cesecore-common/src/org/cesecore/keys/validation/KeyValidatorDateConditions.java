...
public enum KeyValidatorDateConditions {
    ...
    // @formatter:on
    LESS_THAN(0, "KEYVALIDATORDATECONDITION_LESS_THAN"), 
    LESS_OR_EQUAL_THAN(1, "KEYVALIDATORDATECONDITION_LESS_OR_EQUAL"), 
    GREATER_THAN(2, "KEYVALIDATORDATECONDITION_GREATER_THAN"), 
    GREATER_OR_EQUAL_THAN(3, "KEYVALIDATORDATECONDITION_GREATER_OR_EQUAL");
    // @formatter:off
