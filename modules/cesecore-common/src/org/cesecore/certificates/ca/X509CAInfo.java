...
public class X509CAInfo extends CAInfo {
  ...
  public void setDefaultCRLDistPoint(String defaultCRLDistPoint) {
     ...
     * @param crlUrl is the URL to the CRL CDP for this CA, in the format "http://example.com/CA*.crl", where any '*' will be replaced by an index number
     ...
     * @param crlUrl is the URL to the CRL CDP for this CA, in the format "http://example.com/CA*.crl", where any '*' will be replaced by given index number 
