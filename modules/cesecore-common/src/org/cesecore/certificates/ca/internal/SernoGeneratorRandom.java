...
public class SernoGeneratorRandom implements SernoGenerator {
    ...
    /** random generator algorithm, defaults to FIPS approve BCSP800Hybrid in constructor 
    ...
    @Override
    public void setAlgorithm(final String algo) throws IllegalStateException {
        ...
        if (this.algorithm == null || !this.algorithm.equals(algo)) {
            this.algorithm = algo;
            this.random = RandomHelper.getInstance(algorithm);
