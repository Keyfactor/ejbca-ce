...
public interface HybridCa {
    ...
    * @param alternativePublicKey the alternative public key to be signed. Will have precedence over one provided in the RequestMessage
    ...
    */
    Certificate generateCertificate(CryptoToken cryptoToken, EndEntityInformation subject, RequestMessage request, PublicKey publicKey,
            final PublicKey alternativePublicKey, int keyusage, Date notBefore, Date notAfter, CertificateProfile certProfile, Extensions extensions,
            String sequence, CertificateGenerationParams certGenParams, AvailableCustomCertificateExtensionsConfiguration cceConfig)
    ...
    * @param alternativePublicKey the alternative public key to be signed.
    * @param subject end entity information. If it contains certificateRequest under extendedInformation, it will be used instead of the provided RequestMessage and publicKey
    ...
    * @throws IllegalKeyException if the using public key is not allowed to be used by specified certProfile
    */
    Certificate generateCertificate(CryptoToken cryptoToken, EndEntityInformation subject, PublicKey publicKey, final PublicKey alternativePublicKey, int keyusage, Date notBefore,
