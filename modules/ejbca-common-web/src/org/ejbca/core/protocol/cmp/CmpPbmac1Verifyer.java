...
public class CmpPbmac1Verifyer implements CmpMessageProtectionVerifyer {
    ...
    private final AlgorithmIdentifier pAlg;
    private String errMsg;
    private final String macOid;
    private final int iterationCount;
    private String lastUsedRaSecret;
    private final BigInteger dkLen;
    ...
    /**
     * Verifier the PBMAC1 protection of the message.
     ...
     * @throws NoSuchAlgorithmException if the algorithm for the prf or the MAC weren't found
     * @throws CMPException if an exception occurs while verifying the MAC
     */
    public boolean verify(final String raAuthenticationSecret) throws CMPException {
