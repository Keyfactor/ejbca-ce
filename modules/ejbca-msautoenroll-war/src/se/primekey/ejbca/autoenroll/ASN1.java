...
public class ASN1
{
    ...
    static String dump(ASN1Object asn1obj, PKCS10Info info, boolean bPrintToSysOut, int level, String strOid, ASN1Sequence seq1)
    {
        ...
        if (asn1obj instanceof ASN1Set)
        {
            ...
            if (bPrintToSysOut) System.out.println(sb.toString() + asn1set.getClass().getName() + ": " + asn1set.toString());
            ...
            while (objects.hasMoreElements())
            {
                ...
                {
                    if (bPrintToSysOut) System.out.println(sb.toString() + "*** obj: [" + nextElement + "], class: " + nextElement.getClass().getName());
                }
            }
        }
...
//            if (bPrintToSysOut) System.out.println(sb.toString() + asn1seq.getClass().getName() + ": " + asn1seq.toString());
            if (bPrintToSysOut) System.out.println(sb.toString() + asn1seq.getClass().getName());
        ...
        else if (asn1obj instanceof DERTaggedObject)
        {
            ...
            if (bPrintToSysOut) System.out.println(sb.toString() + asn1obj.getClass().getName() + ", Tag No: " + dto.getTagNo() + " : [" + dto + "]");
        ...
        else if (asn1obj instanceof DEROctetString)
        {
            ...
            if (bPrintToSysOut) System.out.println(sb.toString() + asn1obj.getClass().getName() + ": [" + octetString.getOctets().length + "]: " + octetString.toString());
...
//                    if (bPrintToSysOut) System.out.println("val: " + val);
                    ...
                    if (bPrintToSysOut) System.out.println(sb.toString() + strTemp);
                }
...
//                        if (bPrintToSysOut) System.out.println(sb.toString() + ASN1Dump.dumpAsString(octetString, true));
                        if (bPrintToSysOut) System.out.println(decodeSequence(octetString, sb.toString()));
                    }
                    catch (Exception ex)
                    {
                        ex.printStackTrace();
                ...
                else if (0 == strOid.compareTo("1.3.6.1.4.1.311.20.2")) // Enroll Certtype Extension
                {
                    ...
                    if (bPrintToSysOut) System.out.println(sb.toString() + strCertificateTemplateName);
                }
                else if (0 == strOid.compareTo("1.3.6.1.4.1.311.21.7")) // Certificate Template
                {
                    ...
                    if (bPrintToSysOut) System.out.println(sb.toString() + strCertificateTemplateOid);
                }
        ...
        else if (asn1obj instanceof DERObjectIdentifier)
        {
            ...
            if (null != name)
            {
                if (bPrintToSysOut) System.out.println(sb.toString() + name + " [" + objIdent + "] : " + objIdent.getClass().getName());
                retval = objIdent.toString();
            }
            else
            {
                if (bPrintToSysOut) System.out.println(sb.toString() + objIdent + " : " + objIdent.getClass().getName());
            }
        }
        else if ((asn1obj instanceof DERBoolean) || (asn1obj instanceof DERInteger) || (asn1obj instanceof DERNull))
        {
            if (bPrintToSysOut) System.out.println(sb.toString() + asn1obj + " : " + asn1obj.getClass().getName());
        }
        ...
        else if (asn1obj instanceof DERBitString)
        {
            ...
            if (bPrintToSysOut) System.out.println(sb.toString() + asn1obj.getClass().getName() + ", (Length, Padbits, intValue) = " + dbs.getBytes().length + ", "
                    + dbs.getPadBits() + ", " + dbs.intValue() + " : [" + dbs.toString() + "]");
            ASN1Dump.dumpAsString(dbs, true);
        }
        else
        {
            if (bPrintToSysOut) System.out.println(sb.toString() + "*** obj: [" + asn1obj + "], class: " + asn1obj.getClass().getName());
        }
...
//                System.out.println("LenOID = " + lenOid + ", index = " + index + ", lenSeq = " + lenSeq + ", lenString = " + bytes.length);
            ...
            else  // Assume anything left are parameters?
            {
                ...
                {
                    sb.append("\n").append(indent).append("\t").append(m).append(": [").append((int) (bytes[m] & 0x00ff)).append("] [").append((char) bytes[m]).append("]");
                }
                sb0.append("\n").append(indent);
                sb0.append(sb);
