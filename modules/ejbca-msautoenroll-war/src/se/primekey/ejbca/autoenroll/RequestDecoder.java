...
//		cmsData[cmsData.length - 554] += 1; // Kills PKCS #10 signature
        ...
        {
            inner = (ASN1Sequence) ASN1Sequence.getInstance(
                    (ASN1TaggedObject) obj, false).getObjectAt(1);
        }
        else
        {
...
//            ex.printStackTrace();
        ...
        try
        {
            ...
            JcaSignerInfoVerifierBuilder signerInfoVerifierBuilder = new JcaSignerInfoVerifierBuilder(calculatorProviderBuilder.build()).setProvider(BouncyCastleProvider.PROVIDER_NAME);
