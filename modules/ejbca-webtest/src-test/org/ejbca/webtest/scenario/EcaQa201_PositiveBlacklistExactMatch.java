...
public class EcaQa201_PositiveBlacklistExactMatch extends WebTestBase {
    ...
    private static class TestData {
        ...
        static final String APPROVAL_PROFILE_NAME = "EcaQa201C_ApprovalProfile";
        static final String APPROVAL_PROFILE_TYPE_PARTITIONED_APPROVAL = "Partitioned Approval";
        static final String CERTIFICATE_PROFILE_NAME = "EcaQa201C_CertificateProfile";
        static final String ROLE_NAME = "Super Administrator Role";
        static final String ENTITY_NAME = "EcaQa201C_EntityProfile";
