...
public class EcaQa201_PositiveBlacklistBaseDomains extends WebTestBase {
    ...
    public static void exit() throws AuthorizationDeniedException {
        ...
        removeCaAndCryptoToken(EcaQa201_PositiveBlacklistBaseDomains.TestData.CA_NAME);
    ...
    public void stepA_AddAValidator() {
        ...
        validatorsHelper.addValidator(EcaQa201_PositiveBlacklistBaseDomains.TestData.VALIDATOR_NAME);
    ...
    public void stepB_EditAValidatorWithBlacklist() {
        validatorsHelper.openPage(getAdminWebUrl());
        validatorsHelper.openEditValidatorPage(EcaQa201_PositiveBlacklistBaseDomains.TestData.VALIDATOR_NAME);
    ...
    public void stepF_CreateCA() {
        ...
        caHelper.addCa(EcaQa201_PositiveBlacklistBaseDomains.TestData.CA_NAME);
        caHelper.setValidity(EcaQa201_PositiveBlacklistBaseDomains.TestData.CA_VALIDITY);
    ...
    public void stepG_SaveCA() {
        caHelper.createCa();
        caHelper.assertExists(EcaQa201_PositiveBlacklistBaseDomains.TestData.CA_NAME);
    }
    ...
    public void stepI_EditApprovalProfile() {
        ...
        approvalProfilesHelperDefault.setApprovalStepPartitionApprovePartitionRole(0, 0,
                EcaQa201_PositiveBlacklistBaseDomains.TestData.ROLE_NAME);
    }
    ...
    public void stepK_AddCertificateProfile() {
        ...
        certificateProfileHelper.addCertificateProfile(EcaQa201_PositiveBlacklistBaseDomains.TestData.CERTIFICATE_PROFILE_NAME);
        // Verify Audit Log
        ...
        auditLogHelper.assertLogEntryByEventText(
                ...
                "Success",
                null,
                Collections.singletonList("New certificate profile " + EcaQa201_PositiveBlacklistBaseDomains.TestData.CERTIFICATE_PROFILE_NAME + " added successfully.")
        );
    }
    ...
    public void stepL_EditCertificateProfile() {
        ...
        certificateProfileHelper.openPage(getAdminWebUrl());
        certificateProfileHelper.openEditCertificateProfilePage(EcaQa201_PositiveBlacklistBaseDomains.TestData.CERTIFICATE_PROFILE_NAME);

        // Set Approval Settings
        certificateProfileHelper.selectApprovalSetting(CertificateProfileHelper.ApprovalSetting.ADD_OR_EDIT_END_ENTITY, EcaQa201_PositiveBlacklistBaseDomains.TestData.APPROVAL_PROFILE_NAME);
        certificateProfileHelper.selectApprovalSetting(CertificateProfileHelper.ApprovalSetting.KEY_RECOVERY, EcaQa201_PositiveBlacklistBaseDomains.TestData.APPROVAL_PROFILE_NAME);
        certificateProfileHelper.selectApprovalSetting(CertificateProfileHelper.ApprovalSetting.REVOCATION, EcaQa201_PositiveBlacklistBaseDomains.TestData.APPROVAL_PROFILE_NAME);
        ...
        public void stepM_SaveCertificateProfile() {
            ...
            auditLogHelper.assertLogEntryByEventText(
                    ...
                    null,
                    Arrays.asList(
                            "msg=Edited certificateprofile " + EcaQa201_PositiveBlacklistBaseDomains.TestData.CERTIFICATE_PROFILE_NAME + ".",
        ...
        public void stepN_AddEndEntityProfile() {
            ...
            eeProfileHelper.addEndEntityProfile(EcaQa201_PositiveBlacklistBaseDomains.TestData.ENTITY_NAME);
        }

        @Test
        public void stepO_EditEntityProfile() {
            eeProfileHelper.openEditEndEntityProfilePage(EcaQa201_PositiveBlacklistBaseDomains.TestData.ENTITY_NAME);
        ...
        public void stepP_SaveEntityProfile() {
            eeProfileHelper.assertEndEntityProfileNameExists(EcaQa201_PositiveBlacklistBaseDomains.TestData.ENTITY_NAME);
        }
    ...
    public void stepQ_MakeNewCertificate() {
        ...
        raWebHelper.selectCertificateTypeByEndEntityName(EcaQa201_PositiveBlacklistBaseDomains.TestData.ENTITY_NAME);
        raWebHelper.selectCertificationAuthorityByName(TestData.CA_NAME);
        raWebHelper.selectKeyPairGenerationProvided();
        raWebHelper.fillClearCsrText(StringUtils.join(EcaQa201_PositiveBlacklistBaseDomains.TestData.CERTIFICATE_REQUEST_PEM, "\n"));
    }
