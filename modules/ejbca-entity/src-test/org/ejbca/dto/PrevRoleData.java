 ...
 */
@Entity
@Table(name = "RoleDataDto")
public class PrevRoleData extends ProtectedData implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger log = Logger.getLogger(PrevRoleData.class);
    ...
    public PrevRoleData(final PrevRole role) {
        setRole(role);
    }
    ...
    @Transient
    public PrevRole getRole() {
        return new PrevRole(getId(), getNameSpace(), getRoleName(), getDataMap());
    }

    @Transient
    public void setRole(final PrevRole role) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        PrevRoleData other = (PrevRoleData) obj;
        if (id != other.id)
            return false;
