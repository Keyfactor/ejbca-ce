...
/**
 * Constants for PreCertificateMaintenanceWorker. This is a separate class, to make the constants
 * available in code in community edition.
 */
public class PreCertificateMaintenanceWorkerConstants {

    public static final String WORKER_CLASS = "org.ejbca.core.model.services.workers.PreCertificateMaintenanceWorker";
    ...
    public static final String PROP_REVOKE_PRE_CERTS = "worker.revokePreCerts";
