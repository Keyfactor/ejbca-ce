...
public class Approval implements Serializable, Comparable<Approval>, Externalizable { 
	...
	private static final Logger log = Logger.getLogger(Approval.class);
	...
	public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
		...
		if (version < 4) {
		    final String msg = "Incompatible Approval found, version < 4. Please remove from database to continue.";
		    log.error(msg);
