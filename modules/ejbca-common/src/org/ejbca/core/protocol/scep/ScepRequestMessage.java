...
public class ScepRequestMessage extends PKCS10RequestMessage implements RequestMessage {
     ...
     *  Defaults to SMIMECapability.aES128_CBC for SCEP messages. If SCEP request is
    ...
    private void init() throws IOException {
        ...
        if (ctoid.equals(CMSObjectIdentifiers.signedData.getId())) {
            ...
            sd = SignedData.getInstance(ASN1Sequence.getInstance(ci.getContent()));	
            ...
            if (sis.hasMoreElements()) {
                ...
                while (attr.hasMoreElements()) {
                    ...
                    if (a.getAttrType().getId().equals(id_transId)) {
                        ...
                        if (log.isDebugEnabled()) {
                        	log.debug("transactionId = " + LogRedactionUtils.getRedactedMessage(transactionId));
                        }
                    }
