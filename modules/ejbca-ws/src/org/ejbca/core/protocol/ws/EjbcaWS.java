...
/**
 * Implementor of the IEjbcaWS interface. Keep this class free of other helper
 * methods, and implement them in the helper classes instead.
 * 
...
public class EjbcaWS implements IEjbcaWS {
     ...
     * 
     */
    // TODO: Is more than one instance created of this class? If so, we should
    // probably cache the helper..
     ...
     */
    public void editUser(UserDataVOWS userdata) throws CADoesntExistsException, AuthorizationDeniedException, UserDoesntFullfillEndEntityProfile,
            EjbcaException, ApprovalException, WaitingForApprovalException {

        final IPatternLogger logger = TransactionLogger.getPatternLogger();
        try {
            EjbcaWSHelper ejbhelper = new EjbcaWSHelper(wsContext, authorizationSession, caAdminSession, certificateStoreSession, hardTokenSession,
                    raAdminSession, userAdminSession);
            ...
            throw EjbcaWSHelper.getInternalException(e, logger);
            /*
             * } catch (RemoteException e) { throw
             * EjbcaWSHelper.getInternalException(e, logger);
             */
    ...
    public List<UserDataVOWS> findUser(UserMatch usermatch) throws AuthorizationDeniedException, IllegalQueryException, EjbcaException {
        ...
        try {
            ...
            Collection<UserDataVO> result = userAdminSession.query(admin, query, null, null, MAXNUMBEROFROWS); // also
                                                                                                               // checks
                                                                                                               // authorization
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#findCerts(java.lang.String,
     *      boolean)
     */
    public List<Certificate> findCerts(String username, boolean onlyValid) throws AuthorizationDeniedException, EjbcaException {
        ...
        try {
            ...
            Admin admin = ejbhelper.getAdmin();
            logAdminName(admin, logger);
            if (userAdminSession.findUser(admin, username) != null) { // checks
                                                                      // authorization
                                                                      // on CA
                                                                      // and
                                                                      // profiles
        ...
        try {
            if (userAdminSession.findUser(admin, username) != null) { // checks
                ...
                if (certs.size() > 0) {
                    ...
                    if (lastcert != null) {
                        log.debug("Found certificate for user with subjectDN: " + CertTools.getSubjectDN(lastcert) + " and serialNo: "
                                + CertTools.getSerialNumberAsString(lastcert));
                        retval.add(new Certificate(lastcert));
                        // If we added a certificate, we will also append the CA
                        // certificate chain
                        boolean selfSigned = false;
                        int bar = 0; // to control so we don't enter an infinite
                                     // loop. Max chain length is 10
                        while ((!selfSigned) && (bar < 10)) {
                            ...
                            while (iter.hasNext()) {
                                ...
                                try {
                                    ...
                                    // To determine if we have found the last
                                    // certificate or not
                                    selfSigned = CertTools.isSelfSigned(cert);
                                    // Find the next certificate in the chain
                                    // now
                                    lastcert = cert;
                                    break; // Break of iteration over this CAs
                                           // certs
                                } catch (Exception e) {
                                    log
                                            .debug("Failed verification when looking for CA certificate, this was not the correct CA certificate. IssuerDN: "
                                                    + issuerDN + ", serno: " + CertTools.getSerialNumberAsString(cert));
                                }
                            }
                        }
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#crmfRequest(java.lang.String,
    ...
    public CertificateResponse crmfRequest(String username, String password, String crmf, String hardTokenSN, String responseType)
        ...
        final IPatternLogger logger = TransactionLogger.getPatternLogger();
        try {
            return new CertificateResponse(responseType, processCertReq(username, password, crmf, REQTYPE_CRMF, hardTokenSN, responseType, logger));
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#spkacRequest(java.lang.String,
     *      java.lang.String, java.lang.String, java.lang.String,
     *      java.lang.String)
     */
    public CertificateResponse spkacRequest(String username, String password, String spkac, String hardTokenSN, String responseType)
        ...
        final IPatternLogger logger = TransactionLogger.getPatternLogger();
        try {
            return new CertificateResponse(responseType, processCertReq(username, password, spkac, REQTYPE_SPKAC, hardTokenSN, responseType, logger));
        } catch (CADoesntExistsException t) {
            logger.paramPut(TransactionTags.ERROR_MESSAGE.toString(), t.toString());
            throw t;
        } catch (AuthorizationDeniedException t) {
    ...
    /**
     * Method called from cvcRequest that simply verifies a CVCertificate with a
     * public key and throws AuthorizationDeniedException if verification works.
     * Used to check if a request is sent containing the same public key. this
     * could be replaced by enforcing unique public key on the CA (from EJBCA
     * 3.10) actually...
     * 
     * @param pk
     * @param innerreq
    ...
    private void checkInnerCollision(PublicKey pk, CVCertificate innerreq, String holderref) throws AuthorizationDeniedException {
        // Check to see that the inner signature does not verify using an old
        // certificate (public key)
        // because that means the same keys were used, and that is not allowed
    ...
    /**
     * Method that gets the public key from a CV certificate, possibly enriching
     * it with domain parameters from the CVCA certificate if it is an EC public
     * key.
     * 
     * @param ejbhelper
     * @param admin
     ...
     */
    private PublicKey getCVPublicKey(EjbcaWSHelper ejbhelper, Admin admin, java.security.cert.Certificate cert) throws CADoesntExistsException,
            RemoteException {
        PublicKey pk = cert.getPublicKey();
        if (pk instanceof PublicKeyEC) {
            // The public key of IS and DV certificate do not have any EC
            // parameters so we have to do some magic to get a complete EC
            // public key
            ...
            if (cacerts != null) {
                ...
                if (cvcacert != null) {
                    // Do the magic adding of parameters, if they don't exist in
                    // the pk
                    try {
     ...
     */
    public List<Certificate> cvcRequest(String username, String password, String cvcreq) throws CADoesntExistsException,
            AuthorizationDeniedException, UserDoesntFullfillEndEntityProfile, NotFoundException, EjbcaException, ApprovalException,
            WaitingForApprovalException, SignRequestException, CertificateExpiredException {
        ...
        // get and old status that we can remember so we can reset status if
        ...
        try {
            ...
            // In that case look for it's last old certificate and try to
            // authenticate the request using an outer signature.
            // If this verification is correct, set status to NEW and continue
            // process the request.
            if (user != null) {
                ...
                if (parsedObject instanceof CVCAuthenticatedRequest) {
                    ...
                    // Check to see that the inner signature does not also
                    // verify using an old certificate
                    // because that means the same keys were used, and that is
                    // not allowed according to the EU policy
                    // This must be done whether it is signed by CVCA or a
                    // renewal request
                    ...
                    if (oldcerts != null) {
                        ...
                        while (iterator.hasNext()) {
                            ...
                            checkInnerCollision(pk, innerreq, holderRef.getConcatenated()); // Throws
                                                                                            // AuthorizationDeniedException
                        }
                    }

                    boolean verifiedOuter = false; // So we can throw an error
                                                   // if we could not verify
                    if (StringUtils.equals(holderRef.getMnemonic(), caRef.getMnemonic())
                        ...
                        Collection<java.security.cert.Certificate> certs = certificateStoreSession.findCertificatesByUsername(admin, username);
                        // certs contains certificates ordered with last expire
                        // date first. Last expire date should be last issued
                        // cert
                        // We have to iterate over available user certificates,
                        // because we don't know which on signed the old one
                        // and cv certificates have very coarse grained validity
                        // periods so we can't really know which one is the
                        // latest one
                        ...
                        if (certs != null) {
                            ...
                            while (iterator.hasNext()) {
                                java.security.cert.Certificate cert = iterator.next();
                                try {
                                    // Only allow renewal if the old certificate
                                    // is valid
                                    PublicKey pk = getCVPublicKey(ejbhelper, admin, cert);
                                    ...
                                    // Yes we did it, we can move on to the next
                                    // step because the outer signature was
                                    // actually created with some old
                                    // certificate
                                    verifiedOuter = true;
                                    if (ejbhelper.checkValidityAndSetUserPassword(admin, cert, username, password)) {
                                        // If we managed to verify the
                                        // certificate we will break out of the
                                        // loop
                                        break;
                                    }

                                    // If verification of outer signature fails
                                    // because the signature is invalid we will
                                    // break and deny the request...with a
                                    // message
                                } catch (InvalidKeyException e) {
                                    String msg = intres.getLocalizedMessage("cvc.error.outersignature", holderRef.getConcatenated(), e.getMessage());
                                    log.warn(msg, e);
                                } catch (CertificateExpiredException e) { // thrown
                                                                          // by
                                                                          // checkValidityAndSetUserPassword
                                    String msg = intres.getLocalizedMessage("cvc.error.outersignature", holderRef.getConcatenated(), e.getMessage());
                                    // Only log this with DEBUG since it will be
                                    // a common case that happens, nothing that
                                    // should cause any alerts
                                    log.debug(msg);
                                    // This exception we want to throw on,
                                    // because we want to give this error if
                                    // there was a certificate suitable for
                                    // verification, but it had expired. This is
                                    // thrown by checkValidityAndSetUserPassword
                                    // after the request has already been
                                    // verified using the public key of the
                                    // certificate.
                                    throw e;
                                } catch (CertificateException e) {
                                    String msg = intres.getLocalizedMessage("cvc.error.outersignature", holderRef.getConcatenated(), e.getMessage());
                                    ...
                                    // Failing to verify the outer signature
                                    // will be normal, since we must try all old
                                    // certificates
                                    if (log.isDebugEnabled()) {
                                        String msg = intres.getLocalizedMessage("cvc.error.outersignature", holderRef.getConcatenated(), e
                                                .getMessage());
                                        log.debug(msg);
                                    }
                                }
                            } // while (iterator.hasNext()) {
                            // if verification failed because the old cert was
                            // not yet valid, continue processing as usual,
                            // using the sent in username/password hoping the
                            // status is NEW and password is correct. If old
                            // certificate was expired a
                            // CertificateExpiredException is thrown above.

                        } // if (certs != null) {

                        // If there are no old certificate, continue processing
                        // as usual, using the sent in username/password hoping
                        // the
                        ...
                        if (info != null) {
                            ...
                            if (certs != null) {
                                ...
                                if (iterator.hasNext()) {
                                    ...
                                    try {
                                        // The CVCA certificate always contains
                                        // the full key parameters, no need to
                                        // du any EC curve parameter magic here
                                        authreq.verify(cert.getPublicKey());
                                        log.debug("Verified outer signature");
                                        verifiedOuter = true;
                                        // Yes we did it, we can move on to the
                                        // next step because the outer signature
                                        // was actually created with some old
                                        // certificate
                                        if (!ejbhelper.checkValidityAndSetUserPassword(admin, cert, username, password)) {
                                            // If the CA certificate was not
                                            // valid, we are not happy
                    ...
                    // if verification failed because we could not verify the
                    // outer signature at all it is an error
                    if (!verifiedOuter) {
                        String msg = intres.getLocalizedMessage("cvc.error.outersignature", holderRef.getConcatenated(),
                ...
                // If it is not an authenticated request, with an outer
                // signature, continue processing as usual,
                // using the sent in username/password hoping the status is NEW
                // and password is correct.
            } else {
                // If there are no old user, continue processing as usual... it
                // will fail
                log.debug("No existing user with username: " + username);
            }

            // Finally generate the certificate (assuming status is NEW and
            // password is correct
            ...
            // Have this first, if processReq throws an EjbcaException we want
            // to reset status
     ...
     */
    public byte[] caRenewCertRequest(String caname, List<byte[]> cachain, boolean regenerateKeys, boolean usenextkey, boolean activatekey,
            String keystorepwd) throws CADoesntExistsException, AuthorizationDeniedException, EjbcaException, ApprovalException,
            WaitingForApprovalException {
        if (log.isTraceEnabled()) {
            log.trace(">caRenewCertRequest");
        }
        log.debug("Create certificate request for CA " + caname + ", regeneratekeys=" + regenerateKeys + ", usenextkey=" + usenextkey
                + ", activatekey=" + activatekey + ", keystorepwd: " + (keystorepwd == null ? "null" : "hidden"));
        EjbcaWSHelper ejbhelper = new EjbcaWSHelper(wsContext, authorizationSession, caAdminSession, certificateStoreSession, hardTokenSession,
                raAdminSession, userAdminSession);
        Admin admin = ejbhelper.getAdmin();
        byte[] ret = null;
     ...
     */
    public void caCertResponse(String caname, byte[] cert, List<byte[]> cachain, String keystorepwd) throws CADoesntExistsException,
            AuthorizationDeniedException, EjbcaException, ApprovalException, WaitingForApprovalException {
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#pkcs10Request(java.lang.String,
     *      java.lang.String, java.lang.String, java.lang.String,
     *      java.lang.String)
     */
    public CertificateResponse pkcs10Request(String username, String password, String pkcs10, String hardTokenSN, String responseType)
        ...
        try {
            ...
            return new CertificateResponse(responseType,
                    processCertReq(username, password, pkcs10, REQTYPE_PKCS10, hardTokenSN, responseType, logger));
        } catch (CADoesntExistsException t) {
            logger.paramPut(TransactionTags.ERROR_MESSAGE.toString(), t.toString());
            throw t;
        } catch (AuthorizationDeniedException t) {
    ...
    private byte[] processCertReq(String username, String password, String req, int reqType, String hardTokenSN, String responseType,
            IPatternLogger logger) throws EjbcaException, AuthorizationDeniedException {
        byte[] retval = null;
        ...
        try {
            ...
            if (reqType == REQTYPE_SPKAC) {
                ...
                if (reqBytes != null) {
                    ...
                    // Verify POPO, we don't care about the challenge, it's not
                    // important.
            ...
            if (reqType == REQTYPE_CRMF) {
                ...
                PublicKey pubKey = keyFact.generatePublic(keySpec); // just
                                                                    // check
                                                                    // it's ok
                imsg = new SimpleRequestMessage(pubKey, username, password);
                // a simple crmf is not a complete PKI message, as desired by
                // the CrmfRequestMessage class
                // PKIMessage msg = PKIMessage.getInstance(new
                // ASN1InputStream(new
                // ByteArrayInputStream(request)).readObject());
                // CrmfRequestMessage reqmsg = new CrmfRequestMessage(msg, null,
                // true, null);
                // imsg = reqmsg;
            }
            if (reqType == REQTYPE_CVC) {
                ...
                // Popo is really actually verified by the CA (in
                // RSASignSessionBean) as well
    ...
    private byte[] getCertResponseFromPublicKey(Admin admin, IRequestMessage msg, String hardTokenSN, String responseType, EjbcaWSHelper ejbhelper)
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#pkcs12Req(java.lang.String,
     *      java.lang.String, java.lang.String, java.lang.String,
     *      java.lang.String)
     */
    public KeyStore pkcs12Req(String username, String password, String hardTokenSN, String keyspec, String keyalg) throws CADoesntExistsException,
        ...
        try {
            ...
            if (userdata.getTokenType() != SecConst.TOKEN_SOFT_P12) {
                throw EjbcaWSHelper.getEjbcaException("Error: Wrong Token Type of user, must be 'P12' for PKCS12 requests", logger,
                        ErrorCode.BAD_USER_TOKEN_TYPE, null);
            }
            ...
            try {
                ...
                java.security.KeyStore pkcs12 = tgen.generateOrKeyRecoverToken(admin, username, password, caid, keyspec, keyalg, false, loadkeys,
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#revokeCert(java.lang.String,
    ...
    public void revokeCert(String issuerDN, String certificateSN, int reason) throws CADoesntExistsException, AuthorizationDeniedException,
        ...
        try {
            ...
            // Revoke or unrevoke, will throw appropriate exceptions if
            // parameters are wrong, such as trying to unrevoke a certificate
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#revokeUser(java.lang.String,
     *      int, boolean)
     */
    public void revokeUser(String username, int reason, boolean deleteUser) throws CADoesntExistsException, AuthorizationDeniedException,
            NotFoundException, AlreadyRevokedException, EjbcaException, ApprovalException, WaitingForApprovalException {
     ...
     */
    public void keyRecoverNewest(String username) throws CADoesntExistsException, AuthorizationDeniedException, NotFoundException, EjbcaException,
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#revokeToken(java.lang.String,
     *      int)
     */
    public void revokeToken(String hardTokenSN, int reason) throws CADoesntExistsException, RemoteException, AuthorizationDeniedException,
            NotFoundException, AlreadyRevokedException, EjbcaException, ApprovalException, WaitingForApprovalException {
        EjbcaWSHelper ejbhelper = new EjbcaWSHelper(wsContext, authorizationSession, caAdminSession, certificateStoreSession, hardTokenSession,
                raAdminSession, userAdminSession);
        final IPatternLogger logger = TransactionLogger.getPatternLogger();
    ...
    private void revokeToken(Admin admin, String hardTokenSN, int reason, IPatternLogger logger) throws CADoesntExistsException,
            AuthorizationDeniedException, NotFoundException, EjbcaException, AlreadyRevokedException, ApprovalException, WaitingForApprovalException {
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                try {
                    // Revoke or unrevoke, will throw appropriate exceptions if
                    // parameters are wrong, such as trying to unrevoke a
                    // certificate
                    // that was permanently revoked
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#checkRevokationStatus(java.lang.String,
     *      java.lang.String)
     */

    public RevokeStatus checkRevokationStatus(String issuerDN, String certificateSN) throws CADoesntExistsException, AuthorizationDeniedException,
            EjbcaException {
        final IPatternLogger logger = TransactionLogger.getPatternLogger();
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#fetchUserData(java.util.List,
     *      java.lang.String)
     */
    public List<UserDataSourceVOWS> fetchUserData(List<String> userDataSourceNames, String searchString) throws UserDataSourceException,
            EjbcaException, AuthorizationDeniedException {
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#genTokenCertificates(org.ejbca.core.protocol.ws.objects.UserDataVOWS,
    ...
    public List<TokenCertificateResponseWS> genTokenCertificates(UserDataVOWS userDataWS, List<TokenCertificateRequestWS> tokenRequests,
            HardTokenDataWS hardTokenDataWS, boolean overwriteExistingSN, boolean revocePreviousCards) throws CADoesntExistsException,
        ...
        final EjbcaWSHelper ejbhelper = new EjbcaWSHelper(wsContext, authorizationSession, caAdminSession, certificateStoreSession, hardTokenSession,
                raAdminSession, userAdminSession);
        ...
        try {
            ...
            if (significantcAInfo == null) {
                throw EjbcaWSHelper.getEjbcaException("Error the given CA : " + userDataWS.getCaName() + " couldn't be found.", logger,
            ...
            if (userDataVO != null) {
                ...
                if (endEntityProfileId == 0) {
                    throw EjbcaWSHelper.getEjbcaException("Error given end entity profile : " + userDataWS.getEndEntityProfileName()
                            + " couldn't be found", logger, ErrorCode.EE_PROFILE_NOT_EXISTS, null);
                }
            }
            ...
            if (ejbhelper.isAdmin()) {
                ...
                if (userExists) {
                    ...
                    endEntityProfileId = userDataVO.getEndEntityProfileId();
                    authorizationSession.isAuthorizedNoLog(admin, AccessRulesConstants.ENDENTITYPROFILEPREFIX + endEntityProfileId
                ...
                if (WebServiceConfiguration.getApprovalForGenTokenCertificates()) {
                    ...
                    try {
                        ...
                        if (approvalSuccessfullStep1) {
                            ...
                            userDataWS.setSubjectDN(originalDN); // replace
                                                                 // requested DN
                                                                 // with
                                                                 // original DN
                                                                 // to make sure
                        ...
                        if (status == ApprovalDataVO.STATUS_EXPIREDANDNOTIFIED || status == ApprovalDataVO.STATUS_EXPIRED) {
            ...
            if (ar != null && !approvalSuccessfullStep1) {
                throw new WaitingForApprovalException("The approval for id " + ar.generateApprovalId() + " have not yet been approved", ar
                        .generateApprovalId());
            }
            ...
            if (hardTokenExists) {
                if (overwriteExistingSN) {
                    ...
                    Collection<java.security.cert.X509Certificate> currentCertificates = hardTokenSession.findCertificatesInHardToken(admin,
                            hardTokenDataWS.getHardTokenSN());
                    ...
                    while (iter.hasNext()) {
                        ...
                        try {
                            userAdminSession.revokeCert(admin, CertTools.getSerialNumber(nextCert), CertTools.getIssuerDN(nextCert), currentHardToken
                                    .getUsername(), RevokedCertInfo.REVOKATION_REASON_SUPERSEDED);
                        } catch (AlreadyRevokedException e) {
                            // Ignore previously revoked certificates
                        } catch (FinderException e) {
                            throw EjbcaWSHelper.getEjbcaException("Error revoking old certificate, the user : " + currentHardToken.getUsername()
                                    + " of the old certificate couldn't be found in database.", logger, ErrorCode.USER_NOT_FOUND, null);
                        }
                    }
            ...
            if (revocePreviousCards) {
                ...
                while (htdIter.hasNext()) {
                    ...
                    try {
                        if (hardTokenDataWS.getLabel().equals(HardTokenConstants.LABEL_TEMPORARYCARD) && toRevoke.getLabel() != null
                                && !toRevoke.getLabel().equals(HardTokenConstants.LABEL_TEMPORARYCARD)) {

                            // Token have extended key usage MS Logon, don't
                            // revoke it
                            Iterator<X509Certificate> revokeCerts = hardTokenSession.findCertificatesInHardToken(admin, toRevoke.getHardTokenSN())
                                    .iterator();

                            while (revokeCerts.hasNext()) {
                                X509Certificate next = revokeCerts.next();
                                try {
                                    if (WebServiceConfiguration.getSuspendAllCertificates() || next.getExtendedKeyUsage() == null
                                            || !next.getExtendedKeyUsage().contains(KeyPurposeId.id_kp_smartcardlogon.getId())) {
                                        userAdminSession.revokeCert(admin, next.getSerialNumber(), CertTools.getIssuerDN(next), userDataWS
                                                .getUsername(), RevokedCertInfo.REVOKATION_REASON_CERTIFICATEHOLD);
                                    }
            ...
            try {
                // Check if the userdata exist and edit/add it depending on
                // which
                ...
                while (iter.hasNext()) {
                    ...
                    if (certificateProfileId == 0) {
                        EjbcaWSHelper.getEjbcaException("Error the given Certificate Profile : " + next.getCertificateProfileName()
                                + " couldn't be found.", logger, ErrorCode.CERT_PROFILE_NOT_EXISTS, null);
                    }
                    ...
                    if (next.getValidityIdDays() != null) {
                        try {
                            ...
                            EjbcaWSHelper.getEjbcaException("Error : Validity in Days must be a number", logger, ErrorCode.BAD_VALIDITY_FORMAT, null);
                        }
                    }

                    CAInfo cAInfo = caAdminSession.getCAInfo(admin, next.getCAName());
                    if (cAInfo == null) {
                        throw EjbcaWSHelper.getEjbcaException("Error the given CA : " + next.getCAName() + " couldn't be found.", logger,
                                ErrorCode.CA_NOT_EXISTS, null);
                    }
                    ...
                    if (next.getType() == HardTokenConstants.REQUESTTYPE_PKCS10_REQUEST) {
                        ...
                        if (eDate == null) {
                            ...
                            cert = signSession.createCertificate(admin, userData.getUsername(), password, pkcs10req.getRequestPublicKey(), -1, bDate,
                                    eDate);
                        }
                        ...
                        if (!next.getTokenType().equals(HardTokenConstants.TOKENTYPE_PKCS12)) {
                            throw EjbcaWSHelper.getEjbcaException("Unsupported Key Store Type : " + next.getTokenType() + " only "
                                    + HardTokenConstants.TOKENTYPE_PKCS12 + " is supported", logger, ErrorCode.NOT_SUPPORTED_KEY_STORE, null);
                        }
                        ...
                        if (eDate == null) {
                            ...
                            cert = (X509Certificate) signSession.createCertificate(admin, userData.getUsername(), password, keys.getPublic(), -1,
                                    bDate, eDate);
                        }
            ...
            while (iter.hasNext()) {
                ...
                default:
                    throw EjbcaWSHelper
                            .getEjbcaException("Unsupported PIN Type " + pinData.getType(), logger, ErrorCode.NOT_SUPPORTED_PIN_TYPE, null);
                }
            }
            ...
            case HardTokenConstants.TOKENTYPE_ENHANCEDEID:
                ...
                break;
            default:
                throw EjbcaWSHelper.getEjbcaException("Unsupported Token Type : " + hardTokenDataWS.getTokenType(), logger,
                        ErrorCode.NOT_SUPPORTED_TOKEN_TYPE, null);
            ...
            hardTokenSession.addHardToken(admin, hardTokenDataWS.getHardTokenSN(), userDataWS.getUsername(), significantcAInfo.getSubjectDN(),
                    tokenType, hardToken, genCertificates, hardTokenDataWS.getCopyOfSN());
     ...
     */
    public HardTokenDataWS getHardTokenData(String hardTokenSN, boolean viewPUKData, boolean onlyValidCertificates) throws CADoesntExistsException,
            AuthorizationDeniedException, HardTokenDoesntExistsException, NotFoundException, ApprovalRequestExpiredException,
            WaitingForApprovalException, ApprovalRequestExecutionException, EjbcaException {
        ...
        try {
            try {
                ...
                if (WebServiceConfiguration.getApprovalForHardTokenData()) {
                    ...
                    int caid = userData.getCAId();
                    caAdminSession.verifyExistenceOfCA(caid);
                    ar = new GenerateTokenApprovalRequest(userData.getUsername(), userData.getDN(), hardTokenData.getHardToken().getLabel(), admin,
                            null, WebServiceConfiguration.getNumberOfRequiredApprovals(), caid, userData.getEndEntityProfileId());
                    int status = ApprovalDataVO.STATUS_REJECTED;
                    try {
                        if (!WebServiceConfiguration.getApprovalForGenTokenCertificates()) {
                            throw new ApprovalException("");
                        ...
                        // GenTokenCertificates approval doesn't exists, try a
                        // getHardTokenData request
                        if (!WebServiceConfiguration.getApprovalForHardTokenData()) {
                        ...
                        if (genNewRequest) {
                            ...
                            try {
                                approvalSession.addApprovalRequest(admin, ar, raAdminSession.getCachedGlobalConfiguration(admin));
                                throw new WaitingForApprovalException("Adding approval to view hard token data with id " + ar.generateApprovalId(),
    ...
    private List<HardTokenDataWS> getHardTokenDatas(Admin admin, String username, boolean viewPUKData, boolean onlyValidCertificates,
            IPatternLogger logger) throws CADoesntExistsException, AuthorizationDeniedException, EjbcaException {
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#republishCertificate(java.lang.String,
     *      java.lang.String)
     */
    public void republishCertificate(String serialNumberInHex, String issuerDN) throws CADoesntExistsException, AuthorizationDeniedException,
        ...
        try {
            ...
            if (certreqhist == null) {
                throw new PublisherException("Error: the  certificate with  serialnumber : " + serialNumberInHex + " and issuerdn " + issuerDN
            ...
            if (certreqhist != null) {
                CertificateProfile certprofile = certificateStoreSession.getCertificateProfile(admin, certreqhist.getUserDataVO()
                ...
                if (certprofile != null) {
                    ...
                    if (certprofile.getPublisherList().size() > 0) {
                        if (publisherSession.storeCertificate(admin, certprofile.getPublisherList(), cert, certreqhist.getUserDataVO().getUsername(),
                                certreqhist.getUserDataVO().getPassword(), certreqhist.getUserDataVO().getDN(), certinfo.getCAFingerprint(), certinfo
                                        .getStatus(), certinfo.getType(), certinfo.getRevocationDate().getTime(), certinfo.getRevocationReason(),
                                certinfo.getTag(), certinfo.getCertificateProfileId(), certinfo.getUpdateTime().getTime(), certreqhist
                                        .getUserDataVO().getExtendedinformation())) {
                        } else {
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#customLog(int, String,
     *      String)
     */
    public void customLog(int level, String type, String cAName, String username, Certificate certificate, String msg)
        ...
        try {
            ...
            case IEjbcaWS.CUSTOMLOG_LEVEL_INFO:
                ...
                break;
            default:
                throw EjbcaWSHelper.getEjbcaException("Illegal level " + level + " sent to customLog call.", logger, ErrorCode.INVALID_LOG_LEVEL,
                        null);
            }
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#deleteUserDataFromSource(List,
     *      String, boolean)
     */
    public boolean deleteUserDataFromSource(List<String> userDataSourceNames, String searchString, boolean removeMultipleMatch)
            throws AuthorizationDeniedException, MultipleMatchException, UserDataSourceException, EjbcaException {
        boolean ret = false;
        EjbcaWSHelper ejbhelper = new EjbcaWSHelper(wsContext, authorizationSession, caAdminSession, certificateStoreSession, hardTokenSession,
                raAdminSession, userAdminSession);
    ...
    /**
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#getCertificate(String,
     *      String)
     */
    public Certificate getCertificate(String certSNinHex, String issuerDN) throws CADoesntExistsException, AuthorizationDeniedException,
            EjbcaException {
        ...
        try {
            ...
            java.security.cert.Certificate cert = certificateStoreSession.findCertificateByIssuerAndSerno(admin, issuerDN, new BigInteger(
                    certSNinHex, 16));
            if (cert != null) {
     ...
     */
    public NameAndId[] getAuthorizedEndEntityProfiles() throws AuthorizationDeniedException, EjbcaException {
        EjbcaWSHelper ejbhelper = new EjbcaWSHelper(wsContext, authorizationSession, caAdminSession, certificateStoreSession, hardTokenSession,
                raAdminSession, userAdminSession);
        Admin admin = ejbhelper.getAdmin();
        TreeMap<String, Integer> ret = new TreeMap<String, Integer>();
    ...
    public NameAndId[] getAvailableCAsInProfile(int entityProfileId) throws AuthorizationDeniedException, EjbcaException {
        ...
        try {
            EndEntityProfile profile = raAdminSession.getEndEntityProfile(admin, entityProfileId);
            Collection<String> cas = profile.getAvailableCAs(); // list of CA
                                                                // ids available
                                                                // in profile
            HashMap<Integer, String> map = caAdminSession.getCAIdToNameMap(admin);
            for (String id : cas) {
     ...
     * 
     * @see
     * org.ejbca.core.protocol.ws.common.IEjbcaWS#getPublisherQueueLength(java
     * .lang.String)
     */
    public int getPublisherQueueLength(String name) throws EjbcaException {
        final IPatternLogger logger = TransactionLogger.getPatternLogger();
        try {
            final EjbcaWSHelper ejbhelper = new EjbcaWSHelper(wsContext, authorizationSession, caAdminSession, certificateStoreSession,
                    hardTokenSession, raAdminSession, userAdminSession);
            final Admin admin = ejbhelper.getAdmin(true);
            logAdminName(admin, logger);
    ...
    /**
     * @throws IllegalQueryException
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#certificateRequest(org.ejbca.core.protocol.ws.objects.UserDataVOWS,
    ...
    public CertificateResponse certificateRequest(UserDataVOWS userdata, String requestData, int requestType, String hardTokenSN, String responseType)
        ...
        try {
            ...
            EjbcaWSHelper ejbcawshelper = new EjbcaWSHelper(wsContext, authorizationSession, caAdminSession, certificateStoreSession,
                    hardTokenSession, raAdminSession, userAdminSession);
            ...
            return new CertificateResponse(responseType, certificateRequestSession.processCertReq(admin, userdatavo, requestData, requestType,
    ...
    /**
     * @throws IllegalQueryException
     * @see org.ejbca.core.protocol.ws.common.IEjbcaWS#softTokenRequest(org.ejbca.core.protocol.ws.objects.UserDataVOWS,
     *      String, String, String)
     */
    public KeyStore softTokenRequest(UserDataVOWS userdata, String hardTokenSN, String keyspec, String keyalg) throws CADoesntExistsException,
            AuthorizationDeniedException, NotFoundException, UserDoesntFullfillEndEntityProfile, ApprovalException, WaitingForApprovalException,
            EjbcaException {
        final IPatternLogger logger = TransactionLogger.getPatternLogger();
        try {
