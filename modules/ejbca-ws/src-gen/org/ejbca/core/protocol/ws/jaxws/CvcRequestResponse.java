...
@XmlRootElement(name = "cvcRequestResponse", namespace = "http://ws.protocol.core.ejbca.org/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "cvcRequestResponse", namespace = "http://ws.protocol.core.ejbca.org/")
public class CvcRequestResponse {
