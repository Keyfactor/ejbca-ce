...
if ! [ -f $JBOSS_HOME/server/default/lib/jce-jdk13-114.jar ]
then
  cp lib/jce-jdk13-114.jar $JBOSS_HOME/server/default/lib
  echo Copied jce-jdk13-114.jar to $JBOSS_HOME/server/default/lib. JBoss must be restared.
fi
