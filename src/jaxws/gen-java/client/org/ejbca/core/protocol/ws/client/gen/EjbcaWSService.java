 ...
 * 
 */
@WebServiceClient(name = "EjbcaWSService", targetNamespace = "http://ws.protocol.core.ejbca.org/", wsdlLocation = "http://localhost:8080/ejbca/ejbcaws/ejbcaws?wsdl")
    ...
    extends Service
{
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/ejbca/ejbcaws/ejbcaws?wsdl");
