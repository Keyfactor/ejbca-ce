...
<%! // Declarations
  ...
  static final String OLD_MATCHWITHROW5 = "oldmatchwithrow5";
  ...
  static final String SELECT_MATCHWITH_ROW5     = "selectmatchwithrow5"; 
...
%><%
  ...
  String oldmatchwithrow5 = request.getParameter(OLD_MATCHWITHROW5);
  ...
  if( request.getParameter(ACTION) != null){
    if( request.getParameter(ACTION).equals(ACTION_CHANGEFILTERMODETO_ADVANCED)){
      ejbcawebbean.setLastFilterMode(UserPreference.FILTERMODE_ADVANCED);
      filtermode = UserPreference.FILTERMODE_ADVANCED;
    }
    if( request.getParameter(ACTION).equals(ACTION_CHANGEFILTERMODETO_BASIC)){
      ejbcawebbean.setLastFilterMode(UserPreference.FILTERMODE_BASIC);
   ...
   if( (editbuttonpressed || request.getParameter(BUTTON_RELOAD)!=null) && oldaction.equals(OLD_ACTION_FINDUSER) ){
       ...
       if( (editbuttonpressed || request.getParameter(BUTTON_RELOAD)!=null) && oldaction.equals(OLD_ACTION_ADVANCEDLIST) ){
               ...
               int matchwithrow5 = (request.getParameter(OLD_MATCHWITHROW5)==null?-1:Integer.parseInt(request.getParameter(OLD_MATCHWITHROW5)));
              ...
              if(connectorrow4 != -1 && (matchwithrow4 != -1 || matchwithrow5 != -1)){
                   query.add(connectorrow4);
                   query.add(startdate, enddate);
              }

              if(connectorrow4 == -1 && !matchadded && (matchwithrow4 != -1 || matchwithrow5 != -1)){
                   query.add(startdate, enddate);
              }
         ...
         if( request.getParameter(BUTTON_LIST) != null){
           ...
           if( request.getParameter(BUTTON_ISREVOKED) != null){
             ...
             if( request.getParameter(BUTTON_ADVANCEDLIST) != null){
               ...
               oldmatchwithrow5 = request.getParameter(SELECT_MATCHWITH_ROW5);
               ...
               int matchwithrow5 = (request.getParameter(SELECT_MATCHWITH_ROW5)==null?-1:Integer.parseInt(request.getParameter(SELECT_MATCHWITH_ROW5)));
               ...
               if(matchwithrow1 == UserMatch.MATCH_WITH_PROFILE){
                  if(request.getParameter(SELECT_MATCHVALUE_ROW1) != null)
                    matchvaluerow1 = Integer.toString(rabean.getProfileId(request.getParameter(SELECT_MATCHVALUE_ROW1)));
               ...
               if(matchwithrow2 == UserMatch.MATCH_WITH_PROFILE){
                  if(request.getParameter(SELECT_MATCHVALUE_ROW2) != null)
                    matchvaluerow2 = Integer.toString(rabean.getProfileId(request.getParameter(SELECT_MATCHVALUE_ROW2)));
               ...
               if(matchwithrow3 == UserMatch.MATCH_WITH_PROFILE){
                  if(request.getParameter(SELECT_MATCHVALUE_ROW3) != null)
                    matchvaluerow3 = Integer.toString(rabean.getProfileId(request.getParameter(SELECT_MATCHVALUE_ROW3)));
