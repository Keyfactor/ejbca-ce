...
<%  }
     if( request.getParameter(BUTTON_SAVE) != null){
        ...
        if(!ejbcawebbean.existsUserPreference()){
          ejbcawebbean.addUserPreference(dup);
        }
        else{
          ejbcawebbean.changeUserPreference(dup);
        }
...
<body>
<div align="center"> 
  <h2><%= ejbcawebbean.getText("EJBCAUSERPREFERENCES") %><br>
      <%= ejbcawebbean.getText("FORUSER")+" " + ejbcawebbean.getUsersCommonName() %>
  </h2>
</div>
<form name="defaultuserpreferences" method="post" action="<%=THIS_FILENAME %>">
