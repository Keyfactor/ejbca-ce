...
<% 
  ...
  GlobalConfiguration globalconfiguration =ejbcawebbean.initialize(request, "/system_functionallity/edit_administrator_privileges/edit_available_accessrules"); 
  ...
  <form name="availableaccessrules" method="post" action="<%=THIS_FILENAME %>">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr id="Header"> 
        ...
        <td width="65%"><H3><%= ejbcawebbean.getText("RESOURCE") %></H3></td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr> 
        <td width="66%" valign="middle"><input type="text" name="<%=TEXTFIELD_RULENAME%>" size="40" maxlength="255">   
          <input type="submit" name="<%=BUTTON_ADD_AVAILABLERULE %>" onClick='return checkfieldforlegalresourcechars("document.availableaccessrules.<%=TEXTFIELD_RULENAME%>","<%= ejbcawebbean.getText("ONLYRESOURCECHARACTERS") %>")' value="<%= ejbcawebbean.getText("ADD") %>">
        </td>  <td width="16%">&nbsp;</td>
        <td width="18%" valign="middle">&nbsp; </td>
    </tr>
  </table>
