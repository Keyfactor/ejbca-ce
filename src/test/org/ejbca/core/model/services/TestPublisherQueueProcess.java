...
public class TestPublisherQueueProcess extends TestCase {
     ...
     */
    public TestPublisherQueueProcess(String name) throws Exception {
        super(name);
    }
    ...
    */
    public void test01PublishQueueProcessSuccess() throws Exception {
    	...
    	try {
    		TestTools.getCertificateStoreSession().storeCertificate(admin, cert, "TestPublishQueueProcessService", null, CertificateDataBean.CERT_ACTIVE, CertificateDataBean.CERTTYPE_ENDENTITY, 12345, "tag", new Date().getTime());
    	} catch (Exception e) {
