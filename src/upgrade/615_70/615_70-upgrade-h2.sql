...
-- ALTER TABLE CertificateData ADD certificateRequest VARCHAR;
-- ALTER TABLE NoConflictCertificateData ADD certificateRequest VARCHAR;
-- ALTER TABLE Base64CertData ADD certificateRequest VARCHAR;
