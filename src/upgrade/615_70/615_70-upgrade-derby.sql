...
-- ALTER TABLE CertificateData ADD certificateRequest CLOB;
-- ALTER TABLE NoConflictCertificateData ADD certificateRequest CLOB;
-- ALTER TABLE Base64CertData ADD certificateRequest CLOB;
