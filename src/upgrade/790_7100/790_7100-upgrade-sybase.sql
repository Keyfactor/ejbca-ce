...
-- ALTER TABLE AcmeAuthorizationData ADD identifier VARCHAR(255);
-- ALTER TABLE AcmeAuthorizationData ADD identifierType VARCHAR(20);
-- ALTER TABLE AcmeAuthorizationData ADD expires DECIMAL(20,0);
-- ALTER TABLE AcmeAuthorizationData ADD status VARCHAR(20);

-- DROP INDEX IF EXISTS AcmeAuthorizationData.acmeauthorizationdata_idx1;
