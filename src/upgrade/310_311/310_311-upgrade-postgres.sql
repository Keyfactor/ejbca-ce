...
ALTER TABLE ProtectedLogData ADD COLUMN rowVersion INT4 DEFAULT 0;
ALTER TABLE ProtectedLogExportData ADD COLUMN rowVersion INT4 DEFAULT 0;
ALTER TABLE ProtectedLogTokenData ADD COLUMN rowVersion INT4 DEFAULT 0;
