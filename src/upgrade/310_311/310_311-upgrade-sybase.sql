...
ALTER TABLE ProtectedLogData ADD COLUMN rowVersion INTEGER DEFAULT 0;
ALTER TABLE ProtectedLogExportData ADD COLUMN rowVersion INTEGER DEFAULT 0;
ALTER TABLE ProtectedLogTokenData ADD COLUMN rowVersion INTEGER DEFAULT 0;
