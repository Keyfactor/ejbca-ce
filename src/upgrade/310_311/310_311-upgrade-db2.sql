...
CALL SYSPROC.ADMIN_CMD('REORG TABLE ProtectedLogData');
CALL SYSPROC.ADMIN_CMD('REORG TABLE ProtectedLogExportData');
CALL SYSPROC.ADMIN_CMD('REORG TABLE ProtectedLogTokenData');
