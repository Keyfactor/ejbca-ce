 ...
 * @version $Id: EndEntityProfile.java,v 1.15 2003-10-29 14:25:42 herrvendil Exp $
 */
public class EndEntityProfile extends UpgradeableDataHashMap implements java.io.Serializable, Cloneable {
    ...
    public String getAutoGeneratedPasswd(){
    	return PasswordGeneratorFactory.getInstance(PasswordGeneratorFactory.PASSWORDTYPE_6TO8ALLPRINTABLE).getNewPassword();    	
    }
