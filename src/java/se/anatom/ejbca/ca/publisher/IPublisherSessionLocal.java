   ...
   extends javax.ejb.EJBLocalObject
{
    ...
    * @see se.anatom.ejbca.ca.publisher.BasePublisher
    */
   public void testConnection( se.anatom.ejbca.log.Admin admin,int publisherid ) throws se.anatom.ejbca.ca.exception.PublisherConnectionException;
    ...
    */
   public void addPublisher( se.anatom.ejbca.log.Admin admin,java.lang.String name,se.anatom.ejbca.ca.publisher.BasePublisher publisher ) throws se.anatom.ejbca.ca.exception.PublisherExistsException;
    ...
    * @throws EJBException if a communication or other error occurs.
    */
   public void addPublisher( se.anatom.ejbca.log.Admin admin,int id,java.lang.String name,se.anatom.ejbca.ca.publisher.BasePublisher publisher ) throws se.anatom.ejbca.ca.exception.PublisherExistsException;
    ...
    * @throws EJBException if a communication or other error occurs.
    */
   public void clonePublisher( se.anatom.ejbca.log.Admin admin,java.lang.String oldname,java.lang.String newname ) throws se.anatom.ejbca.ca.exception.PublisherExistsException;
    ...
    * @throws EJBException if a communication or other error occurs.
    */
   public void renamePublisher( se.anatom.ejbca.log.Admin admin,java.lang.String oldname,java.lang.String newname ) throws se.anatom.ejbca.ca.exception.PublisherExistsException;
