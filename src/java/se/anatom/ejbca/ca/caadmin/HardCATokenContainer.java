 ...
 * 
 *
 * @version $Id: HardCATokenContainer.java,v 1.2 2005-05-24 09:32:53 herrvendil Exp $
 */
public class HardCATokenContainer extends CAToken{
	...
	/**
	 * @see se.anatom.ejbca.ca.caadmin.CAToken#getPrivateKey()
	 */
	...
	/**
	 * @see se.anatom.ejbca.ca.caadmin.CAToken#getPublicKey()
	 */
	...
	/**
	 * @see se.anatom.ejbca.ca.caadmin.CAToken#getProvider()
	 */
