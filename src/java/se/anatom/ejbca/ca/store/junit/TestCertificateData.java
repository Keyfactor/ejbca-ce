 ...
 *
 * @version $Id: TestCertificateData.java,v 1.1.1.1 2001-11-15 14:58:17 anatom Exp $
 */
public class TestCertificateData extends TestCase {
    ...
    public void test02FindAndChange() throws Exception {
        ...
        System.out.println("issuer="+data2.getIssuer());
        System.out.println("subject="+data2.getSubject());
    ...
    public void test04FindAgain() throws Exception {
        cat.debug(">test04FindAgain()");
        CertificateDataPK pk = new CertificateDataPK();
        pk.fp = CertTools.getFingerprintAsString(cert);
        ...
        System.out.println("issuer="+data3.getIssuer());
        System.out.println("subject="+data3.getSubject());
    ...
    public void test05FindByIssuerAndSerno() throws Exception {
        cat.debug(">test05FindByIssuerAndSerno()");
        CertificateDataPK pk = new CertificateDataPK();
        pk.fp = CertTools.getFingerprintAsString(cert);
        CertificateData data3 = home.findByPrimaryKey(pk);
        assertNotNull("Failed to find cert", data3);
    ...
    public void test06IsRevoked() throws Exception {
        cat.debug(">test06IsRevoked()");
        CertificateDataPK pk = new CertificateDataPK();
        pk.fp = CertTools.getFingerprintAsString(cert);
        CertificateData data3 = home.findByPrimaryKey(pk);
        assertNotNull("Failed to find cert", data3);
