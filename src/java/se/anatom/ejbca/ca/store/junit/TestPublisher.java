 ...
 * Tests Publishers.
 *
 * @version $Id: TestPublisher.java,v 1.16 2003-09-03 13:04:02 herrvendil Exp $
 */
public class TestPublisher extends TestCase {
    ...
    public void test01AddCertificate() throws Exception {
        ...
        boolean ret = pub.storeCertificate(new Admin(Admin.TYPE_INTERNALUSER), cert, "test01",
                null, CertificateData.CERT_ACTIVE, SecConst.USER_ENDUSER);
    ...
    public void test05AddCACert() throws Exception {
        ...
        boolean ret = pub.storeCertificate(new Admin(Admin.TYPE_INTERNALUSER), cacert, "test05", null, CertificateData.CERT_ACTIVE, SecConst.CERTTYPE_SUBCA);
        assertTrue("Storing certificate failed", ret);
        log.debug("<test05AddCACert()");
    }
    ...
    public void test06AddCACertAgain() throws Exception {
        ...
        X509Certificate cacert = CertTools.getCertfromByteArray(testcacert);
        boolean ret = pub.storeCertificate(new Admin(Admin.TYPE_INTERNALUSER), cacert,"test06", null, CertificateData.CERT_ACTIVE, SecConst.CERTTYPE_SUBCA);
        assertTrue("Storing certificate failed", ret);
        log.debug("<test06AddCACertAgain()");
    }
}
