...
/**
 * CACertificateType is a class defining the fixed characteristics of a CA certificate type.
 *
 * @author  TomSelleck
 */
public class CACertificateType extends CertificateType{
    
    // Public Constants

    public final static  String CERTIFICATETYPENAME =  "CA";
    
    // Public Methods
    /** Creates a certificate with the characteristics of an end user. */
    public CACertificateType() {
