...
/**
 * RootCACertificateType is a class defining the fixed characteristics of a root ca certificate type.
 *
 * @author  TomSelleck
 */
public class RootCACertificateType extends CertificateType{
    
    // Public Constants

    public final static String CERTIFICATETYPENAME =  "ROOTCA";
    
    // Public Methods
    /** Creates a certificate with the characteristics of an end user. */
    public RootCACertificateType() {
