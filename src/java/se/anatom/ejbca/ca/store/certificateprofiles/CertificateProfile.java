...
public class CertificateProfile extends UpgradeableDataHashMap implements Serializable, Cloneable {
    ...
    public Long getValidity(){return (Long) data.get(VALIDITY);}
    public void setValidity(long validity) { data.put(VALIDITY,new Long(validity));}
    
    public Boolean getUseBasicConstraints(){ return (Boolean) data.get(USEBASICCONSTRAINTS); }
    ...
    public Boolean getBasicConstraintsCritical(){ return (Boolean) data.get(BASICCONSTRAINTSCRITICAL); }
    ...
    public Boolean getUseKeyUsage(){ return (Boolean) data.get(USEKEYUSAGE); }
    public void setUseKeyUsage(boolean usekeyusage) { data.put(USEKEYUSAGE, new Boolean(usekeyusage));} 
   
    public Boolean getKeyUsageCritical(){ return (Boolean) data.get(KEYUSAGECRITICAL); }
    public void setKeyUsageCritical(boolean keyusagecritical) { data.put(KEYUSAGECRITICAL, new Boolean(keyusagecritical));}     
    
    public Boolean getUseSubjectKeyIdentifier(){ return (Boolean) data.get(USESUBJECTKEYIDENTIFIER); }
    ...
    public Boolean getSubjectKeyIdentifierCritical(){ return (Boolean) data.get(SUBJECTKEYIDENTIFIERCRITICAL); }
    ...
    public Boolean getUseAuthorityKeyIdentifier(){ return (Boolean) data.get(USEAUTHORITYKEYIDENTIFIER); }
    ...
    public Boolean getAuthorityKeyIdentifierCritical(){ return (Boolean) data.get(AUTHORITYKEYIDENTIFIERCRITICAL); }
    ...
    public Boolean getUseSubjectAlternativeName(){ return (Boolean) data.get(USESUBJECTALTERNATIVENAME); }
    ...
    public Boolean getSubjectAlternativeNameCritical(){ return (Boolean) data.get(SUBJECTALTERNATIVENAMECRITICAL); }
    ...
    public Boolean getUseCRLDistributionPoint(){ return (Boolean) data.get(USECRLDISTRIBUTIONPOINT); }
    ...
    public Boolean getCRLDistributionPointCritical(){ return (Boolean) data.get(CRLDISTRIBUTIONPOINTCRITICAL); }
    ...
    public Boolean getUseCertificatePolicies() { return (Boolean) data.get(USECERTIFICATEPOLICIES); }
    ...
    public Boolean getCertificatePoliciesCritical() { return (Boolean) data.get(CERTIFICATEPOLICIESCRITICAL); }
    ...
    public Long getCRLPeriod(){ return (Long) data.get(CRLPERIOD); }
    public void setCRLPeriod(long crlperiod){data.put(CRLPERIOD,new Long(crlperiod));}
    
    public Boolean getFinishUser(){ return (Boolean) data.get(FINISHUSER); }
