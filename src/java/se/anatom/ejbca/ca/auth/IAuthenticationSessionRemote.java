 ...
 */
public interface IAuthenticationSessionRemote
   extends javax.ejb.EJBObject
{
    ...
    */
   public se.anatom.ejbca.ca.auth.UserAuthData authenticateUser( se.anatom.ejbca.log.Admin admin,java.lang.String username,java.lang.String password )
      throws javax.ejb.ObjectNotFoundException, se.anatom.ejbca.ca.exception.AuthStatusException, se.anatom.ejbca.ca.exception.AuthLoginException, java.rmi.RemoteException;
    ...
    * @throws ObjectNotFoundException if the user does not exist.
    */
   public void finishUser( se.anatom.ejbca.log.Admin admin,java.lang.String username,java.lang.String password )
