...
/**
 * Handles maintenance of the device producing signatures and handling the private key. Classes
 * implementing this interface should be Singletons, since they will be created using the
 * getInstance() method.
 *
 * @version $Id: ISigningDevice.java,v 1.7 2003-06-26 11:43:23 anatom Exp $
 */
public interface ISigningDevice extends java.io.Serializable {
    ...
    /**
     * Returns the signature Provider that should be used to sign things with the PrivateKey object
     * returned by this signingdevice implementation.
     *
