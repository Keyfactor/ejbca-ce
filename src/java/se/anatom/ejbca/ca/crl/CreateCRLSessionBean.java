 ...
 *
 * @version $Id: CreateCRLSessionBean.java,v 1.14 2003-07-24 08:43:30 anatom Exp $
 */
public class CreateCRLSessionBean extends BaseSessionBean implements IJobRunnerSession {
    ...
    public void run(Admin admin) throws RemoteException {
        ...
        try {
            ...
            Collection revcerts = store.listRevokedCertificates(admin);
            ...
            while (iter.hasNext()) {
                ...
                if ((data.getStatus() == CertificateData.CERT_REVOKED) &&
                    ...
                    RevokedCertInfo certinfo = new RevokedCertInfo(new BigInteger(
                                data.getSerialNumber()), new Date(data.getRevocationDate()),
            ...
            X509CRL crl = sign.createCRL(admin, certs);
