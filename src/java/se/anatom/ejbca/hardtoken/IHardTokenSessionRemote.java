...
public interface IHardTokenSessionRemote extends javax.ejb.EJBObject {
    ...
    public void addHardToken(Admin admin, String tokensn, String username, int tokentype,
        ...
        throws HardTokenExistsException, RemoteException;
    ...
    public void changeHardToken(Admin admin, String tokensn, int tokentype, HardToken hardtokendata)
        throws HardTokenDoesntExistsException, RemoteException;

    /**
     * removes a hard token data from the database, observe the certificate to tokensn mappings
     * isn't removed with this function. the certificate mappings have to be removed separately.
     *
     * @param admin , the administrator calling the function
     * @param tokensn , The serialnumber of token.
     *
    ...
    public void addHardTokenCertificateMapping(Admin admin, String tokensn,
        X509Certificate Certificate) throws RemoteException;
     ...
     * @param tokensn The serialnumber of token.
     *
     * @return collection of certificates, or empty collection
     *
     * @throws EJBException if a communication or other error occurs.
     */
