 ...
 *
 * @version $Id: IHardTokenBatchJobSessionRemote.java,v 1.3 2003-06-26 11:43:24 anatom Exp $
 */
public interface IHardTokenBatchJobSessionRemote extends javax.ejb.EJBObject {
    ...
    public UserAdminData getNextHardTokenToGenerate(Admin admin, X509Certificate issuercert)
        throws UnavailableTokenException, RemoteException;

    /**
     * Returns a Collection of users scheduled for batch generation for the given issuer.  A
     * maximum of MAX_RETURNED_QUEUE_SIZE users will be returned by call.
     *
     * @param admin the administrator performing the actions
     * @param issuercert the certificate of the hard token issuer.
     *
    ...
    public UserAdminData getNextHardTokenToGenerateInQueue(Admin admin, X509Certificate issuercert,
        int index) throws UnavailableTokenException, RemoteException;
