...
public interface ILogSessionLocal
   extends javax.ejb.EJBLocalObject,LogConstants
{
   /**
    ...
    */
   public java.util.Collection query( se.anatom.ejbca.util.query.Query query,java.lang.String viewlogprivileges,java.lang.String capriviledges ) throws se.anatom.ejbca.util.query.IllegalQueryException;
