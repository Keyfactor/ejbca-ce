...
public class CaMakeRootCommand extends BaseCaAdminCommand {
    ...
    public void execute() throws IllegalAdminCommandException, ErrorAdminCommandException {
        ...
        try {
            ...
            X509Certificate rootcert = CertTools.genSelfCert(dn, validity, policyId,
                    rsaKeys.getPrivate(), rsaKeys.getPublic(), true);
            KeyStore ks = KeyTools.createP12(privKeyAlias, rsaKeys.getPrivate(), rootcert,
