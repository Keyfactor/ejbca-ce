 ...
 *
 * @version  $Id: ScepPkiOpHelper.java,v 1.8 2003-06-04 20:06:02 anatom Exp $
 */
public class ScepPkiOpHelper {
    ...
    throws ObjectNotFoundException, AuthorizationDeniedException, AuthLoginException, SignRequestException, AuthStatusException, IllegalKeyException, SignRequestSignatureException 
    {
        ...
        try {
            ...
            String password = reqmsg.getRequestChallengePwd();
            // TODO:
