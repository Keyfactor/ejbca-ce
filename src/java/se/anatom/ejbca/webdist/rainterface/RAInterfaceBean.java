 ...
 * @version $Id: RAInterfaceBean.java,v 1.54 2005-04-29 09:15:40 anatom Exp $
 */
public class RAInterfaceBean {
    ...
    throws FinderException, NumberFormatException {
        ArrayList userlist = new ArrayList();
        UserView[] returnval = null;
    ...
    public boolean revokeTokenCertificates(String tokensn, String username, int reason) throws FinderException{
        boolean success = true;
    ...
    public boolean isAllTokenCertificatesRevoked(String tokensn) {
        Collection certs = hardtokensession.findCertificatesInHardToken(administrator, tokensn);
    ...
    public boolean authorizedToRevokeCert(String username) throws FinderException, AuthorizationDeniedException {
