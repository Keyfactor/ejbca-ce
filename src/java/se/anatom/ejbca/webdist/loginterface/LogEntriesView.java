...
public class LogEntriesView {
     ...
     *
     * @param dnproxy DOCUMENT ME!
     * @param localinfoeventnames DOCUMENT ME!
     * @param localerroreventnames DOCUMENT ME!
     * @param localmodulenames DOCUMENT ME!
     */
    public LogEntriesView(SubjectDNProxy dnproxy, String[] localinfoeventnames,
        String[] localerroreventnames, String[] localmodulenames) {
     ...
     * @param localmodulenames DOCUMENT ME!
     */
    public LogEntriesView(LogEntry logentry, SubjectDNProxy dnproxy, String[] localinfoeventnames,
        String[] localerroreventnames, String[] localmodulenames)
        throws RemoteException {
        logentryviews = new ArrayList();
        sortby = new SortBy(SortBy.TIME, SortBy.DECENDING);
        this.dnproxy = dnproxy;
        logentryviews.add(new LogEntryView(logentry, dnproxy, localinfoeventnames,
                localerroreventnames, localmodulenames));
        this.localinfoeventnames = localinfoeventnames;
        this.localerroreventnames = localerroreventnames;
        this.localmodulenames = localmodulenames;
    }
     ...
     * @param localmodulenames DOCUMENT ME!
     */
    public LogEntriesView(Collection logentries, SubjectDNProxy dnproxy,
        String[] localinfoeventnames, String[] localerroreventnames, String[] localmodulenames)
        throws RemoteException {
        logentryviews = new ArrayList();
        sortby = new SortBy(SortBy.TIME, SortBy.DECENDING);
        this.dnproxy = dnproxy;
     ...
     *
     * @param sortby should be one of the constants defined in
     *        se.anatom.ejbca.webdist.rainterface.Sortby.
     * @param sortorder should be one of the constants defined in
     *        se.anatom.ejbca.webdist.rainterface.Sortby.
     */
    ...
    public void setEntries(LogEntry[] logentries) throws RemoteException {
        ...
        if ((logentries != null) && (logentries.length > 0)) {
            for (int i = 0; i < logentries.length; i++) {
                logentryview = new LogEntryView(logentries[i], dnproxy, localinfoeventnames,
                        localerroreventnames, localmodulenames);
    ...
    public void setEntries(Collection logentries) throws RemoteException {
        ...
        if ((logentries != null) && (logentries.size() > 0)) {
            ...
            while (i.hasNext()) {
                ...
                logentryview = new LogEntryView(nextentry, dnproxy, localinfoeventnames,
                        localerroreventnames, localmodulenames);
                logentryview.setSortBy(this.sortby);
