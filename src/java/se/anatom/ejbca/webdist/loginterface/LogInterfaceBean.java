...
public class LogInterfaceBean {
    ...
    public void initialize(HttpServletRequest request, EjbcaWebBean ejbcawebbean) throws  Exception{
      ...
      if(!initialized){
        ...
        ILogSessionHome logsessionhome = (ILogSessionHome) javax.rmi.PortableRemoteObject.narrow(jndicontext.lookup("LogSession"), 
     ...
     */    
    public void saveLogConfiguration(LogConfiguration logconfiguration) throws RemoteException{
