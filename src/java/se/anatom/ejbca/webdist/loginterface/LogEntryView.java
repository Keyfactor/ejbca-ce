...
public class LogEntryView implements java.io.Serializable, Cloneable, Comparable {
    ...
    /**
     * Creates a new LogEntryView object.
     *
     ...
     */
    public LogEntryView(LogEntry logentry, SubjectDNProxy dnproxy, String[] localinfoeventnames,
    ...
    public void setValues(LogEntry logentry, String[] localinfoeventnames,
        String[] localerroreventnames, String[] localmodulenames)
        throws RemoteException {
        logentrydata[TIME] = DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT)
        ...
        if (logentry.getAdminType() == Admin.TYPE_CLIENTCERT_USER) {
            ...
            if (dnstring != null) {
                ...
                logentrydata[ADMINDATA] = dn.getField(DNFieldExtractor.CN, 0) + ", " +
                    dn.getField(DNFieldExtractor.O, 0);
            }
        } else {
        ...
        if (logentrydata[CERTIFICATESERNO] != null) {
            ...
            if (dnstring != null) {
                DNFieldExtractor dn = new DNFieldExtractor(dnstring, DNFieldExtractor.TYPE_SUBJECTDN);
                logentrydata[CERTIFICATE] = dn.getField(DNFieldExtractor.CN, 0) + ", " +
                    dn.getField(DNFieldExtractor.O, 0);
            }
        }
        ...
        if (logentry.getEvent() < LogEntry.EVENT_ERROR_BOUNDRARY) {
            ...
            logentrydata[EVENT] = localerroreventnames[logentry.getEvent() -
                LogEntry.EVENT_ERROR_BOUNDRARY];
        }
    ...
    public int compareTo(Object obj) {
        ...
        case SortBy.CERTIFICATE:
            returnvalue = logentrydata[CERTIFICATE].compareTo(((LogEntryView) obj).getValue(
                        CERTIFICATE));
