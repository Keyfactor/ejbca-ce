...
public class LocalKeyRecoverySessionBean extends BaseSessionBean {
    ...
    public boolean addKeyRecoveryData(Admin admin, X509Certificate certificate, String username,
        ...
        try {
            ...
            getLogSession().log(admin, LogEntry.MODULE_KEYRECOVERY, new java.util.Date(), username,
            ...
            try {
                getLogSession().log(admin, LogEntry.MODULE_KEYRECOVERY, new java.util.Date(),
    ...
    public boolean changeKeyRecoveryData(Admin admin, X509Certificate certificate,
        ...
        try {
            ...
            try {
                getLogSession().log(admin, LogEntry.MODULE_KEYRECOVERY, new java.util.Date(), null,
