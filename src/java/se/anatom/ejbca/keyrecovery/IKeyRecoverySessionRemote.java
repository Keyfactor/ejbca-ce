...
public interface IKeyRecoverySessionRemote extends javax.ejb.EJBObject {
    ...
    public boolean addKeyRecoveryData(Admin admin, X509Certificate certificate, String username, KeyPair keypair) throws RemoteException;   
     ...
     * @throws EJBException if a communication or other error occurs.   
     */ 
    public void removeKeyRecoveryData(Admin admin, X509Certificate certificate) throws RemoteException;
     ...
     * @throws EJBException if a communication or other error occurs.   
     */ 
    public void removeAllKeyRecoveryData(Admin admin, String username) throws RemoteException;    
       ...
       * @throws EJBException if a communication or other error occurs.
       */      
    public KeyRecoveryData keyRecovery(Admin admin, String username) throws RemoteException;
    
      /**
       * Marks a users newest certificate for key recovery. Newest means certificate with latest not before date.
       *
       * @return true if operation went successful or false if no certificates could be found for user.
       * @throws EJBException if a communication or other error occurs.
       */      
    public boolean markNewestAsRecoverable(Admin admin, String username) throws RemoteException;    
       ...
       * @throws EJBException if a communication or other error occurs.
       */      
    public boolean markAsRecoverable(Admin admin, X509Certificate certificate) throws RemoteException;
       ...
       * @throws EJBException if a communication or other error occurs.
       */      
    public void unmarkUser(Admin admin, String username) throws RemoteException;
       ...
       * @throws EJBException if a communication or other error occurs.
       */         
    public boolean isUserMarked(Admin admin, String username) throws RemoteException;
       ...
       * @throws EJBException if a communication or other error occurs.
       */        
    public boolean existsKeys(Admin admin, X509Certificate certificate) throws RemoteException;
