...
public class AdminCertReqServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String dn = p10.getCertificationRequest().getCertificationRequestInfo().getSubject()
                       .toString();
        ...
        try {
            X509Certificate cert = (X509Certificate) ss.createCertificate(admin, username,
                    password, p10);
    ...
    private final RAInterfaceBean getRaBean(HttpServletRequest req)
        ...
        if (rabean == null) {
            try {
                rabean = (RAInterfaceBean) Beans.instantiate(this.getClass().getClassLoader(),
                        "se.anatom.ejbca.webdist.rainterface.RAInterfaceBean");
    ...
    private final EjbcaWebBean getEjbcaWebBean(HttpServletRequest req)
        ...
        if (ejbcawebbean == null) {
            try {
                ejbcawebbean = (EjbcaWebBean) java.beans.Beans.instantiate(this.getClass()
                                                                               .getClassLoader(),
    ...
    private final CAInterfaceBean getCaBean(HttpServletRequest req)
        ...
        if (cabean == null) {
            try {
                cabean = (CAInterfaceBean) Beans.instantiate(this.getClass().getClassLoader(),
                        "se.anatom.ejbca.webdist.cainterface.CAInterfaceBean");
            } catch (ClassNotFoundException e) {
                throw new ServletException(e);
            } catch (Exception e) {
