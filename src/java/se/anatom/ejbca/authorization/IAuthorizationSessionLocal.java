 ...
 */
public interface IAuthorizationSessionLocal
   extends javax.ejb.EJBLocalObject
{
   /**
    * Method to initialize authorization bean, must be called directly after creation of bean. Should only be called once.
    */
   public void initialize( se.anatom.ejbca.log.Admin admin,int caid ) throws se.anatom.ejbca.authorization.AdminGroupExistsException;
    ...
    */
   public boolean isAuthorized( se.anatom.ejbca.log.Admin admin,java.lang.String resource ) throws se.anatom.ejbca.authorization.AuthorizationDeniedException;
    ...
    * @param resource the resource to check authorization for.
    */
   public boolean isAuthorizedNoLog( se.anatom.ejbca.log.Admin admin,java.lang.String resource ) throws se.anatom.ejbca.authorization.AuthorizationDeniedException;

   /**
    * Method to check if a group is authorized to a resource.
    */
   public boolean isGroupAuthorized( se.anatom.ejbca.log.Admin admin,int admingrouppk,java.lang.String resource ) throws se.anatom.ejbca.authorization.AuthorizationDeniedException;

   /**
    * Method to check if a group is authorized to a resource without any logging.
    */
   public boolean isGroupAuthorizedNoLog( se.anatom.ejbca.log.Admin admin,int admingrouppk,java.lang.String resource ) throws se.anatom.ejbca.authorization.AuthorizationDeniedException;
    ...
    */
   public void authenticate( java.security.cert.X509Certificate certificate ) throws se.anatom.ejbca.authorization.AuthenticationFailedException;
    ...
    */
   public void addAdminGroup( se.anatom.ejbca.log.Admin admin,java.lang.String admingroupname,int caid ) throws se.anatom.ejbca.authorization.AdminGroupExistsException;
    ...
    * @throws AdminGroupExistsException if admingroup already exists.
    */
   public void renameAdminGroup( se.anatom.ejbca.log.Admin admin,java.lang.String oldname,int caid,java.lang.String newname ) throws se.anatom.ejbca.authorization.AdminGroupExistsException;
