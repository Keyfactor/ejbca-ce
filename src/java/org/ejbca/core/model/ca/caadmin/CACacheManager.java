...
public class CACacheManager {
    ...
    /**
     * Adds a CA to the registry. If a CA already exists for the given CAid, the old one is removed and replaced with the new. If the CA passed is
     * null, an existing CA is removed.
     * 
