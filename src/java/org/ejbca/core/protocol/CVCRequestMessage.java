...
public class CVCRequestMessage implements IRequestMessage {
    ...
    /**
     * Returns the string representation of the holderReference field of the certification request,
    ...
    public String getUsername() {
        ...
        String subject = null;
		try {
			subject = cvcert.getCertificateBody().getHolderReference().getValue();
		} catch (NoSuchFieldException e) {
			log.error(e);
		}
        return subject;
