...
public final class UniqueSernoHelper {
	...
	/*package*/ static final void reset() {
	 ...
	 */
	/*package*/ static final boolean isUniqueCertificateSerialNumberIndex(final CertificateStoreSession certificateStoreSession) {
