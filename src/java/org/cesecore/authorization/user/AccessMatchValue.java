 ...
 * 
 * Based on cesecore:
 *      AccessMatchValue.java 191 2011-01-28 15:12:56Z mikek
 * 
 * @version $Id$
 * 
 */
public enum AccessMatchValue {
    NONE(0), WITH_COUNTRY(1), WITH_DOMAINCOMPONENT(2), WITH_STATE(3), WITH_LOCALE(4), WITH_ORGANIZATION(5), WITH_ORGANIZATIONUNIT(6), WITH_TITLE(7), WITH_COMMONNAME(
            8), WITH_UID(9), WITH_DNSERIALNUMBER(10), WITH_SERIALNUMBER(11), WITH_DNEMAIL(12), WITH_RFC822NAME(13), WITH_UPN(14);
