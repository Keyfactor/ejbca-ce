...
public class PKCS11Wrapper {
    ...
    private static final Map<String, PKCS11Wrapper> instances = new HashMap<String, PKCS11Wrapper>();
    ...
    public PKCS11Wrapper(final String fileName) {
     ...
     * @return the instance.
     */
    public static synchronized PKCS11Wrapper getInstance(final String fileName) {
        final PKCS11Wrapper storedP11 = instances.get(fileName);
        if (storedP11 != null) {
            return storedP11;
        }
