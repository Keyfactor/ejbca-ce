...
set EJBCA_CP=%EJBCA_HOME%\lib\ldap.jar;%EJBCA_HOME%\lib\log4j.jar;%EJBCA_HOME%\lib\bcprov-jdk14.jar;%EJBCA_HOME%\lib\bcmail-jdk14.jar;%EJBCA_HOME%\lib\commons-lang-2.0.jar
