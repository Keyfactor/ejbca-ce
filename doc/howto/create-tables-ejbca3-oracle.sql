--
-- These definitions should work for EJBCA 3.8.x, Oracle 9.x or 10.x and the JDBC driver version 10.1.0.2.
--
...
CREATE TABLE "PROTECTEDLOGDATA" (
	...
	"CAID" NUMBER(10) NOT NULL,
	"MODULE" NUMBER(10) NOT NULL,
	"EVENTTIME" NUMBER(19) NOT NULL,
	"USERNAME" VARCHAR2(255 byte),
	"CERTIFICATESERIALNUMBER" VARCHAR2(255 byte),
	"CERTIFICATEISSUERDN" VARCHAR2(255 byte),
	"EVENTID" NUMBER(10) NOT NULL,
	"EVENTCOMMENT" VARCHAR2(4000 byte),
	"NODEGUID" NUMBER(10) NOT NULL,
	"COUNTER" NUMBER(19) NOT NULL, 
	"NODEIP" VARCHAR2(255 byte),
	"B64LINKEDINEVENTIDENTIFIERS" CLOB,
	"B64LINKEDINEVENTSHASH" VARCHAR2(255 byte),
	"CURRENTHASHALGORITHM" VARCHAR2(255 byte),
	"PROTECTIONKEYIDENTIFIER" NUMBER(10) NOT NULL,
	"PROTECTIONKEYALGORITHM" VARCHAR2(255 byte),
	"B64PROTECTION" VARCHAR2(4000 byte),
...
CREATE TABLE "PROTECTEDLOGEXPORTDATA" (
	"PK" VARCHAR2(255 byte) NOT NULL,
	"TIMEOFEXPORT" NUMBER(19) NOT NULL, 
	"EXPORTENDTIME" NUMBER(19) NOT NULL, 
	"EXPORTSTARTTIME" NUMBER(19) NOT NULL, 
	"B64LOGDATAHASH" VARCHAR2(255 byte),
	"B64PREVIOSEXPORTHASH" VARCHAR2(255 byte),
	"CURRENTHASHALGORITHM" VARCHAR2(255 byte),
	"B64SIGNATURECERTIFICATE" CLOB,
    "DELETED" NUMBER(1) NOT NULL, 
	"B64SIGNATURE" VARCHAR2(4000 byte),
...
CREATE TABLE "PROTECTEDLOGTOKENDATA" (
	"PK" VARCHAR2(255 byte) NOT NULL,
	"TOKENIDENTIFIER" NUMBER(10) NOT NULL,
	"TOKENTYPE" NUMBER(10) NOT NULL,
	"B64TOKENCERTIFICATE" CLOB,
	"TOKENREFERENCE" CLOB,
...
CREATE TABLE "PUBLISHERQUEUEDATA" (
    ...
    "TIMEPUBLISHED" TIMESTAMP default NULL,
