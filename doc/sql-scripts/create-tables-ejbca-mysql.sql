...
CREATE TABLE CertificateData (
    ...
    serialNumber VARCHAR(250) BINARY NOT NULL,
    status INT(11) NOT NULL,
    subjectAltName VARCHAR(8000) BINARY,
    subjectDN VARCHAR(767) BINARY NOT NULL,
...
CREATE TABLE UserData (
    ...
    subjectAltName VARCHAR(8000) BINARY,
    subjectDN VARCHAR(767) BINARY,
    subjectEmail VARCHAR(256) BINARY,
    timeCreated BIGINT(20) NOT NULL,
