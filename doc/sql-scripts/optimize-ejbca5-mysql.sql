...
-- Note: This will only gurantee uniqueness of "serialNumber, issuerDN" and
...
ALTER TABLE CertificateData ADD UNIQUE INDEX certificatedata_idx13 (serialNumber, issuerDN, type);
ALTER TABLE CertificateData REMOVE PARTITIONING;
ALTER TABLE CertificateData DROP PRIMARY KEY;
ALTER TABLE CertificateData ADD UNIQUE INDEX certificatedata_idx14 (fingerprint, type);
