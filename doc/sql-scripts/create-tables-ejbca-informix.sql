...
CREATE TABLE CertificateData (
    ...
    serialNumber VARCHAR(255,0) NOT NULL,
    status INTEGER NOT NULL,
    subjectAltName LVARCHAR(8000),
    subjectDN VARCHAR(400,0) NOT NULL,
    subjectKeyId VARCHAR(255,0),
    accountBindingId VARCHAR(255,0),
    tag VARCHAR(255,0),
...
CREATE TABLE BlacklistData (
    id INTEGER NOT NULL,
    type VARCHAR(255,0) NOT NULL,
    value VARCHAR(255,0) NOT NULL,
    data VARCHAR(255,0),
    rowProtection TEXT,
    rowVersion INTEGER NOT NULL,
    updateCounter INTEGER NOT NULL,
...
CREATE TABLE RoleData (
    id INTEGER NOT NULL,
    roleName VARCHAR(255,0) NOT NULL,
    nameSpace VARCHAR(255,0),
    rawData TEXT,
    rowProtection TEXT,
    rowVersion INTEGER NOT NULL,
    PRIMARY KEY (id)
...
CREATE TABLE AcmeNonceData (
    nonce VARCHAR(255,0) NOT NULL,
    timeExpires DECIMAL(18,0) NOT NULL,
    rowProtection TEXT,
    rowVersion INTEGER NOT NULL,
    PRIMARY KEY (nonce)
);
...
CREATE TABLE AcmeAccountData (
    ...
    currentKeyId VARCHAR(255,0) NOT NULL,
    rawData TEXT,
    rowProtection TEXT,
    rowVersion INTEGER NOT NULL,
...
CREATE TABLE AcmeAuthorizationData (
    authorizationId VARCHAR(255,0) NOT NULL,
    identifier VARCHAR(255,0),
    identifierType VARCHAR(20,0),
...
CREATE TABLE SctData (
    ...
    fingerprint VARCHAR(255,0) NOT NULL,
    certificateExpirationDate DECIMAL(18,0) NOT NULL,
    data TEXT,
    rowProtection TEXT,
    rowVersion INTEGER NOT NULL,
    PRIMARY KEY (pk) 
...
CREATE TABLE IncompleteIssuanceJournalData (
    serialNumberAndCaId VARCHAR(255,0) NOT NULL,
    startTime DECIMAL(18,0) NOT NULL,
    rawData TEXT,
    rowProtection TEXT,
    rowVersion INTEGER NOT NULL,
