...
CREATE TABLE CertificateData (
    ...
    serialNumber VARCHAR2(255 byte) NOT NULL,
    status NUMBER(10) NOT NULL,
    subjectAltName VARCHAR2(4000 byte),
    subjectDN VARCHAR2(400 byte) NULL,
    subjectKeyId VARCHAR2(255 byte),
    accountBindingId VARCHAR2(255 byte),
...
CREATE TABLE RoleMemberData (
    ...
    tokenProviderId NUMBER(10) DEFAULT 0 NOT NULL,
...
CREATE TABLE AcmeAuthorizationData (
    authorizationId VARCHAR2(255 byte) NOT NULL,
    identifier VARCHAR(255 byte),
    identifierType VARCHAR(20 byte),
    expires NUMBER(19),
    status VARCHAR(20 byte),
