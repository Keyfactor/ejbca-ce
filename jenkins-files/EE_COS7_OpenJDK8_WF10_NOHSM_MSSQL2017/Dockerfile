...
# Add MSSQL driver
RUN mkdir -p /opt/jboss/wildfly/modules/system/layers/base/com/microsoft/mssql/main/
ADD mssql-jdbc-7.2.2.jre8.jar /opt/jboss/wildfly/modules/system/layers/base/com/microsoft/mssql/main/mssql-jdbc-7.2.2.jre8.jar
ADD module.xml /opt/jboss/wildfly/modules/system/layers/base/com/microsoft/mssql/main/module.xml
