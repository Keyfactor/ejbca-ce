...
then
    ...
    export DOCKERFILE_STANDALONE_DATASOURCE_JNDI_NAME="$DOCKERFILE_STANDALONE_DATASOURCE_JNDI_NAME"
    export DOCKERFILE_STANDALONE_DATASOURCE_CONNECTION_URL="$DOCKERFILE_STANDALONE_DATASOURCE_CONNECTION_URL"
    export DOCKERFILE_STANDALONE_DATASOURCE_DRIVER="$DOCKERFILE_STANDALONE_DATASOURCE_DRIVER"
    export DOCKERFILE_STANDALONE_DATASOURCE_DRIVER_CLASS="$DOCKERFILE_STANDALONE_DATASOURCE_DRIVER_CLASS"
    export DOCKERFILE_STANDALONE_DATASOURCE_USERNAME="$DOCKERFILE_STANDALONE_DATASOURCE_USERNAME"
    export DOCKERFILE_STANDALONE_DATASOURCE_PASSWORD="$DOCKERFILE_STANDALONE_DATASOURCE_PASSWORD"
    export DOCKERFILE_STANDALONE_DATASOURCE_VALID_CONNECTION="$DOCKERFILE_STANDALONE_DATASOURCE_VALID_CONNECTION"
    export DOCKERFILE_STANDALONE_DRIVER="$DOCKERFILE_STANDALONE_DRIVER"
fi
