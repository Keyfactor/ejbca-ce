...
echo "Configuring database in standalone[1|2].xml-s."
if [ $5 = "db2" ]
then
    echo "Using DB2 pattern..."
    DOCKERFILE_STANDALONE_DATASOURCE_CONNECTION_URL="jdbc:db2://db_ee_cos7_openjdk8_wf10_nohsm_db2:50000/ejbca"
...
then
    ...
    DOCKERFILE_STANDALONE_DATASOURCE_CONNECTION_URL="jdbc:mysql://mariadb_1:3306/ejbca"
...
sed -e "s#DOCKERFILE_STANDALONE_DATASOURCE_JNDI_NAME#$DOCKERFILE_STANDALONE_DATASOURCE_JNDI_NAME#" \
    ...
    -e "s#DOCKERFILE_STANDALONE_DATASOURCE_DRIVER_CLASS#$DOCKERFILE_STANDALONE_DATASOURCE_DRIVER_CLASS#" \
